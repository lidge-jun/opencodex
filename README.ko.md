...
<p align="center">
  <a href="README.md">English</a> · <b>한국어</b> · <a href="README.zh-CN.md">简体中文</a> · <a href="README.ru.md">Русский</a> · 📖 <a href="https://lidge-jun.github.io/opencodex/ko/"><b>전체 문서 →</b></a>
</p>
...
4. 기본적으로 프로바이더의 `/v1/models` 엔드포인트에서 모델이 **자동 감지**됩니다. Add Provider 대화 상자에서 **수동 설정**을 선택하고 한 줄에 하나씩 모델 ID를 입력할 수도 있습니다 (`liveModels: false`와 입력한 `models` 목록이 저장되며, `/models` 요청은 발생하지 않습니다).
