...
| `~/.opencodex/codex-shim.json`, `*.lock`, `kimi-device-id`, `mimo-client-id` | opencodex bookkeeping | Shim restore obligations, cross-process locks, per-install client identifiers. |
