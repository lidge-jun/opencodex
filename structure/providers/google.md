...
400 without a changed repair send. The `google-tool-schema-repair` diagnostic contains only endpoint
class, fixed category counts, declaration count, truncation, and whether that send was allowed.
