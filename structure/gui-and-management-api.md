...
and failure restoration. Field masks are replayed against the latest provider under that same
...
versus undefined fields, provider/container identities and pending deletion provenance. Opaque
