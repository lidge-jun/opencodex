...
The dashboard displays configured `sourceModels` as technical data and preserves that boundary
when saving model, effort, or trigger changes; edit the allowlist through config or the settings API.
