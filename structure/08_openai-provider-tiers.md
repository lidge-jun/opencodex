...
immediately until normal quota or failure routing changes it. The active-account API uses `__main__`
for an explicit main-login selection; `null` means automatic selection with no pin.
