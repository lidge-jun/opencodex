...
3. Require independent source review and meaningful regression test additions. Compare test deletions/names before commits. Check file-size caps, test-layout registrations, exhaustive unions, structure ownership, public docs and attribution. Record forbidden local checks as NOT RUN, never as green.
