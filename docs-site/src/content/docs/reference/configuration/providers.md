...
| `noStopModels?` | `string[]` | Models that reject caller-specified Chat Completions `stop`. The `openai-chat` adapter and Chat passthrough omit the field for those ids. The xAI preset seeds this for documented reasoning models (`grok-4.7`, `grok-4.6`, `grok-4.5`, `grok-4.3`, `grok-4.20-multi-agent-0309`, `grok-4.20-0309-reasoning`, `grok-build-0.1`). Caller `stop` is still forwarded for `grok-4.20-0309-non-reasoning` and `grok-composer-2.5-fast`. |
