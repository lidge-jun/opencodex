...
| `manualCodexAccountSelectionId?` | `string` | — | Internal provenance marker for an explicit account selection. It survives proxy restarts and is cleared when automatic quota or failure routing changes the active account. Do not set by hand. |
