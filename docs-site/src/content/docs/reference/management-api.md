...
| `PUT /api/codex-auth/accounts/quota-auto-refresh` | Enable or disable 5-hour or weekly automatic window activation for one account | 400 invalid id/window/state; 404 missing account; 409 unavailable window |
