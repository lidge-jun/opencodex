...
requires effective local `codexDesktopAuthless` mode, the appropriate credentials and a current upstream permission. Catalog visibility alone never authorizes a request.
