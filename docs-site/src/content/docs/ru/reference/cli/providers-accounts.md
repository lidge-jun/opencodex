...
CLI надёжно повторно использует тот же operation ID до получения terminal response, поэтому после
timeout повторите ту же команду, а не начинайте новое расходование.
