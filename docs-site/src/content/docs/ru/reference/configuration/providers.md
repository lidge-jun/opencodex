...
Имена селекторов — настраиваемые публичные метки. При инициализации используются безопасные для
конфиденциальности автоматически созданные значения по умолчанию; opencodex не придаёт им семантики ролей
