...
и текст схемы не включаются. Диагностика только наблюдает существующее совместимое преобразование
и не отклоняет запрос. Нативные схемы вывода в неё не входят. См.
