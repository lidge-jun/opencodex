...
Расходование reset credit Codex — исключение. Для этой необратимой операции кроме loopback GUI-сессии владелец должен повторно ввести административный токен. Удалённый дашборд не может получить GUI-сессию, поэтому для расходования reset credit используйте локальный consent-flow CLI.
