...
провайдеров цели и недавние upstream-ошибки. Для cooldown подождите настроенное значение или
fallback upstream (5 секунд для rate-limit-кодов `1302`/`1305`, иначе 60 секунд; не более 10 минут), затем повторите запрос.
