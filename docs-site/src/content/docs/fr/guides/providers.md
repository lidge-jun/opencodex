...
Le quota Antigravity est sondé en direct via les RPC CCA `retrieveUserQuota` et `retrieveUserQuotaSummary` (délai de 8 secondes) ; le catalogue maintenu reste la solution de repli lorsque le quota en direct est indisponible.
