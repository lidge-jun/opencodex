...
Pour observer explicitement une installation Windows x64, consultez [`attest`](/fr/reference/cli/agents/). Quatre chemins sont requis ; aucune autorité de mise à jour ni sélection du runtime n’est attestée.
