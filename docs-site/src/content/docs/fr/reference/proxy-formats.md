...
| 400 | `unreadable_encrypted_agent_task` | Une tâche de travail v2 chiffrée n'a ni cible ChatGPT canonique ni cible Responses explicitement approuvée pouvant la consommer |
