...
Açık Windows x64 kurulum gözlemi için [`attest`](/tr/reference/cli/agents/) komutuna bakın. Dört yol gerekir; güncelleme yetkisi veya çalışma zamanı seçimi doğrulanmaz.
