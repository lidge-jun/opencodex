...
const INTENTIONAL_ENGLISH = new Set<TKey>([
  ...
  // Control plane proper nouns, identical French spellings, and technical identifiers
  "skills.tab.marketplace",
  "skills.tab.agents",
  "skills.col.version",
  "skills.col.actions",
  "skills.editorVersionPlaceholder",
  ...
  "credentials.tab.pool",
  "credentials.tab.quota",
  "credentials.tab.audit",
  "credentials.card.total",
  "credentials.col.id",
  "credentials.col.secret",
  "credentials.col.actions",
  "credentials.col.score",
  "credentials.col.oauth",
  "credentials.col.session",
  "credentials.col.budget",
  "credentials.col.action",
]);
