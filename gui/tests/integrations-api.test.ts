...
test("all registered export clients appear in file integrations", () => {
  expect(FILE_INTEGRATION_CLIENTS).toEqual([
    "opencode", "pi", "omp", "hermes", "openclaw", "kimi", "gajae", "dsh", "mcode", "zcode", "prime", "aside", "raycast", "omo", "cline", "droid",
  ]);
});
