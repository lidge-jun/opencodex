  ...
  return (
    <div className="panel" style={{ marginBottom: 24 }}>
      ...
      <div className="stat-row">
        <Stat label={t("dash.mem.rss")} value={data ? formatBytes(data.rss) : "—"} />
        <Stat label={t("dash.mem.jsHeap")} value={data ? `${formatBytes(data.heapUsed)} / ${formatBytes(data.heapTotal)}` : "—"} />
      ...
      <details style={{ marginTop: 10 }}>
        ...
        {data?.watchdog && (
          <div className="stat-row" style={{ marginTop: 16 }}>
            <Stat label={t("dash.mem.threshold")} value={formatBytes(data.watchdog.warnThresholdBytes)} />
            <Stat
