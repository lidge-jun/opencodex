 ...
 */
export const CLIENTS = ["opencode", "pi", "omp", "hermes", "openclaw", "kimi", "gajae", "dsh", "mcode", "zcode", "prime", "aside", "raycast", "omo", "cline", "droid"] as const;
...
export const CLIENT_LABEL_KEYS = {
  ...
  droid: "api.clientConfig.clientFactoryDroid",
} as const;
