...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "remoteLink.findHome.notice": "Connecting restarts OpenCodex on this computer. Codex turns already running finish first, and new requests can fail for up to a minute. Afterwards Codex keeps the same local address, and the Home serves it with its own providers and accounts.",
  ...
  "remoteLink.restart.body": "Running Codex turns finish first, then OpenCodex restarts as a Child. This page reloads by itself when the Child is ready.",
  "remoteLink.restart.waiting": "Waiting for this computer to reconnect as Child…",
  "remoteLink.restart.slow": "Restarting is taking longer than usual. This page keeps checking and reloads by itself once the Child answers. If OpenCodex has stopped, start it again.",
  ...
  "remoteLink.error.fingerprint_failed": "The SSH host key could not be read. Test the connection again.",
  "remoteLink.error.forbidden": "This dashboard session cannot manage remote links. Open the dashboard on this computer (standalone install), or use a paired Hub session.",
  ...
  "remoteLink.error.link_unavailable": "Remote Link is not available in this runtime. Restart OpenCodex and retry.",
  "remoteLink.error.listener_unavailable": "The Remote Link listener could not start on this computer. Check for a port conflict and retry.",
  "remoteLink.error.probe_failed": "Could not connect to the SSH host. Check that it accepts your SSH key and that any ProxyCommand helper is installed.",
  "remoteLink.error.remote_connect_failed": "The remote computer could not connect to this Home. Check its OpenCodex service and retry.",
  "remoteLink.error.remote_disconnect_failed": "Remote link request could not be completed.",
  "remoteLink.error.remote_ocx_missing": "ocx was not found on the remote computer. Install OpenCodex there, or make sure ocx is on the PATH of non-interactive SSH sessions.",
  "remoteLink.error.remote_ocx_outdated": "OpenCodex on the remote computer is too old for Remote Link. Run ocx update there (2.66.0 or later), then retry.",
  "remoteLink.error.remote_ocx_unrecognized": "The remote computer did not report an OpenCodex version. Remote Link needs OpenCodex 2.66.0 or later on macOS or Linux.",
  "remoteLink.error.remote_port_failed": "The remote computer could not report its link port. Check that OpenCodex 2.66.0 or later is running there and retry.",
  "remoteLink.error.tailscale_session_refused": "Remote link request could not be completed.",
  "remoteLink.error.version_probe_failed": "Could not run ocx on the remote computer over SSH. Check SSH access and retry.",
