...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.resetCliOnly": "Reset-credit consumption is available only from the loopback dashboard. When using a remote dashboard, run the local CLI consent flow on the OpenCodex host instead.",
  "codexAuth.confirmResetTitle": "Use Reset Credit?",
  "codexAuth.confirmResetDesc": "This will instantly reset your current rate limits. After confirmation, re-enter the OpenCodex admin token to prove owner consent. You have {count} credit(s) remaining.",
