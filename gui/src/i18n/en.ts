...
"common.discard": "Discard",
  ...
  "sub.taskRecovery": "Recover encrypted V2 tasks",
  "sub.taskRecoveryHint": "For native ChatGPT parents handing work to routed models. Uses one additional authenticated ChatGPT request, which can consume quota and add latency. Recovered text stays only in a bounded in-memory cache; failures remain fail-closed.",
  "sub.taskRecoveryConfirm": "Enable experimental encrypted-task recovery? It can consume additional ChatGPT quota, add latency, and depends on undocumented backend behavior.",
...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "pws.openrouter.title": "Provider routing by model",
  "pws.openrouter.hint": "Choose the exact OpenRouter endpoints used by each model. Endpoint discovery requires an authorized OpenRouter Management Key; routing itself keeps using the configured API key.",
  "pws.openrouter.load": "Load providers",
  "pws.openrouter.mode": "Routing behavior",
  "pws.openrouter.inherit": "Inherit provider default",
  "pws.openrouter.order": "Prioritize selected providers",
  "pws.openrouter.only": "Use only selected providers",
  "pws.openrouter.allowFallbacks": "Allow OpenRouter fallbacks after the selected providers",
  "pws.openrouter.managementKeyRequired": "Endpoint discovery requires an authorized OpenRouter Management Key. Existing manual routing remains unchanged.",
  "pws.openrouter.keyRequired": "Add an OpenRouter API key before discovering providers.",
  "pws.openrouter.loadFailed": "Could not load providers for this model.",
  "pws.openrouter.loaded": "Loaded {count} provider endpoints.",
  "pws.openrouter.notReturned": "Not returned by the latest discovery",
  "pws.openrouter.saved": "Model provider routing saved.",
