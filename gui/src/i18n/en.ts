...
export const en = {
  ...
  "prov.openaiDirectDesc": "Uses the caller's main Codex login only. No account rotation.",
  "prov.openaiMultiDesc": "Rotates across the main login and added Codex accounts.",
  ...
  "codexAuth.multiOwnerTitle": "Codex Multi-account pool",
  "codexAuth.multiOwnerDesc": "The main Codex login stays eligible alongside every account added here.",
  "codexAuth.multiMissing": "The Multi provider is not configured.",
  "codexAuth.addMultiProvider": "Add Codex Multi-account",
  "codexAuth.multiDisabled": "The Multi provider is configured but disabled.",
