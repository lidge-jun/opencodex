...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "pws.openrouter.hint": "Choose the exact OpenRouter endpoints used by each model. Discovery and routing use the configured OpenRouter API key.",
  ...
  "pws.openrouter.authorizationFailed": "OpenRouter rejected the configured API key for endpoint discovery. Existing manual routing remains unchanged.",
