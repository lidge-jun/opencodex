...
export const en = {
  ...
  "navGroup.automation": "Automation",
  ...
  "startup.subtitle": "Verify that Codex can reach hubapi after a restart, before local proxy routing becomes a reconnect loop.",
  ...
  "startup.summary.protected": "hubapi will be available after restart",
  ...
  "startup.riskDetailCustomLocal": "Codex points to a custom local gateway. hubapi cannot manage or verify that gateway's restart lifecycle.",
  ...
  "startup.codexRuntime.clampHidden": "Some reasoning effort options were hidden because hubapi used Codex {version}.",
  "startup.codexRuntime.clampHiddenWithEfforts": "Some reasoning effort options were hidden because hubapi used Codex {version} (removed: {efforts}).",
  "startup.codexRuntime.olderBinary": "hubapi is using an older Codex binary ({version}). A newer installation is available.",

  // dashboard
  "dash.subtitle": "Live status of the local hubapi proxy, its providers, and the models routed into Codex.",
  ...
  "dash.routes.title": "Recent route evidence",
  "dash.routes.hint": "Recorded requests only; configuration previews are kept separate.",
  "dash.routes.viewAll": "View logs",
  "dash.routes.unavailable": "Persistent request history is unavailable.",
  "dash.routes.empty": "No persisted requests yet.",
  "dash.routes.unknown": "Route trace unavailable",
  "dash.routes.attempts": "{count} attempts",
  ...
  "dash.codexAutoStart": "Start hubapi with Codex",
  ...
  "dash.shadowCallTooltip": "Codex App makes background helper calls for thread title generation, commit message generation, and skill orchestration. The helper model changed across client versions, so hubapi intercepts every model in this set: {models}. Enable this to redirect those calls to your chosen model.",
  ...
  "dash.maintenanceHint": "Refresh Codex's model catalog or install a newer hubapi release.",
  ...
  "dash.projectConfigTitle": "Project Codex config bypasses hubapi",
  "dash.projectConfigHint": "These repo-local settings override the hubapi proxy (e.g. route to OpenCode Go directly). Remove them so ~/.codex/config.toml routing applies in that project.",
  "dash.checkUpdate": "Check update",
  "dash.updateTitle": "Update hubapi",
  ...
  "dash.updateStatus.running": "Updating hubapi.",
  ...
  // providers
  "prov.subtitle": "Configure the upstream providers hubapi routes into Codex. Log in with an account, add a provider, or edit the raw config.",
  ...
  "oauthTos.anthropicBody": "Directly reusing Claude subscription OAuth tokens through a third-party proxy such as hubapi is not a supported Anthropic integration and may lead to access restrictions. Supported Agent SDK integrations that use Claude subscriptions are separate.",
  "oauthTos.highBody": "hubapi connects {provider} through a third-party OAuth path. Unsupported use may lead to access limits or suspension.",
  "oauthTos.elevatedBody": "hubapi connects {provider} through an unofficial OAuth path. Use the official client when possible; unusual or automated traffic may be treated as abuse and access may be limited or suspended.",
  "oauthTos.saferPath": "Safer option: configure an API key in hubapi instead.",
  ...
  "models.subtitle": "Toggle which models Codex sees — native GPT passthrough and routed providers, grouped by provider (click a header to collapse). Hidden models stay off the catalog + model picker but remain directly callable by exact id. Changes apply on the next Codex turn — hubapi invalidates Codex's 5-min model cache so no restart is needed.",
  ...
  // subagents
  "sub.subtitle": "Codex's {cmd} advertises only the first 5 models (by priority) as overrides. Pick up to 5 here — native gpt or routed — and hubapi sets their catalog priority so exactly these lead. Any other model is still callable by its exact name; this only controls what's shown.",
  ...
  "logs.tabLogs": "Logs",
  "logs.tabDebug": "Debug",
  "logs.subtitle": "Persisted requests routed through the local hubapi proxy, newest first.",
  "logs.history.indexed": "{count} persisted requests indexed",
  "logs.history.repaired": "History index was repaired",
  "logs.history.loadOlder": "Load older requests",
  "logs.history.loadError": "Older requests could not be loaded.",
  ...
  "logs.filter.advanced": "Persistent history filters",
  "logs.filter.provider": "Provider ID",
  "logs.filter.model": "Final model",
  "logs.filter.requestedModel": "Requested model",
  "logs.filter.status": "HTTP status",
  "logs.filter.protocol": "Inbound protocol",
  "logs.filter.apiKey": "API key ID",
  "logs.filter.profile": "Routing profile ID",
  "logs.filter.fallback": "Fallback used",
  "logs.filter.fallback.any": "Any",
  "logs.filter.fallback.yes": "Yes",
  "logs.filter.fallback.no": "No",
  "logs.filter.apply": "Apply filters",
  "logs.filter.clearAll": "Clear all",
  ...
  "logs.detail.route.loading": "Loading recorded route evidence…",
  "logs.detail.route.loadError": "Recorded route evidence could not be loaded; no route is inferred from the final provider.",
  "logs.detail.route.requested": "Requested model",
  "logs.detail.route.final": "Final target",
  "logs.detail.route.outcome": "Outcome",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "integrations.subtitle": "Connect clients to hubapi, manage credentials, and restore client configuration.",
  ...
  "integrations.codex.body": "Codex wiring is owned by the proxy service. Starting hubapi applies it; stopping the service restores native routing.",
  ...
  "integrations.detail.grokAbsent": "No hubapi block in the config",
  "integrations.dialog.grok.title": "Disable the Grok Build integration?",
  "integrations.dialog.grok.changes": "Only the block marked by hubapi will be removed from {path}. Content written outside the block will remain unchanged.",
  "integrations.dialog.grok.breakage": "Disabling removes the hubapi model aliases from Grok Build. Models used with your xAI account remain available.",
  "integrations.dialog.grok.undo": "If hubapi is running on a loopback address, turning this back on writes a new block from the models currently available.",
  "integrations.dialog.grok.confirm": "Disable",
  "integrations.dialog.desktop.title": "Disable Claude Desktop integration?",
  "integrations.dialog.desktop.changes": "If {path} contains an hubapi-managed gateway profile, Desktop will first select a new credential-free standard profile, then remove the old profile and backup.",
  "integrations.dialog.desktop.breakage": "Claude Desktop will return to standard Claude instead of models routed through hubapi.",
  "integrations.dialog.desktop.undo": "Turning this back on regenerates the hubapi profile from your saved model assignments.",
  ...
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build can be registered automatically only while hubapi runs on a loopback address. The previous block that pointed to loopback was removed.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build can be registered automatically only while hubapi runs on a loopback address. There was no previous block to remove.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build can be registered automatically only while hubapi runs on a loopback address. Another process wrote a new block in the meantime, so the block now in the file was not created by this request.",
  "integrations.native.error.orphanedMarker": "{path} has an hubapi start marker but no end marker. The file was left unchanged because hubapi cannot determine where its block ends.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop is pointed at standard mode, but old hubapi credential files remain at: {paths}.",
  ...
  "integrations.onboarding": "Applying writes one hubapi provider block after saving a backup. Disable removes only that block, and a retained snapshot can be restored.",
  "integrations.empty.title": "No installed clients were detected",
  "integrations.empty.body": "Install a supported client, then return here to apply hubapi.",
  ...
  "integrations.error.conflict": "The config changed after hubapi wrote it. Nothing was removed.",
  ...
  "integrations.bulk.body": "Only the hubapi-owned block is removed. A pre-write snapshot is kept for each client.",
  ...
  "integrations.semantics.dsh": "hubapi manages only llm-pi-ai.providers.opencodex in $DSH_HOME/settings.yaml. DSH hot reloads this provider; your default model and deepseek-official stay unchanged. Currently loopback-only; no real credential is written.",
  ...
  "accountPool.strategyDesc": "How hubapi assigns an account to a new/unbound task.",
  ...
  // api access page
  "api.title": "Proxy API",
  "api.subtitle": "Use generated API keys to access the hubapi proxy from external apps. Keys authenticate via the {authHeader} header; see the table below for what each endpoint accepts.",
  "api.proxy.title": "Unified proxy gateway",
  "api.proxy.online": "Online and accepting API requests",
  "api.proxy.flowLabel": "Proxy request flow",
  "api.proxy.clients": "Clients",
  "api.proxy.providers": "Providers",
  "api.proxy.baseUrl": "Base URL",
  "api.proxy.protocols": "Inbound protocols",
  "api.proxy.auth": "Authentication",
  ...
  "claude.smallFastModelNativeWarning": "When unset, hubapi leaves the helper-model overrides unset. Claude Code may use its native Sonnet model, which may incur charges from your native provider.",
  ...
  "cws.howBody": "Ask Codex for the combo's public model name. Without one, the default is combo/<id>. hubapi selects a target and hops only on retryable upstream failures. If no target remains available, the request fails closed instead of using the global default provider.",
  ...
  "grok.subtitle": "Models hubapi has registered in your Grok config.",
  ...
  "grok.notConfiguredHint": "Start or restart the proxy with Grok installed and hubapi writes a managed block into:",
