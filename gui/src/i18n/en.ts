...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.namespacesTitle": "Choose a Codex login per conversation",
  "codexAuth.namespacesOnDesc": "The model picker shows each GPT model once for every Codex login you've added. The prefix is that login's label, such as Personal or Work. Selecting one pins the conversation to that login and its quota; OpenCodex will not switch accounts.",
  "codexAuth.namespacesOffDesc": "Normally, GPT models use whichever Codex login is selected by the account mode above. Turn this on to choose the login directly from the model picker.",
  "codexAuth.namespacesCompatibilityNote": "This only adds account-specific model choices. It does not change your Pool or Direct settings, existing conversations, or saved model selections.",
  "codexAuth.namespacesSaved": "Account choices updated. Reopen Codex if the current model list is stale.",
  "codexAuth.namespacesSaveFailed": "Account choices could not be updated. The previous setting is unchanged.",
  "codexAuth.add": "Add",
