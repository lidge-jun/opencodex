...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.removeCleanupPending": "The account was removed, but local credential cleanup is still pending.",
  "codexAuth.removeCleanupRetry": "Retry cleanup",
  "codexAuth.removeCleanupComplete": "Account cleanup completed.",
  "codexAuth.removeCleanupRetryRefused": "Cleanup retry stopped because the account could not be confirmed absent.",
