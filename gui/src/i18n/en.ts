...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "codexAuth.autoSwitchResetWindowDesc": "Reset-window: {threshold}% is the drain point; accounts with headroom are ordered by their fresh governing reset.",
  "codexAuth.autoSwitchResetWindowOffDesc": "Reset-window has no usage drain point; fresh governing reset order still assigns new/unbound tasks.",
  ...
  "accountPool.strategyHintResetWindow": "Reset window orders unbound tasks by fresh governing reset timestamps; healthy bound tasks keep affinity.",
  "accountPool.resetOrder": "Reset order",
  "accountPool.resetOrderHelp": "Choose whether fresh future quota resets are drained from nearest to farthest or farthest to nearest.",
  "accountPool.resetOrderSoonest": "Soonest first",
  "accountPool.resetOrderLatest": "Latest first",
