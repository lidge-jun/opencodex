...
export const en = {
  ...
  "modal.browseFree": "Browse more free providers",
  "modal.browsePaid": "Browse more paid providers",
  "modal.browseBack": "Back to top picks",
  "modal.connect": "Connect",
  "modal.notListedTitle": "Provider not listed?",
  "modal.notListedSub": "You can add any OpenAI-compatible endpoint",
  "modal.connectApiKey": "Add custom endpoint",
  "modal.overwriteProvider": "Overwrite provider",
  "modal.overwriteWarnDetail": "Existing credentials, models, and custom settings for this provider will be replaced.",
  "modal.overwriteConfirm": "Overwrite existing provider “{name}”?",
  "modal.badge.api": "API",
  "modal.accountsEmpty": "No account-login providers available.",
  "modal.search": "Search providers…",
  "modal.logInWith": "Sign in with {label}",
  "modal.connectWith": "Connect {label}",
  "modal.signInWithProvider": "Sign in with {label}",
  ...
  "modal.oauthDefaultNote": "Sign in with your account to use available models and usage limits — no API key needed.",
  "modal.oauthConnectTitle": "Connect {label}",
  "modal.oauthConnectBody": "Sign in with your {label} account to use available models and usage limits.",
  "modal.anthropicOauthNote": "Sign in with your Claude account to use available models and usage limits.",
  "modal.forwardNote": "Uses your Codex login — no API key required.",
  "codexAuth.noPoolInline": "No pool accounts added yet.",
  "codexAuth.addAccount": "Add account",
  "pws.jsonRestoreTitle": "Restore the draft to the contents when you opened the editor (discards unsaved edits).",
  "pws.jsonSaved": "Configuration saved.",
  "pws.jsonSaveFailed": "Could not save configuration.",
  "pws.loadingProviders": "Loading providers…",
  "pws.noSearchResults": "No providers match your search.",
  "pws.quotaUnavailable": "Rate-limit data unavailable.",
  "pws.quotaRefreshFailed": "Could not refresh quotas.",
  "pws.modelsLoading": "Loading models…",
  "pws.modelsLoadFailed": "Could not load models for this provider.",
  "pws.providerGone": "This provider is no longer in the config.",
  "pws.providerGoneAction": "Back to overview",
  "pws.catalogLoading": "Loading catalog…",
  "modal.invalidApiKey": "Invalid API key — check the key and try again.",
  "modal.oauthCancelled": "Sign-in was cancelled or expired.",
  ...
  "modal.duplicateWarn": "{name} is already configured and will be overwritten.",
  ...
  "codexAuth.appLoginHint": "Signed in via the Codex / ChatGPT app session (not a pool account).",
  ...
  "quota.usedPercentExhausted": "{pct}% used · Limit reached",
  "quota.limitReached": "Limit reached",
  "quota.resetsIn": "Resets in {when}",
  "quota.resetsAt": "Resets on {date} at {time}",
  ...
  "codexAuth.autoSwitchDesc": "New sessions switch when the selected quota reaches 80%. Go and Free accounts use the 30-day usage window.",
  ...
  "codexAuth.addIdLabel": "Account name",
  "codexAuth.addIdPlaceholder": "codex-work, codex-alt, team…",
  "codexAuth.addIdHint": "Optional. Stored as an ID/slug under the Codex auth pool (for example ~/.codex/accounts/codex-work). Leave empty to auto-generate one after login.",
  "codexAuth.slugDuplicate": "Account name \"{id}\" is already in the pool.",
  "codexAuth.signInWithChatGpt": "Sign in with ChatGPT",
  "codexAuth.resetCreditsTitleTooltip": "{count} rate-limit reset credit(s). Click to view or redeem.",
  ...
  "pws.tab.usage": "Usage & limits",
  "pws.tab.settings": "Settings",
  "pws.sort.az": "A → Z",
  "pws.sort.za": "Z → A",
  "pws.sort.freePaid": "Free → Paid",
  "pws.sort.paidFree": "Paid → Free",
  ...
  "pws.auth.noKey": "No API key required",
  "pws.rail.selectAria": "Select provider {name}, {status}{suffix}",
  "pws.rail.suffixDefault": ", default",
  "pws.rail.suffixLocal": ", local",
  "pws.rail.suffixFree": ", free",
  "pws.defaultTitle": "Default routing provider",
  "pws.localTitle": "Local runtime",
  "pws.freeTitle": "Free tier — no API key required",
  "pws.modelCount": "{count} models",
  "pws.modelCountOne": "1 model",
  "pws.connection": "Connection",
  "pws.cell.lastChecked": "Last checked",
  "pws.cell.auth": "Authentication",
  "pws.cell.defaultModel": "Default model",
  "pws.ops.ok": "All systems operational",
  "pws.ops.creds": "Credentials required",
  "pws.ops.disabled": "Provider disabled",
  "pws.editSettings": "Edit settings",
  "pws.editAria": "Edit {name}",
  "pws.statsAria": "Provider stats",
  "pws.statsTitle": "Provider stats",
  ...
  "pws.quotaSource.cursorUsage": "Cursor usage",
  "pws.quotaSource.codex": "ChatGPT",
  "pws.quotaSource.unknown": "{source}",
  "pws.stats.viewDetailed": "View detailed usage",
  "pws.notesAria": "Provider notes",
  "pws.notes": "Notes",
  "pws.notesPlaceholder": "Add a note about this provider…",
  "pws.apiKeys": "API keys",
  "pws.loggedInTitle": "Logged in",
  "pws.notLoggedInTitle": "Not logged in",
  "pws.reauth": "Re-auth",
  "pws.activeAccount": "Active account",
  "pws.switchAccount": "Switch to this account",
  "pws.removeAccountAria": "Remove account {id}",
  "pws.currentLogin": "Current login",
  "pws.availableAccounts": "Available accounts",
  "pws.noApiKey": "No API key configured",
  "pws.activeKey": "Active key",
  "pws.switchKey": "Switch to this key",
  "pws.modelsAvailable": "{count} available",
  "pws.searchModels": "Search models…",
  "pws.copyModelId": "Copy model ID",
  "pws.modelCopied": "Copied",
  "pws.selected": "Selected",
  "pws.noDefaultModel": "No default model configured.",
  "pws.modelsResolvedRuntime": "Models are resolved at runtime from this provider's endpoint.",
  "pws.noStaticModels": "No static models available",
  "pws.noStaticModelsDesc": "Available models are discovered dynamically from the endpoint on each request, so a fixed model list cannot be shown here.",
  "pws.defaultModelUnset": "Default model: Not set",
  "pws.defaultModelLabel": "Default model",
  "pws.defaultModelNone": "Not set",
  "pws.noModelsMatch": "No models match your search.",
  "pws.usageTotals": "Usage totals (30d)",
  "pws.usageLast30d": "Last 30 days",
  "pws.metricRequests": "Requests",
  "pws.metricTokens": "Tokens",
  "pws.noUsageFor": "No usage recorded for {name}.",
  "pws.usageSummary": "{requests} requests and {tokens} tokens.",
  "pws.usageUnavailable": "Usage data is not available for this provider.",
  "pws.quotaContext": "Quota context",
  "pws.quotaUpdatedFrom": "Updated {when} from {source}.",
  "pws.quotaUpdated": "Checked {when}",
  "pws.quotaSource": "Source",
  "pws.lastUpdated": "Last updated",
  "pws.dailyLimit": "Daily limit",
  "pws.unavailable": "Unavailable",
  "pws.rateLimits": "Rate limits",
  "pws.noRateLimits": "No rate-limit windows reported yet. Sign in to ChatGPT or Claude and refresh quotas to see 5h / week usage and reset times.",
  "pws.jsonUnsavedTitle": "Unsaved JSON changes",
  "pws.jsonUnsavedDesc": "You have unsaved edits to the proxy config. Save them, discard them, or keep editing.",
  "pws.jsonUnsavedBadge": "Unsaved",
  "pws.jsonDiscard": "Discard changes",
  "pws.jsonKeepEditing": "Keep editing",
  "pws.jsonFormat": "Format",
  "pws.jsonRestore": "Restore",
  "pws.jsonInvalid": "Invalid JSON{where}",
  "pws.jsonInvalidAt": " at line {line}, column {column}",
  "pws.jsonLiveConfig": "Live configuration",
  "pws.updatesUnavailable": "Updates are not available.",
  "pws.adapterBaseRequired": "Adapter and Base URL are required.",
  "pws.settingsSaved": "Settings saved.",
  "pws.settingsDirty": "Unsaved changes",
  "pws.settingsUnsavedBar": "Unsaved changes",
  "pws.settingsUnsavedLeave": "You have unsaved settings. Discard them?",
  "pws.discardSettings": "Discard",
  "pws.advancedSettings": "Advanced settings",
  "pws.connectionSettings": "Connection settings",
  "pws.providerId": "Provider ID",
  "pws.renameUnsupported": "Rename is not supported — remove and re-add to change the id.",
  "pws.immutableId": "Immutable id used in routing and config keys.",
  "pws.note": "Note",
  "pws.notePlaceholder": "Optional note",
  "pws.optionalPlaceholder": "Optional",
  "pws.authMode": "Auth mode",
  "pws.authForward": "Passthrough",
  "pws.authForwardDesc": "Requests are forwarded through your ChatGPT login. This provider does not need its own API key.",
  "pws.authForwardManageHint": "Manage ChatGPT accounts under Overview → Account login.",
  "pws.authForwardCredentials": "Managed in Overview",
  "pws.authForwardPoolHint": "These ChatGPT accounts are shared by all ChatGPT passthrough providers. Switching applies on the next Codex session.",
  "pws.authForwardNextSession": "Next session: {email}",
  "pws.authCurrent": "Current: {mode}",
  "pws.authCurrentForward": "{label} ({technical})",
  "pws.apiKeyKeepPlaceholder": "••••••••  (leave blank to keep)",
  "pws.configured": "Configured",
  "pws.missing": "Missing",
  "pws.keyReplaceHint": "Enter a new value only to replace it.",
  "pws.keyRequiredHint": "Required for key-auth providers.",
  "pws.signInStatus": "Sign-in status",
  "pws.signedInAs": "Signed in as {email}.",
  "pws.signedIn": "Signed in.",
  "pws.notSignedInHint": "Not signed in — use CLI login or add an account from Providers.",
  "pws.freeTierDesc": "Free tier — no API key required.",
  "pws.saving": "Saving…",
  "pws.saveSettings": "Save settings",
  "pws.providerState": "Provider state",
  "pws.providerDisabledLabel": "Provider disabled",
  "pws.providerEnabledLabel": "Provider enabled",
  "pws.disabledRoutingHint": "Disabled providers are excluded from model routing.",
  "pws.detailAria": "{name} provider details",
  "pws.backToAll": "Provider Overview",
  ...
  "pws.probeModels": "Probe models for this provider",
  "pws.removeProvider": "Remove provider",
  "pws.removeProviderAria": "Remove provider {name}",
  "pws.enabledLabel": "Enabled",
  "pws.tabsAria": "{name} tabs",
  "pws.connectionFailed": "Connection failed",
  "pws.removeConfirmTitle": "Remove provider \"{name}\"?",
  "pws.removeConfirmDesc": "Removes this provider from OpenCodex, including its stored credentials and settings. This cannot be undone from the UI.",
  "pws.removeConfirmUi": "Remove provider \"{name}\"? This cannot be undone from the UI.",
  "pws.emptyTitle": "No providers yet",
  "pws.emptySub": "Get started by connecting your first provider.",
  "pws.addProvider": "Add provider",
  "pws.connectFirst": "Connect your first provider",
  "pws.connectFirstSub": "Pick a catalog provider or wire any OpenAI-compatible endpoint.",
  "pws.empty.browseFree": "Browse free providers",
  "pws.empty.browseFreeDesc": "No key required",
  "pws.empty.connectAccount": "Connect an account",
  "pws.empty.connectAccountDesc": "Use ChatGPT, Claude, Cursor and others",
  "pws.empty.addEndpoint": "Add API endpoint",
  "pws.empty.addEndpointDesc": "Use an API key or OpenAI-compatible endpoint",
  "pws.browseProviders": "Browse providers",
  "pws.browseProvidersDesc": "Connect to popular cloud providers",
  "pws.customProviderDesc": "Any OpenAI-compatible base URL + key",
  "pws.notSure": "Not sure where to start?",
  "pws.viewDocs": "View documentation",
  "pws.overviewTitle": "Providers overview",
  "pws.overviewSub": "Manage all your model providers in one place.",
  "pws.needSetup": "Need setup",
  "pws.addProviderDesc": "Browse catalog providers",
  "pws.customEndpointDesc": "Any OpenAI-compatible endpoint",
  "pws.editJsonDesc": "Edit the raw proxy config as JSON",
  "pws.attentionRequired": "Attention required",
  "pws.attentionAria": "{name}: {reason}",
  "pws.recentlyUsed": "Recently used",
  "pws.noUsageRecorded": "No usage recorded.",
  "pws.openProvider": "Open {name}",
  "pws.requestsCount": "{count} requests",
  ...
  "pws.resetAll": "Reset filters",
  "pws.noResults": "No results for “{search}”",
  "pws.noMatchFilters": "No providers match the current filters.",
  ...
  "pws.workspaceMainAria": "Provider workspace",
  "pws.providersAria": "Providers",
  "pws.providerFiltersAria": "Provider filters",
  "pws.savedName": "Saved {name}",
  "pws.updateFailed": "Failed to update {name}",
  "pws.jsonEditorDesc": "Edit the live proxy config as JSON. Secrets are masked in this view — prefer per-provider Settings or Add API key for credentials.",
  "pws.workspace": "Workspace",
  "pws.freeTier": "free tier",
  "pws.filterType": "Type",
  "pws.type.cloud": "Cloud",
  "pws.type.local": "Local",
  "pws.type.selfHosted": "Self-hosted",
  "pws.type.account": "Accounts",
  "modal.manage": "Manage",
} as const;
