...
"common.discard": "Discard",
  ...
  "compactionRouting.providerWarningScoped": "With this setting, only compaction requests from {sources} send the full conversation contents to {provider} for summarization; other conversations keep their own model.",
  "compactionRouting.comboWarningScoped": "With this setting, only compaction requests from {sources} send the full conversation contents to combo {combo} for summarization; other conversations keep their own model. The combo attempts its targets ({providers}) in order and uses the first that answers, so any one of them can receive those conversations.",
