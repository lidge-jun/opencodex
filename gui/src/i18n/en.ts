// English — source of truth. Its keys define the TKey type; de/fr/ko/zh/zh-TW/ru/ja/tr/th must match (compile-checked).
...
export const en = {
  ...
  "common.retry": "Retry",
  "auth.adminTokenTitle": "PaohupByPaoZa admin token (OPENCODEX_ADMIN_AUTH_TOKEN)",
  ...
  "app.logoAria": "PaohupByPaoZa logo",
  ...
  "startup.subtitle": "Verify that Codex can reach PaohupByPaoZa after a restart, before local proxy routing becomes a reconnect loop.",
  ...
  "startup.summary.protected": "PaohupByPaoZa will be available after restart",
  ...
  "startup.riskDetailCustomLocal": "Codex points to a custom local gateway. PaohupByPaoZa cannot manage or verify that gateway's restart lifecycle.",
  ...
  "startup.codexRuntime.clampHidden": "Some reasoning effort options were hidden because PaohupByPaoZa used Codex {version}.",
  "startup.codexRuntime.clampHiddenWithEfforts": "Some reasoning effort options were hidden because PaohupByPaoZa used Codex {version} (removed: {efforts}).",
  "startup.codexRuntime.olderBinary": "PaohupByPaoZa is using an older Codex binary ({version}). A newer installation is available.",

  // dashboard
  "dash.subtitle": "Live status of the local PaohupByPaoZa proxy, its providers, and the models routed into Codex.",
  ...
  "dash.codexAutoStart": "Start PaohupByPaoZa with Codex",
  ...
  "dash.shadowCallTooltip": "Codex App makes background helper calls for thread title generation, commit message generation, and skill orchestration. The helper model changed across client versions, so PaohupByPaoZa intercepts every model in this set: {models}. Enable this to redirect those calls to your chosen model.",
  ...
  "dash.maintenanceHint": "Refresh Codex's model catalog or install a newer PaohupByPaoZa release.",
  ...
  "dash.projectConfigTitle": "Project Codex config bypasses PaohupByPaoZa",
  "dash.projectConfigHint": "These repo-local settings override the PaohupByPaoZa proxy (e.g. route to OpenCode Go directly). Remove them so ~/.codex/config.toml routing applies in that project.",
  "dash.checkUpdate": "Check update",
  "dash.updateTitle": "Update PaohupByPaoZa",
  ...
  "dash.updateStatus.running": "Updating PaohupByPaoZa.",
  ...
  // providers
  "prov.subtitle": "Configure the upstream providers PaohupByPaoZa routes into Codex. Log in with an account, add a provider, or edit the raw config.",
  ...
  "oauthTos.anthropicBody": "Directly reusing Claude subscription OAuth tokens through a third-party proxy such as PaohupByPaoZa is not a supported Anthropic integration and may lead to access restrictions. Supported Agent SDK integrations that use Claude subscriptions are separate.",
  "oauthTos.highBody": "PaohupByPaoZa connects {provider} through a third-party OAuth path. Unsupported use may lead to access limits or suspension.",
  "oauthTos.elevatedBody": "PaohupByPaoZa connects {provider} through an unofficial OAuth path. Use the official client when possible; unusual or automated traffic may be treated as abuse and access may be limited or suspended.",
  "oauthTos.saferPath": "Safer option: configure an API key in PaohupByPaoZa instead.",
  ...
  "models.subtitle": "Toggle which models Codex sees — native GPT passthrough and routed providers, grouped by provider (click a header to collapse). Hidden models stay off the catalog + model picker but remain directly callable by exact id. Changes apply on the next Codex turn — PaohupByPaoZa invalidates Codex's 5-min model cache so no restart is needed.",
  ...
  // subagents
  "sub.subtitle": "Codex's {cmd} advertises only the first 5 models (by priority) as overrides. Pick up to 5 here — native gpt or routed — and PaohupByPaoZa sets their catalog priority so exactly these lead. Any other model is still callable by its exact name; this only controls what's shown.",
  ...
  "logs.tabLogs": "Logs",
  "logs.tabDebug": "Debug",
  "logs.subtitle": "Recent requests routed through the local PaohupByPaoZa proxy, newest first.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "brain.subtitle": "Read-only observatory: agents, tasks, skills, nodes, memory.",
  "brain.askPlaceholder": "Ask Pao Brain...",
  "brain.search": "Search",
  "brain.loading": "Loading...",
  "brain.loadFailed": "Could not load observatory data.",
  "brain.tab.agents": "Agents",
  "brain.tab.tasks": "Tasks",
  "brain.tab.skills": "Skills",
  "brain.tab.nodes": "Nodes",
  "brain.tab.memory": "Memory",
  "brain.tab.search": "Search",
  "brain.empty.agents": "No agents registered.",
  "brain.empty.tasks": "No tasks in the queue.",
  "brain.empty.skills": "No skills registered.",
  "brain.empty.nodes": "No remote nodes registered.",
  "brain.empty.memory": "No memories recorded.",
  "brain.empty.search": "Type a question to search the local universe.",
  "brain.empty.searchResults": "No local matches.",
  "brain.col.name": "Name",
  "brain.col.provider": "Provider",
  "brain.col.type": "Type",
  "brain.col.health": "Health",
  "brain.col.enabled": "Enabled",
  "brain.col.title": "Title",
  "brain.col.kind": "Kind",
  "brain.col.status": "Status",
  "brain.col.attempts": "Attempts",
  "brain.col.version": "Version",
  "brain.col.capabilities": "Capabilities",
  "brain.permits.pending": "Pending write permits",
  "brain.permits.grant": "Grant",
  "brain.permits.deny": "Deny",
  "brain.tab.policies": "Policies",
  "brain.policies.capability": "Capability",
  "brain.policies.subject": "Subject",
  "brain.policies.effect": "Effect",
  "brain.policies.addAllow": "Allow",
  "brain.policies.addDeny": "Deny",
  "brain.policies.empty": "No policies configured.",
  "brain.policies.remove": "Remove",
  "brain.tab.projects": "Projects",
  "brain.projects.name": "Project name",
  "brain.projects.path": "Root path",
  "brain.projects.add": "Add",
  "brain.projects.scan": "Scan",
  "brain.projects.empty": "No projects registered.",
  "brain.projects.files": "files",
  "brain.projects.lastScan": "Last scan",
  "brain.tab.atlas": "Atlas",
  "brain.tab.universe": "Universe",
  ...
  "demo.loadScenario": "Load Smart Factory Scenario",
  "demo.reset": "Reset Demo",
  "demo.noProject": "No project yet. Load the scenario.",
  "demo.scenarioLoaded": "Scenario loaded.",
  "demo.resetDone": "Demo reset.",
  "demo.approvalsTitle": "Pending approvals",
  "demo.approvalsNone": "No pending approvals.",
  "demo.activityTitle": "Agent Activity",
  "demo.activityNone": "No agent activity yet.",
  "brain.tab.tools": "Tools",
  "brain.tab.activity": "Activity",
  "brain.tool.risk": "Risk",
  "brain.tool.readOnly": "Read-only",
  "brain.tool.execute": "Execute",
  "brain.tool.empty": "No tools registered.",
  "brain.activity.empty": "No agent activity yet.",
  "brain.activity.tool": "Tool",
  "brain.activity.actor": "Actor",
  "brain.activity.result": "Result",
  "brain.graph.selectProject": "Project",
  "brain.graph.empty": "No graph data. Scan a project first.",
  "brain.graph.nodes": "nodes",
  "brain.graph.edges": "edges",
  "brain.graph.capped": "Showing the first 180 nodes.",
  "brain.graph.aria": "Brain Universe graph",
  "nav.openMenu": "Open menu",
  "nav.closeMenu": "Close menu",
  "integrations.subtitle": "Connect clients to PaohupByPaoZa, manage credentials, and restore client configuration.",
  ...
  "integrations.codex.body": "Codex wiring is owned by the proxy service. Starting PaohupByPaoZa applies it; stopping the service restores native routing.",
  ...
  "integrations.detail.grokAbsent": "No PaohupByPaoZa block in the config",
  "integrations.dialog.grok.title": "Disable the Grok Build integration?",
  "integrations.dialog.grok.changes": "Only the block marked by PaohupByPaoZa will be removed from {path}. Content written outside the block will remain unchanged.",
  "integrations.dialog.grok.breakage": "Disabling removes the PaohupByPaoZa model aliases from Grok Build. Models used with your xAI account remain available.",
  "integrations.dialog.grok.undo": "If PaohupByPaoZa is running on a loopback address, turning this back on writes a new block from the models currently available.",
  "integrations.dialog.grok.confirm": "Disable",
  "integrations.dialog.desktop.title": "Disable Claude Desktop integration?",
  "integrations.dialog.desktop.changes": "If {path} contains an PaohupByPaoZa-managed gateway profile, Desktop will first select a new credential-free standard profile, then remove the old profile and backup.",
  "integrations.dialog.desktop.breakage": "Claude Desktop will return to standard Claude instead of models routed through PaohupByPaoZa.",
  "integrations.dialog.desktop.undo": "Turning this back on regenerates the PaohupByPaoZa profile from your saved model assignments.",
  ...
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build can be registered automatically only while PaohupByPaoZa runs on a loopback address. The previous block that pointed to loopback was removed.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build can be registered automatically only while PaohupByPaoZa runs on a loopback address. There was no previous block to remove.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build can be registered automatically only while PaohupByPaoZa runs on a loopback address. Another process wrote a new block in the meantime, so the block now in the file was not created by this request.",
  "integrations.native.error.orphanedMarker": "{path} has an PaohupByPaoZa start marker but no end marker. The file was left unchanged because PaohupByPaoZa cannot determine where its block ends.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop is pointed at standard mode, but old PaohupByPaoZa credential files remain at: {paths}.",
  ...
  "integrations.onboarding": "Applying writes one PaohupByPaoZa provider block after saving a backup. Disable removes only that block, and a retained snapshot can be restored.",
  "integrations.empty.title": "No installed clients were detected",
  "integrations.empty.body": "Install a supported client, then return here to apply PaohupByPaoZa.",
  ...
  "integrations.error.conflict": "The config changed after PaohupByPaoZa wrote it. Nothing was removed.",
  ...
  "integrations.bulk.body": "Only the PaohupByPaoZa-owned block is removed. A pre-write snapshot is kept for each client.",
  ...
  "integrations.semantics.dsh": "PaohupByPaoZa manages only llm-pi-ai.providers.opencodex in $DSH_HOME/settings.yaml. DSH hot reloads this provider; your default model and deepseek-official stay unchanged. Currently loopback-only; no real credential is written.",
  ...
  "accountPool.strategyDesc": "How PaohupByPaoZa assigns an account to a new/unbound task.",
  ...
  "api.subtitle": "Use generated API keys to access the PaohupByPaoZa proxy from external apps. Keys authenticate via the {authHeader} header; see the table below for what each endpoint accepts.",
  ...
  "claude.smallFastModelNativeWarning": "When unset, PaohupByPaoZa leaves the helper-model overrides unset. Claude Code may use its native Sonnet model, which may incur charges from your native provider.",
  ...
  "cws.howBody": "Ask Codex for the combo's public model name. Without one, the default is combo/<id>. PaohupByPaoZa selects a target and hops only on retryable upstream failures. If no target remains available, the request fails closed instead of using the global default provider.",
  ...
  "grok.subtitle": "Models PaohupByPaoZa has registered in your Grok config.",
  ...
  "grok.notConfiguredHint": "Start or restart the proxy with Grok installed and PaohupByPaoZa writes a managed block into:",
