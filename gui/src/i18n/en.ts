...
export const en = {
  ...
  "models.contextWindowEdit": "Context windows",
  "models.contextWindowHint": "Override the advertised context window per model (tokens). Blank = use the provider default.",
  "models.contextWindowModel": "Model",
  "models.contextWindowValue": "Window",
  "models.contextWindowLive": "live",
  ...
  "models.noVisionLabel": "No vision",
  "models.noVisionHint": "Mark text-only models. The vision sidecar describes images for them.",
  "models.noVisionApplied": "Vision setting saved.",
  ...
  // model source (auto-discover vs manual)
  "modal.modelSource": "Models",
  "modal.modelSourceAuto": "Auto-discover from provider",
  "modal.modelSourceAutoHint": "Model list is fetched live from the provider's /models endpoint.",
  "modal.modelSourceManual": "Set models manually",
  "modal.manualModelsPlaceholder": "One model ID per line, e.g. gpt-5.5",
  "modal.manualModelsRequired": "Enter at least one model ID, or switch to auto-discover.",
  "modal.manualModelsDefaultHint": "Default model is not in the manual list.",
  "modal.manualModelsDefaultError": "Default model must appear in the manual list, or clear the default model.",
