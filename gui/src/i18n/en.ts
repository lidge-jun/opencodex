...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "codexAuth.accountPickerCustomizeTitle": "Customize models per account",
  "codexAuth.accountPickerCustomizeOffDesc": "Every account selector currently shows every available model, the same as before this setting existed.",
  "codexAuth.accountPickerCustomizeOnDesc": "Choose which models appear under each account selector below. Common pool models keep showing everywhere.",
  "codexAuth.accountPickerCustomizeUpdated": "Per-account model customization updated.",
  "codexAuth.accountPickerCustomizeUpdateFailed": "Could not update per-account model customization. The last confirmed setting is shown.",
  "codexAuth.accountPickerModelsCommonNote": "Common pool models remain visible in the picker regardless of the selections below.",
  "codexAuth.accountPickerModelsSearchPlaceholder": "Search models…",
  "codexAuth.accountPickerModelsNoMatch": "No models match your search.",
  "codexAuth.accountPickerModelsSelectedCount": "{n} selected",
  "codexAuth.accountPickerModelsSaved": "Model selection saved.",
  "codexAuth.accountPickerModelsSaveFailed": "Could not save the model selection. Try again.",
  "codexAuth.accountPickerModelsNoAccounts": "No account selectors are available yet.",
  "codexAuth.accountPickerOnDescCustomized": "Each selector is a public label for one stored account. Choosing it locks that conversation to the mapped account: it never rotates or falls back, and it does not change the active Pool account. Common pool models keep appearing alongside your selected per-account models below.",
