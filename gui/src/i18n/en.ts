...
export const en = {
  ...
  "modal.connectApiKey": "Connect API key",
  "modal.badge.api": "API",
  ...
  "pws.freeTitle": "No API key required",
  ...
  "pws.renameUnsupported": "Rename is not supported yet — remove and re-add to change the id.",
  ...
  "pws.freeTierDesc": "This provider does not require an API key.",
  "pws.saving": "Saving…",
