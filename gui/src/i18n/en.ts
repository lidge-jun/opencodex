...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "cws.jev.modelProfile": "Model profile for JEV",
  "cws.jev.modelProfilePlaceholder": "Optional: leave blank to use the built-in profile.",
  "cws.jev.modelProfileHint": "Describe capability, context and relative subscription cost. Sent to TypeSafe on every JEV decision.",
  "cws.err.invalidModelProfile": "Model profile must be at most 512 characters.",
