...
export const en = {
  ...
  "modal.endpoint.chinaMainland": "China mainland",
  "modal.endpoint.international": "International",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "modal.catalogModes": "Provider access modes",
  "modal.accessGroups": "Free access groups",
  "modal.providerDirectory": "Provider directory",
  "modal.searchCount": "Search {count} providers",
  "modal.group.all": "All providers",
  "modal.group.recurring-or-keyless": "Recurring / keyless",
  "modal.group.recurring-uncapped": "No public token cap",
  "modal.group.recurring-credit": "Recurring credits",
  "modal.group.signup-credit": "Signup credits",
  "modal.group.existing": "Existing free & local",
  "modal.paidHint": "Browse paid providers and providers with one-time signup credit.",
  "modal.selectProvider": "Select a provider",
  "modal.selectProviderHint": "Choose a provider to view setup and discover models.",
  "modal.badge.recurring": "Free recurring",
  "modal.badge.reference": "Reference",
  "modal.badge.experimental": "Experimental",
  "modal.badge.supported": "Supported",
  "modal.verification.official": "Official docs",
  "modal.verification.primary": "Primary source",
  "modal.verification.unverified": "Unverified",
  "modal.providerDocs": "Provider docs",
  "modal.referenceExplanation": "This entry is reference-only. Automated calling and model discovery remain disabled until a documented transport has been verified.",
  ...
  "modal.discoveredModels": "Discovered models",
  "modal.discoveryFailed": "No models could be discovered for this setup.",
  "modal.backToDirectory": "Back to provider directory",
  "modal.setupReviewProvider": "Review the {label} setup documentation.",
  "modal.setupReferenceStep": "Use this entry as setup guidance until verified calling support is available.",
  "modal.setupKeylessStep": "Confirm the endpoint below; an API key is optional.",
  "modal.setupDiscoverStep": "Discover and choose a default model.",
