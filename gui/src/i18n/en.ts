...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "api.subtitle": "Use generated API keys to access the opencodex proxy from external apps. Authenticate requests with {authHeader}.",
  "api.endpoint": "Endpoint",
  "api.endpointNote": "Compatible with OpenAI Responses API format.",
  "api.tunnelTitle": "Cloudflare public access",
  "api.tunnelStatusStopped": "Off",
  "api.tunnelStatusStarting": "Starting",
  "api.tunnelStatusRunning": "Public",
  "api.tunnelStatusStopping": "Stopping",
  ...
  "api.tunnelStarting": "Starting…",
  "api.tunnelStopping": "Stopping…",
  ...
  "api.tunnelSetupIntro": "Connect your Cloudflare account automatically, or use credentials from an existing tunnel.",
  "api.tunnelSseNote": "Named Tunnel is the default and supports SSE streaming end to end.",
  "api.tunnelSetupMethod": "Tunnel setup method",
  "api.tunnelSetupAutomatic": "Configure automatically",
  "api.tunnelSetupAutomaticDesc": "Create the tunnel, DNS route, and local connector in one step with a scoped API token.",
  "api.tunnelSetupExisting": "Use an existing tunnel",
  "api.tunnelSetupExistingDesc": "Paste its public URL and tunnel token, or the cloudflared install command.",
  "api.tunnelAccountId": "Cloudflare account ID",
  "api.tunnelAccountIdPlaceholder": "Enter the account ID",
  "api.tunnelZoneId": "Cloudflare zone ID",
  "api.tunnelZoneIdPlaceholder": "Enter the zone ID",
  "api.tunnelHostname": "Public hostname",
  "api.tunnelHostnamePlaceholder": "api.example.com",
  "api.tunnelName": "Tunnel name (optional)",
  ...
  "api.tunnelApiPermissions": "Use a scoped token with only Account: Cloudflare Tunnel Edit and Zone: DNS Edit permissions.",
  "api.tunnelReplaceExistingConfirm": "I understand this creates a new Tunnel and DNS record. The previous Cloudflare resources are not deleted automatically and must be removed manually after verification.",
  "api.tunnelExistingPublicUrl": "Existing public URL",
  "api.tunnelExistingPublicUrlPlaceholder": "https://api.example.com",
  "api.tunnelTokenOrCommand": "Tunnel token or install command",
  "api.tunnelTokenOrCommandPlaceholder": "Paste the tunnel token or cloudflared install command",
  "api.tunnelTokenSecurity": "The Cloudflare API token is used only for this setup request and is never written to disk. Only the tunnel runner token is stored locally.",
  "api.tunnelRunnerTokenSecurity": "The tunnel runner token is stored in a protected local credential file and is never returned by the management API.",
  "api.tunnelOpenDashboard": "Open Cloudflare dashboard",
  "api.tunnelTokenGuide": "API token guide",
  "api.tunnelExistingGuide": "Named Tunnel guide",
  "api.tunnelConfiguring": "Configuring…",
  "api.tunnelConfigureStart": "Configure and enable",
