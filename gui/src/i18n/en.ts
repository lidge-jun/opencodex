...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.namespacesTitle": "Show each Codex account separately in the model picker",
  "codexAuth.namespacesOnDesc": "Each available Codex account gets a separate entry for every GPT model. Main identifies the built-in login. Each public picker label maps privately to one stored account. Added accounts use their user-owned alias, or a stable privacy-safe pXXXXXX label when no alias is set; stored account IDs and emails are never used. Existing and custom labels remain unchanged. Selecting one pins the conversation to that exact account; OpenCodex will not switch or fall back to another account.",
  "codexAuth.namespacesOffDesc": "Turn this on when you have multiple Codex accounts and want to choose exactly which account a conversation uses without logging out. Turning it off only hides these picker entries; it does not remove any account.",
  "codexAuth.namespacesCompatibilityNote": "This replaces the regular GPT picker entries with explicit account-specific choices. Existing conversations, custom account labels, and saved model selections keep their current routing; bare GPT model IDs keep their Pool or Direct behavior.",
  "codexAuth.namespacesSaved": "Account-specific picker entries updated. Reopen Codex if the current model list is stale.",
  "codexAuth.namespacesSaveFailed": "The model picker could not be updated. The previous setting is unchanged.",
  "codexAuth.add": "Add",
  ...
  "codexAuth.catalogRefreshPending": "The account change was saved, but the model picker could not refresh. Run `ocx sync` to retry.",
