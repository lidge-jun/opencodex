...
export const en = {
  ...
  "prov.apiProviders": "API Providers",
  "prov.apiProvidersHint": "Only configured API-key providers are shown. Use + to add more.",
  "prov.noApiProviders": "No API providers configured yet.",
  "prov.addApiProvider": "Add API provider",
  "prov.addApiProviderDesc": "Choose a provider that supports API keys and complete its setup.",
  "prov.apiReady": "Ready",
  "prov.restartCodex": "Restart Codex",
  "prov.restartCodexConfirm": "Codex will close and reopen. Any active turn will be interrupted. Restart now?",
  "prov.restartCodexFailed": "Could not restart Codex: {error}",
  "prov.addedRestartRequired": "Added \"{name}\" and synced its models. Restart Codex to refresh the app.",
  "modal.addApiProvider": "Add API Provider",
  "modal.apiProvidersHint": "Choose an API-key provider, then enter its key and endpoint settings.",
  "prov.noAccountProvidersMatch": "No matching account providers.",
  "prov.noConnectedAccounts": "No account providers connected yet.",
  "prov.searchAccountProviders": "Search account providers",
  "prov.connectAccountDesc": "Search providers that support account login. Connected providers appear in the list.",
  "prov.connectAccountTitle": "Connect account provider",
  "prov.connectAccount": "Connect",
  "prov.accountLoginHint": "Only connected account providers are shown. Use + to find and connect more.",
  ...
  "prov.loginOk": "Logged in to {provider}. Models synced to Codex.",
  "prov.modelSyncFailed": "Provider connected, but model sync failed. Run {cmd} to retry.",
  ...
  "prov.added": "Added \"{name}\". Live now — models synced to Codex.",
