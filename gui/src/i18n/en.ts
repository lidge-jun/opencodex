...
export const en = {
  ...
  "memory.growthLabel": "growth:",
  "memory.growthValue": "{mb} MB/h",
  "memory.notAvailable": "n/a",
  "memory.restartsLabel": "restarts:",
  "memory.privateLabel": "private:",
  "memory.commitLabel": "system commit:",
  "memory.commitValue": "{used} / {limit} GB ({pct}%)",
  "memory.responseCacheLabel": "response cache:",
  "memory.responseCacheValue": "{count} items · {mb} MB",
  "memory.probeLabel": "probe:",
  "memory.probeAgo": "{s}s ago",
  "memory.probeDegraded": "degraded ({code})",
  "memory.mbValue": "{mb} MB",
  "memory.supervisorLabel": "supervisor:",
  "memory.supervisorDetected": "detected ({hint})",
  "memory.supervisorNotDetected": "not detected",
  "memory.recommended": "Recommended",
  "memory.recSummary": "warn {warn}% · critical {crit}% · auto-restart {auto}",
  "memory.applyRecommended": "Apply recommended",
  "memory.enabledLabel": "Enabled",
  "memory.warnLabel": "Warn %",
  ...
  "memory.autoRestartNote": "When automatic restart begins, new requests are paused and in-progress responses are given up to {seconds} seconds to finish. A streaming response that does not finish in time may be interrupted and may need to be retried by the client. Completed responses are unaffected, and restarts are rate-limited.",
  "memory.graceLabel": "Restart grace period (seconds)",
  "memory.applyGrace": "Apply grace",
  "memory.graceRangeError": "Enter {min}–{max} seconds.",
  "memory.graceCooldownError": "Cannot exceed the minimum restart interval ({seconds}s).",
