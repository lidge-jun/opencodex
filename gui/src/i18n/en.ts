...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "cws.group.weighted": "Weighted",
  "cws.group.leastUsed": "Least used",
  "cws.group.resetWindow": "Reset window",
  ...
  "cws.count.weighted": "Weighted",
  "cws.count.leastUsed": "Least used",
  "cws.count.resetWindow": "Reset window",
  ...
  "cws.strategy.randomHint": "Weighted random selection. Higher-weight targets are more likely to be chosen on each request.",
  "cws.strategy.leastUsedHint": "Pick the target with the fewest recorded uses, spreading load across all targets.",
  "cws.strategy.resetWindowHint": "Prefer targets whose known quota window resets soonest. Targets without a known reset time remain fallback targets.",
  ...
  "cws.targets.randomHint": "Weights control the chance of each target being selected on a request.",
  "cws.targets.leastUsedHint": "Order breaks ties when targets have the same successful-use count.",
  "cws.targets.resetWindowHint": "Order breaks ties and remains the fallback when no cached quota reset time is available.",
