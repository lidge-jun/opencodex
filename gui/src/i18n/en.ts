...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.namespacesTitle": "Account-specific models",
  "codexAuth.namespacesOnDesc": "Personal / … and account-aliased model choices are available and stay strictly bound to that account.",
  "codexAuth.namespacesOffDesc": "Add explicit Personal / … and Work / … choices to the Codex model picker.",
  "codexAuth.namespacesSaved": "Account-specific models updated. Reopen Codex if the current model list is stale.",
  "codexAuth.namespacesSaveFailed": "Account-specific models could not be updated. The previous setting is unchanged.",
  "codexAuth.pickerModeTitle": "Picker layout",
  "codexAuth.pickerModeAdditive": "Bare + accounts",
  "codexAuth.pickerModeReplace": "Accounts only",
  "codexAuth.pickerModeAdditiveDesc": "Shows bare OpenAI models alongside the Personal / Work account choices.",
  "codexAuth.pickerModeReplaceDesc": "Shows only account-qualified OpenAI choices. Other providers remain unchanged.",
  "codexAuth.pickerModeSaved": "Picker updated. Reopen Codex if the current model list is stale.",
  "codexAuth.pickerModeSaveFailed": "The picker setting could not be saved. The previous selection is unchanged.",
  "codexAuth.add": "Add",
