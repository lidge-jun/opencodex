...
export const en = {
  ...
  "models.customFieldCodexAccount": "Codex account for this model",
  "models.customAccountTargetAutomatic": "Automatic (provider Pool/Direct)",
  "models.customAccountTargetHint": "Optional exact binding. The request fails closed instead of switching accounts when this target is unavailable.",
  "models.customAccountTargetPaused": "paused",
  "models.customAccountTargetUnavailable": "Previously selected account (unavailable)",
  "models.customAccountTargetLoadFailed": "Failed to load Codex account choices",
