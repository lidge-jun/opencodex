...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.field.aliasHint": "Optional. Clients request this exact name instead of the default. Use a bare id like deepseek-v4-flash when a mandated model name is required — no combo/ prefix is shown.",
