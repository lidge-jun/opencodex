...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "api.tunnelModeQuick": "Quick Tunnel · Temporary development access, up to 200 in-flight requests, and no SSE support. The public URL changes after restart.",
  "api.tunnelModeNamed": "Named Tunnel · Stable public access with SSE support, suitable for streaming.",
