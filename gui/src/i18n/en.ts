...
"common.discard": "Discard",
  ...
  "subagentSurface.selectionBody": "On {mode}, a task handed from a ChatGPT model to a routed model such as Grok or Claude arrives encrypted for the ChatGPT backend, and the routed model cannot read it. Cross-provider delegation fails with unreadable_encrypted_agent_task until this is fixed upstream. v1 delegates across providers reliably.",
  "subagentSurface.advisoryTitle": "v1 is now the default sub-agent surface",
  "subagentSurface.advisoryBody": "This install runs {mode}, which hands ChatGPT-to-routed tasks over encrypted and breaks cross-provider delegation. We recommend v1 until that is fixed upstream. Your current setting is unchanged until you choose.",
