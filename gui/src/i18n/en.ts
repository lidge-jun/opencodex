...
"common.discard": "Discard",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.capacity.missingQuota": "No current quota data: {count} account(s).",
  "pws.capacity.unknownPlan": "Unknown plan: {count} account(s).",
  "pws.capacity.pausedAccounts": "Paused: {count} account(s).",
  "pws.capacity.reauthAccounts": "Reauthentication required: {count} account(s).",
  "pws.capacity.staleQuota": "Stale quota data: {count} account(s).",
...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "codexAuth.managedByCodex": "Managed by Codex",
  "codexAuth.keyringDetailsPending": "OpenCodex cannot read Codex's keyring login. Account type and quota appear after the first successful request through this proxy.",
