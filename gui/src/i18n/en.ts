...
export const en = {
  ...
  "nav.advisor": "Advisor",
  "advisor.description": "An independent expert model that reviews the worker's task and returns advice. OpenCodex owns the consultation: the worker can call the synthetic advisor tool, and policy preflight guarantees one automatic consultation per task without any worker cooperation.",
  ...
  "advisor.effort": "Reasoning",
  "advisor.policy": "Policy",
  "advisor.policy.manual": "Manual — only when the worker asks",
  "advisor.policy.preflight": "Preflight — guaranteed consultation per task",
