...
export const en = {
  ...
  "common.retry": "Retry",
  "remote.title": "Remote",
  "remote.subtitle": "Connect this OpenCodex installation to your account, then use its encrypted terminals from your Remote address.",
  "remote.refresh": "Refresh Remote status",
  "remote.progressLabel": "Remote setup progress",
  "remote.stepAccount": "OpenCodex account",
  "remote.stepPassword": "Access password",
  "remote.stepTunnel": "Computer link",
  "remote.loading": "Loading Remote status…",
  "remote.loadFailed": "Could not load Remote status.",
  "remote.signedOutTitle": "Connect this computer",
  "remote.signedOutBody": "Connect this computer through OpenCodex Remote. This local OCX receives only a revocable OpenCodex device credential.",
  "remote.signIn": "Connect Remote",
  "remote.starting": "Starting…",
  "remote.identityTitle": "Identity stays central",
  "remote.identityBody": "The service handles GitHub OAuth and never sends your GitHub token to this computer.",
  "remote.deviceTitle": "One credential per device",
  "remote.deviceBody": "This OCX creates its own device key and can be revoked without signing out your other computers.",
  "remote.tunnelTitle": "No inbound port",
  "remote.tunnelBody": "This computer opens one outbound WSS connection. No router port or inbound firewall rule is required.",
  "remote.startFailed": "Could not start GitHub sign-in.",
  "remote.cancelFailed": "Could not cancel device sign-in.",
  "remote.pendingTitle": "Approve this computer in your browser",
  "remote.pendingBody": "Approve this computer on opencodexpages.me and confirm that the code shown there matches this local code.",
  "remote.codeLabel": "Device code",
  "remote.openBrowser": "Open sign-in page",
  "remote.waiting": "Waiting for browser approval…",
  "remote.connectedAs": "Connected as",
  "remote.passwordTitle": "Create a Remote access password",
  "remote.passwordBody": "This separate password encrypts your Remote vault locally with Argon2id and AES-GCM.",
  "remote.passwordLabel": "Remote password",
  "remote.passwordConfirm": "Confirm password",
  "remote.passwordLength": "Use at least 10 characters.",
  "remote.passwordMismatch": "The passwords do not match.",
  "remote.passwordFailed": "Could not save the Remote password.",
  "remote.savePassword": "Save Remote password",
  "remote.accountReadyTitle": "Account and device are ready",
  "remote.accountReadyBody": "GitHub identity, this computer, and the Remote access password are connected.",
  "remote.connectorNext": "Next: install and start the signed OCX connector, then assign this computer its opencodexpages.me address.",
  "remote.privateBetaTitle": "Private beta access required",
  "remote.privateBetaBody": "This account is connected, but Remote activation is still invite-only on this server.",
  "remote.domainTitle": "Choose this computer's address",
  "remote.domainBody": "Reserve one account Remote address, then register this computer under a unique name.",
  "remote.deviceNameLabel": "Computer name",
  "remote.deviceNamePlaceholder": "Home PC",
  "remote.domainLabel": "Remote address",
  "remote.domainSuffix": ".opencodexpages.me",
  "remote.domainInvalid": "Use lowercase letters, numbers, and hyphens for the address.",
  "remote.activateFailed": "Could not activate Remote for this computer.",
  "remote.activating": "Reserving address…",
  "remote.activate": "Enable Remote",
  "remote.provisioningTitle": "Creating the Remote workspace",
  "remote.provisioningBody": "The central service is reserving the account address and registering this computer.",
  "remote.connectorTitle": "Start the local connector",
  "remote.connectorBody": "The address is ready. Start the signed, unprivileged Agent that maintains one outbound encrypted relay connection.",
  "remote.pairingCode": "One-time pairing code",
  "remote.pairingFailed": "Could not prepare connector pairing.",
  "remote.preparingConnector": "Preparing…",
  "remote.prepareConnector": "Start connector",
  "remote.connectorRequirement": "The connector runs as your current user and needs no root access or port forwarding. A signed binary for this platform must be installed with OCX.",
  "remote.connectingTitle": "Connecting this computer",
  "remote.connectingBody": "The helper is paired. Waiting for the local OCX, Agent, Tunnel, and Gateway checks to pass.",
  "remote.readyTitle": "Remote is online",
  "remote.readyBody": "This computer's shell, Codex CLI, and Claude Code are available through the end-to-end encrypted Remote workspace.",
  "remote.openRemote": "Open Remote workspace",
  "remote.unavailableTitle": "Remote needs attention",
  "remote.unavailableBody": "This instance is suspended or could not be provisioned. Refresh the status or contact the operator.",
  "remote.disconnect": "Disconnect",
  "remote.disconnectConfirm": "Disconnect this computer from OpenCodex Remote?",
  "remote.disconnectFailed": "Could not revoke this device.",
  "remote.devicesTitle": "Paired computers",
  "remote.devicesBody": "Each computer keeps one outbound encrypted relay connection. No inbound port or router setting is required.",
  "remote.changePasswordTitle": "Change encryption password",
  "remote.changePasswordBody": "The old password is required. The vault is re-encrypted locally before the server receives the new envelope.",
  "remote.currentPassword": "Current password",
  "remote.newPassword": "New password",
  "remote.confirmNewPassword": "Confirm new password",
  "remote.changePassword": "Change password",
