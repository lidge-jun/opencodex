...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.namespacesTitle": "Choose account in model picker",
  "codexAuth.namespacesOnDesc": "Each GPT model is listed once per account. Selecting Personal or Work locks the thread to that account and never falls back.",
  "codexAuth.namespacesOffDesc": "GPT models use the Pool or Direct account mode above.",
  "codexAuth.namespacesCompatibilityNote": "This does not change the active Pool account. Plain GPT entries are hidden from the picker; existing threads and saved settings still work.",
