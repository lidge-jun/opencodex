...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "googleAntigravityPool.title": "Google Antigravity account pool",
  "googleAntigravityPool.enabledDesc": "Fails over on upstream HTTP 429 or surfaced HTTP 402. New sessions prefer accounts below {threshold}% usage.",
  "googleAntigravityPool.disabledDesc": "Uses only the active Google Antigravity account.",
  ...
  "googleAntigravityPool.needTwoAccounts": "Add at least two Google OAuth accounts before enabling the pool.",
  "anthropicPool.threshold": "New-session usage threshold",
  "googleAntigravityPool.threshold": "New-session usage threshold",
  "anthropicPool.thresholdAria": "New-session usage threshold, percent",
  "googleAntigravityPool.thresholdAria": "New-session usage threshold, percent",
  "anthropicPool.thresholdHelp": "0 disables quota-based picking (affinity + active account only). Default 80.",
  "googleAntigravityPool.thresholdHelp": "New sessions prefer accounts below this usage threshold. 0 disables quota-based selection. Default 80.",
  "anthropicPool.thresholdInvalid": "Enter a whole number from 0 to 100",
  "googleAntigravityPool.thresholdInvalid": "Enter a whole-number percentage from 0 to 100",
  "anthropicPool.loadFailed": "Claude pool settings could not be loaded.",
  "googleAntigravityPool.loadFailed": "Google Antigravity pool settings could not be loaded.",
  "anthropicPool.saveFailed": "Claude pool settings could not be saved.",
  "googleAntigravityPool.saveFailed": "Google Antigravity pool settings could not be saved.",
  "anthropicPool.on": "On",
  "anthropicPool.off": "Off",
  "googleAntigravityPool.on": "On",
  "googleAntigravityPool.off": "Off",
