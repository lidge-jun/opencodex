...
export const ja: Record<TKey, string> = {
  ...
  "codexAuth.namespacesTitle": "アカウント別モデル",
  "codexAuth.namespacesOnDesc": "個人用とアカウント名付きのモデルを選択でき、選んだアカウントに厳密に固定されます。",
  "codexAuth.namespacesOffDesc": "Codex のモデル選択に個人用と仕事用の明示的な選択肢を追加します。",
  "codexAuth.namespacesSaved": "アカウント別モデルを更新しました。表示が古い場合は Codex を開き直してください。",
  "codexAuth.namespacesSaveFailed": "アカウント別モデルを更新できませんでした。以前の設定は維持されます。",
  "codexAuth.pickerModeTitle": "選択リストの配置",
  "codexAuth.pickerModeAdditive": "標準 + アカウント",
  "codexAuth.pickerModeReplace": "アカウントのみ",
  "codexAuth.pickerModeAdditiveDesc": "標準の OpenAI モデルと個人 / 仕事アカウントの選択肢を並べて表示します。",
  "codexAuth.pickerModeReplaceDesc": "アカウント指定の OpenAI モデルだけを表示します。他のプロバイダーは変わりません。",
  "codexAuth.pickerModeSaved": "モデル選択を更新しました。表示が古い場合は Codex を開き直してください。",
  "codexAuth.pickerModeSaveFailed": "設定を保存できませんでした。以前の選択は変更されていません。",
  "codexAuth.add": "追加",
