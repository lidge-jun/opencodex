...
"common.discard": "破棄",
  ...
  "pws.capacity.incomplete": "対象範囲が不完全です：{excluded} 件のアカウントを除外しました。",
  "pws.capacity.missingQuota": "現在のクォータデータなし：{count} 件のアカウント。",
  "pws.capacity.unknownPlan": "不明なプラン：{count} 件のアカウント。",
  "pws.capacity.pausedAccounts": "一時停止中：{count} 件のアカウント。",
  "pws.capacity.reauthAccounts": "再認証が必要：{count} 件のアカウント。",
  "pws.capacity.staleQuota": "古いクォータデータ：{count} 件のアカウント。",
...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
  ...
  "codexAuth.managedByCodex": "Codex が管理",
  "codexAuth.keyringDetailsPending": "OpenCodex は Codex のキーチェーン認証を読み取れません。アカウント種別とクォータは、このプロキシ経由で最初のリクエストが成功した後に表示されます。",
