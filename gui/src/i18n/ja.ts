...
export const ja: Record<TKey, string> = {
  ...
  "nav.advisor": "アドバイザー",
  "advisor.description": "Worker のタスクをレビューし助言を返す独立したエキスパートモデル。相談は OpenCodex 自身が実行します。Worker は合成 advisor ツールを呼び出せて、preflight ポリシーではタスクごとに 1 回の自動相談が保証されます。",
  ...
  "advisor.policy.preflight": "Preflight — タスクごとに 1 回の自動相談を保証",
  "advisor.timeout": "タイムアウト (ms)",
  "advisor.save": "アドバイザー設定を保存",
  "advisor.saved": "アドバイザー設定を保存しました。",
  "advisor.loadFailed": "アドバイザー設定を読み込めません。プロキシが実行中か確認してください。",
  "advisor.warning.noModel": "有効ですがエキスパートモデルが未設定です — 相談は失敗します。",
  "advisor.costNote": "相談は実際の追加モデル呼び出しであり、Worker ではなくアドバイザーモデルの使用量として記録されます。",
