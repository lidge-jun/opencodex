...
export const ja: Record<TKey, string> = {
  ...
  "brain.title": "読み取り専用オブザーバトリー: エージェント、タスク、スキル、ノード、メモリ。",
  "brain.subtitle": "読み取り専用オブザーバトリー: エージェント、タスク、スキル、ノード、メモリ。",
  "brain.askPlaceholder": "Pao Brain に質問...",
  "brain.search": "検索",
  "brain.loading": "読み込み中...",
  "brain.loadFailed": "オブザーバトリーのデータを読み込めませんでした。",
  "brain.tab.agents": "エージェント",
  "brain.tab.tasks": "タスク",
  "brain.tab.skills": "スキル",
  "brain.tab.nodes": "ノード",
  "brain.tab.memory": "メモリ",
  "brain.tab.search": "検索",
  "brain.empty.agents": "エージェントが未登録です。",
  "brain.empty.tasks": "キューにタスクがありません。",
  "brain.empty.skills": "スキルが未登録です。",
  "brain.empty.nodes": "リモートノードが未登録です。",
  "brain.empty.memory": "メモリがありません。",
  "brain.empty.search": "質問を入力してローカルを検索してください。",
  "brain.empty.searchResults": "ローカルには該当なしです。",
  "brain.col.name": "名前",
  "brain.col.provider": "プロバイダー",
  "brain.col.type": "種別",
  "brain.col.health": "状態",
  "brain.col.enabled": "有効",
  "brain.col.title": "タイトル",
  "brain.col.kind": "種類",
  "brain.col.status": "状態",
  "brain.col.attempts": "試行回数",
  "brain.col.version": "バージョン",
  "brain.col.capabilities": "機能",
  "brain.permits.pending": "承認待ちの書き込み許可",
  "brain.permits.grant": "許可",
  "brain.permits.deny": "拒否",
  "brain.tab.policies": "ポリシー",
  "brain.policies.capability": "ケイパビリティ",
  "brain.policies.subject": "対象",
  "brain.policies.effect": "効果",
  "brain.policies.addAllow": "許可",
  "brain.policies.addDeny": "拒否",
  "brain.policies.empty": "ポリシーが未設定です。",
  "brain.policies.remove": "削除",
  "brain.tab.projects": "プロジェクト",
  "brain.projects.name": "プロジェクト名",
  "brain.projects.path": "ルートパス",
  "brain.projects.add": "追加",
  "brain.projects.scan": "スキャン",
  "brain.projects.empty": "プロジェクトが未登録です。",
  "brain.projects.files": "ファイル",
  "brain.projects.lastScan": "前回のスキャン",
  "brain.tab.atlas": "アトラス",
  "brain.tab.universe": "ユニバース",
  ...
  "demo.loadScenario": "スマートファクトリーシナリオを読み込む",
  "demo.reset": "デモをリセット",
  "demo.noProject": "プロジェクトがありません。シナリオを読み込んでください。",
  "demo.scenarioLoaded": "シナリオを読み込みました。",
  "demo.resetDone": "デモをリセットしました。",
  "demo.approvalsTitle": "保留中の承認",
  "demo.approvalsNone": "保留中の承認はありません。",
  "demo.activityTitle": "エージェントの活動",
  "demo.activityNone": "エージェントの活動はまだありません。",
  "brain.tab.tools": "ツール",
  "brain.tab.activity": "活動",
  "brain.tool.risk": "リスク",
  "brain.tool.readOnly": "読み取り専用",
  "brain.tool.execute": "実行",
  "brain.tool.empty": "登録されたツールがありません。",
  "brain.activity.empty": "エージェントの活動はまだありません。",
  "brain.activity.tool": "ツール",
  "brain.activity.actor": "アクター",
  "brain.activity.result": "結果",
  "brain.graph.selectProject": "プロジェクト",
  "brain.graph.empty": "グラフデータがありません。先にプロジェクトをスキャンしてください。",
  "brain.graph.nodes": "ノード",
  "brain.graph.edges": "エッジ",
  "brain.graph.capped": "最初の180ノードを表示しています。",
  "brain.graph.aria": "Brain Universe グラフ",
