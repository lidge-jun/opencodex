...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
  ...
  "codexAuth.accountPickerCustomizeTitle": "アカウントごとにモデルをカスタマイズ",
  "codexAuth.accountPickerCustomizeOffDesc": "各アカウントセレクターには、この設定が導入される前と同様に、利用可能なすべてのモデルが表示されます。",
  "codexAuth.accountPickerCustomizeOnDesc": "以下で各アカウントセレクターに表示するモデルを選択できます。共通プールのモデルは引き続きどこでも表示されます。",
  "codexAuth.accountPickerCustomizeUpdated": "アカウントごとのモデルカスタマイズを更新しました。",
  "codexAuth.accountPickerCustomizeUpdateFailed": "アカウントごとのモデルカスタマイズを更新できませんでした。最後に確認された設定を表示しています。",
  "codexAuth.accountPickerModelsCommonNote": "以下の選択に関わらず、共通プールのモデルはピッカーに表示され続けます。",
  "codexAuth.accountPickerModelsSearchPlaceholder": "モデルを検索…",
  "codexAuth.accountPickerModelsNoMatch": "検索条件に一致するモデルがありません。",
  "codexAuth.accountPickerModelsSelectedCount": "{n} 件選択中",
  "codexAuth.accountPickerModelsSaved": "モデルの選択を保存しました。",
  "codexAuth.accountPickerModelsSaveFailed": "モデルの選択を保存できませんでした。もう一度お試しください。",
  "codexAuth.accountPickerModelsNoAccounts": "利用できるアカウントセレクターはまだありません。",
  "codexAuth.accountPickerOnDescCustomized": "各セレクターは保存済みアカウント1つに対応する公開ラベルです。選択した会話はそのアカウントに固定され、Poolのローテーションやフォールバックは行われず、現在のPoolアカウントも変更されません。共通プールのモデルは、以下で選択したアカウントごとのモデルと並んで引き続き表示されます。",
