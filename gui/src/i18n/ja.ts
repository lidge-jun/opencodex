...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
  ...
  "codexAuth.autoSwitchResetWindowDesc": "リセットウィンドウ: {threshold}% を使い切り基準とし、余裕のあるアカウントを新しいリセット情報の順で割り当てます。",
  "codexAuth.autoSwitchResetWindowOffDesc": "リセットウィンドウに使用量基準はありませんが、新しいリセット順で新規/未紐付けタスクを割り当てます。",
  ...
  "accountPool.strategyResetWindow": "リセットウィンドウ",
  ...
  "accountPool.strategyHintResetWindow": "リセットウィンドウは新しいリセット時刻で未紐付けタスクを並べ、正常な紐付け済みタスクは親和性を維持します。",
  "accountPool.resetOrder": "リセット順序",
  "accountPool.resetOrderHelp": "将来の quota リセットを近い順または遠い順に使い切るか選択します。",
  "accountPool.resetOrderSoonest": "近いリセットから",
  "accountPool.resetOrderLatest": "遠いリセットから",
