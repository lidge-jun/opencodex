...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
  ...
  "cws.group.weighted": "重み付き",
  "cws.group.leastUsed": "最少使用",
  "cws.group.resetWindow": "リセットウィンドウ",
  ...
  "cws.count.weighted": "重み付き",
  "cws.count.leastUsed": "最少使用",
  "cws.count.resetWindow": "リセットウィンドウ",
  ...
  "cws.strategy.randomHint": "重み付きランダム選択。重みが高いターゲットが選ばれやすくなります。",
  "cws.strategy.resetWindowHint": "既知のクォータウィンドウが最も早くリセットされるターゲットを優先します。リセット時刻が不明なターゲットはフォールバックのままです。",
  "cws.strategy.leastUsedHint": "記録された使用回数が最も少ないターゲットを選択します。",
  ...
  "cws.targets.randomHint": "重みは、各リクエストでターゲットが選ばれる確率を制御します。",
  "cws.targets.leastUsedHint": "成功した使用回数が同じ場合は順序で同点を解消します。",
  "cws.targets.resetWindowHint": "順序で同点を解消し、キャッシュ済みのクォータリセット時刻がない場合のフォールバックになります。",
