...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
  ...
  "models.pickerOrder.hint": "Codex のメインピッカーでルーティング済みモデルを並べ替えます。注目のサブエージェントモデルやフォールバックルーティングは変更しません。",
  ...
  "models.pickerOrder.saved": "モデルピッカーの順序を保存しました。新しい Codex セッションに適用されます。",
