...
"common.discard": "破棄",
 ...
 "quota.fiveHourLimit": "5 時間上限",
  ...
  "modal.azureEntraSetupGuide": "Azure OpenAI の設定",
  "modal.azureEntraIntro": "Azure OpenAI は API キー、または DefaultAzureCredential による Microsoft Entra ID を使用できます。",
  "modal.azureEntraResource": "Base URL のリソースプレースホルダーを Azure OpenAI リソース名に置き換えてください。",
  "modal.azureEntraCredential": "Microsoft Entra ID を使う場合は API キーを空欄にし、OpenCodex を実行するマシンで DefaultAzureCredential を構成してください。",
