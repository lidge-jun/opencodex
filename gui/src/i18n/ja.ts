...
export const ja: Record<TKey, string> = {
  ...
  "googleAntigravityPool.title": "Google Antigravity アカウントプール",
  "googleAntigravityPool.enabledDesc": "上流の HTTP 429 または表面化した HTTP 402 の場合にフェイルオーバーします。新規セッションは使用率が {threshold}% 未満のアカウントを優先します。",
  "googleAntigravityPool.disabledDesc": "アクティブな Google Antigravity アカウントのみを使用します。",
  ...
  "googleAntigravityPool.needTwoAccounts": "プールを有効にする前に、Google OAuth アカウントを 2 つ以上追加してください。",
  "anthropicPool.threshold": "新規セッションの使用率しきい値",
  "googleAntigravityPool.threshold": "新規セッションの使用率しきい値",
  "anthropicPool.thresholdAria": "新規セッションの使用率しきい値（パーセント）",
  "googleAntigravityPool.thresholdAria": "新規セッションの使用率しきい値（パーセント）",
  "anthropicPool.thresholdHelp": "0 はクォータに基づく選択を無効にします（アフィニティ + アクティブアカウントのみ）。デフォルト 80。",
  "googleAntigravityPool.thresholdHelp": "新規セッションは使用率がこのしきい値未満のアカウントを優先します。0 はクォータに基づく選択を無効にします。デフォルトは 80 です。",
  "anthropicPool.thresholdInvalid": "0 から 100 までの整数を入力してください",
  "googleAntigravityPool.thresholdInvalid": "0〜100 の整数の割合を入力してください",
  "anthropicPool.loadFailed": "Claude プール設定を読み込めませんでした。",
  "googleAntigravityPool.loadFailed": "Google Antigravity プール設定を読み込めませんでした。",
  "anthropicPool.saveFailed": "Claude プール設定を保存できませんでした。",
  "googleAntigravityPool.saveFailed": "Google Antigravity プール設定を保存できませんでした。",
  "anthropicPool.on": "オン",
  "anthropicPool.off": "オフ",
  "googleAntigravityPool.on": "オン",
  "googleAntigravityPool.off": "オフ",
