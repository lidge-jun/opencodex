...
export const ja: Record<TKey, string> = {
  ...
  "codexAuth.namespacesTitle": "モデル選択でアカウントを選ぶ",
  "codexAuth.namespacesOnDesc": "各 GPT モデルがアカウントごとに表示されます。個人用または仕事用を選ぶと、そのアカウントに固定されます。",
  "codexAuth.namespacesOffDesc": "GPT モデルは上のプールまたは直接アカウントモードを使用します。",
  "codexAuth.namespacesCompatibilityNote": "アクティブなプールアカウントは変わりません。通常の GPT 項目は非表示ですが、既存スレッドと保存済み設定は引き続き動作します。",
