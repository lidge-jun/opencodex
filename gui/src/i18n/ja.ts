...
"common.discard": "破棄",
  ...
  "subagentSurface.selectionBody": "{mode} では、ChatGPT モデルから Grok や Claude などの routed モデルに渡されるタスクは、ChatGPT バックエンド向けに暗号化されたまま届き、routed モデルは読めません。上流で修正されるまで、プロバイダーをまたぐ委任は unreadable_encrypted_agent_task で失敗します。v1 ならプロバイダーをまたいで確実に委任できます。",
  "subagentSurface.advisoryTitle": "v1 がデフォルトのサブエージェントサーフェスになりました",
  "subagentSurface.advisoryBody": "このインストールは {mode} で動作しており、ChatGPT から routed へのタスクは暗号化されて渡されるため、プロバイダーをまたぐ委任が壊れます。上流で修正されるまで v1 を推奨します。選ぶまで現在の設定は変わりません。",
