...
export const ja: Record<TKey, string> = {
  ...
  "modal.endpoint.chinaMainland": "中国本土",
  "modal.endpoint.international": "国際",
  ...
  "time.hoursAgo": "{n}時間前",
  "time.daysAgo": "{n}日前",
  "modal.catalogModes": "プロバイダーのアクセス方式",
  "modal.accessGroups": "無料アクセスのグループ",
  "modal.providerDirectory": "プロバイダーディレクトリ",
  "modal.searchCount": "{count} 件のプロバイダーを検索",
  "modal.group.all": "すべてのプロバイダー",
  "modal.group.recurring-or-keyless": "定期無料 / キー不要",
  "modal.group.recurring-uncapped": "公開トークン上限なし",
  "modal.group.recurring-credit": "定期付与クレジット",
  "modal.group.signup-credit": "登録時クレジット",
  "modal.group.existing": "既存の無料・ローカル",
  "modal.paidHint": "有料プロバイダーと、登録時に一度だけクレジットが付与されるプロバイダーを参照します。",
  "modal.selectProvider": "プロバイダーを選択",
  "modal.selectProviderHint": "プロバイダーを選択して、設定の確認とモデルの検出を行います。",
  "modal.badge.recurring": "定期無料",
  "modal.badge.reference": "参考情報",
  "modal.badge.experimental": "試験的",
  "modal.badge.supported": "対応済み",
  "modal.verification.official": "公式ドキュメント",
  "modal.verification.primary": "一次情報",
  "modal.verification.unverified": "未検証",
  "modal.providerDocs": "プロバイダーのドキュメント",
  "modal.referenceExplanation": "この項目は参考情報のみです。文書化された通信方式が検証されるまで、自動呼び出しとモデル検出は無効です。",
  ...
  "modal.discoveredModels": "検出されたモデル",
  "modal.discoveryFailed": "この設定でモデルを検出できませんでした。",
  "modal.backToDirectory": "プロバイダーディレクトリに戻る",
  "modal.setupReviewProvider": "{label} の設定ドキュメントを確認します。",
  "modal.setupReferenceStep": "検証済みの呼び出しに対応するまで、この項目を設定ガイドとして利用してください。",
  "modal.setupKeylessStep": "下記のエンドポイントを確認します。API キーは任意です。",
  "modal.setupDiscoverStep": "モデルを検出して、既定のモデルを選択します。",
  "modal.noMatch": "一致なし。",
