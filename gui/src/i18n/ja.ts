...
export const ja: Record<TKey, string> = {
  ...
  "codexAuth.namespacesTitle": "モデル選択に Codex アカウントを表示",
  "codexAuth.namespacesOnDesc": "追加した Codex アカウントごとに各 GPT モデルが表示されます。アカウント名付きモデルを選ぶと、スレッド全体でそのアカウントの割り当てを使い、別のアカウントへ切り替わりません。",
  "codexAuth.namespacesOffDesc": "GPT モデルは上のプールまたは直接動作に従います。スレッドで使う正確なアカウントを選びたい場合に有効にします。",
  "codexAuth.namespacesCompatibilityNote": "新しいモデル選択肢の表示だけが変わります。アクティブなプールアカウント、既存スレッド、保存済み設定は変わりません。",
  "codexAuth.namespacesSaved": "アカウント選択を更新しました。表示が古い場合は Codex を開き直してください。",
  "codexAuth.namespacesSaveFailed": "アカウント選択を更新できませんでした。以前の設定は維持されます。",
  "codexAuth.add": "追加",
