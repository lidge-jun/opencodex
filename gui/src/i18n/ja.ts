...
export const ja: Record<TKey, string> = {
  ...
  "memory.title": "メモリウォッチドッグ",
  "memory.disabledHint": "ウォッチドッグは無効です。有効にするとメモリ負荷を監視し警告を受け取れます。",
  "memory.enable": "有効化",
  "memory.intro": "総RAMに対するプロセスメモリを監視します。デフォルトは警告のみ。自動再起動はオプトインで、スーパーバイザーが検出された場合にのみ実行されます。",
  "memory.pressure": "メモリ負荷",
  "memory.pressureValue": "{used} / {total} MB ({pct}%)",
  "memory.sourceLabel": "ソース:",
  "memory.growthLabel": "増加:",
  "memory.growthValue": "{mb} MB/h",
  "memory.notAvailable": "なし",
  "memory.restartsLabel": "再起動:",
  "memory.privateLabel": "プライベート:",
  "memory.commitLabel": "システムコミット:",
  "memory.commitValue": "{used} / {limit} GB（{pct}%）",
  "memory.responseCacheLabel": "応答キャッシュ:",
  "memory.responseCacheValue": "{count} 件 · {mb} MB",
  "memory.probeLabel": "計測:",
  "memory.probeAgo": "{s}秒前",
  "memory.probeDegraded": "制限あり（{code}）",
  "memory.mbValue": "{mb} MB",
  "memory.supervisorLabel": "スーパーバイザー:",
  "memory.supervisorDetected": "検出 ({hint})",
  "memory.supervisorNotDetected": "未検出",
  "memory.recommended": "推奨",
  "memory.recSummary": "警告 {warn}% · 危険 {crit}% · 自動再起動 {auto}",
  "memory.applyRecommended": "推奨値を適用",
  "memory.enabledLabel": "有効",
  "memory.warnLabel": "警告 %",
  "memory.criticalLabel": "危険 %",
  "memory.applyThresholds": "しきい値を適用",
  "memory.autoRestartLabel": "危険時に自動再起動（オプトイン）",
  "memory.autoRestartNote": "自動再起動が始まると新規リクエストの受付を一時停止し、進行中の応答が完了するまで最大 {seconds} 秒待機します。この時間内に完了しなかったストリーミング応答は中断されることがあり、クライアント側での再試行が必要になる場合があります。すでに完了した応答には影響せず、再起動の頻度は制限されています。",
  "memory.graceLabel": "再起動の猶予時間（秒）",
  "memory.applyGrace": "猶予時間を適用",
  "memory.graceRangeError": "{min}〜{max}秒の値を入力してください。",
  "memory.graceCooldownError": "最小再起動間隔（{seconds}秒）を超えることはできません。",
