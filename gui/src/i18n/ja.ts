...
export const ja: Record<TKey, string> = {
  ...
  "models.customFieldCodexAccount": "このモデルで使用する Codex アカウント",
  "models.customAccountTargetAutomatic": "自動（プロバイダーの Pool/Direct）",
  "models.customAccountTargetHint": "任意の固定バインドです。対象が利用できない場合、別アカウントへ切り替えず失敗します。",
  "models.customAccountTargetPaused": "一時停止中",
  "models.customAccountTargetUnavailable": "以前選択したアカウント（利用不可）",
  "models.customAccountTargetLoadFailed": "Codex アカウント候補を読み込めませんでした",
