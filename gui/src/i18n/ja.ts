...
export const ja: Record<TKey, string> = {
  ...
  "common.retry": "再試行",
  "remote.title": "リモート",
  "remote.subtitle": "この OpenCodex をアカウントに接続し、暗号化された outbound relay 経由で端末を利用します。",
  "remote.refresh": "リモート状態を更新",
  "remote.progressLabel": "リモート設定の進行状況",
  "remote.stepAccount": "GitHub アカウント",
  "remote.stepPassword": "アクセスパスワード",
  "remote.stepTunnel": "コンピューター接続",
  "remote.loading": "リモート状態を読み込み中…",
  "remote.loadFailed": "リモート状態を読み込めませんでした。",
  "remote.signedOutTitle": "このコンピューターを接続",
  "remote.signedOutBody": "OpenCodex サービス経由でログインします。GitHub は本人確認のみを行い、ローカル OCX には OpenCodex のデバイス資格情報だけが渡されます。",
  "remote.signIn": "GitHub で続行",
  "remote.starting": "開始中…",
  "remote.identityTitle": "本人確認は中央で処理",
  "remote.identityBody": "サービスが GitHub OAuth を処理し、GitHub トークンをこの PC へ送りません。",
  "remote.deviceTitle": "デバイスごとの資格情報",
  "remote.deviceBody": "この OCX は固有のデバイスキーを作成し、他の PC に影響せず個別に解除できます。",
  "remote.tunnelTitle": "受信ポート不要",
  "remote.tunnelBody": "Agent は暗号化された outbound 接続を 1 本だけ開き、自宅や社内ネットワークを公開しません。",
  "remote.startFailed": "GitHub ログインを開始できませんでした。",
  "remote.cancelFailed": "デバイスログインをキャンセルできませんでした。",
  "remote.pendingTitle": "ブラウザーでこの PC を承認してください",
  "remote.pendingBody": "opencodexpages.me で GitHub ログインを完了し、表示コードが下のコードと一致することを確認してください。",
  "remote.codeLabel": "デバイスコード",
  "remote.openBrowser": "ログインページを開く",
  "remote.waiting": "ブラウザーの承認を待っています…",
  "remote.connectedAs": "接続中のアカウント",
  "remote.passwordTitle": "リモートアクセス用パスワードを作成",
  "remote.passwordBody": "このパスワードはリモートブラウザーアクセス用で、GitHub パスワードとは別です。",
  "remote.passwordLabel": "リモートパスワード",
  "remote.passwordConfirm": "パスワードの確認",
  "remote.passwordLength": "10 文字以上で入力してください。",
  "remote.passwordMismatch": "パスワードが一致しません。",
  "remote.passwordFailed": "リモートパスワードを保存できませんでした。",
  "remote.savePassword": "リモートパスワードを保存",
  "remote.accountReadyTitle": "アカウントとデバイスの準備ができました",
  "remote.accountReadyBody": "GitHub の本人確認、この PC、リモートアクセス用パスワードが接続されました。",
  "remote.connectorNext": "次の手順: 署名済み OCX コネクターを起動し、この PC に opencodexpages.me アドレスを割り当てます。",
  "remote.privateBetaTitle": "プライベートベータの承認が必要です",
  "remote.privateBetaBody": "アカウントは接続済みですが、このサーバーでは招待されたアカウントのみ Remote を有効化できます。",
  "remote.domainTitle": "このコンピューターのアドレスを選択",
  "remote.domainBody": "OpenCodex がアカウントとこの PC 用の一意な opencodexpages.me アドレスを予約します。",
  "remote.deviceNameLabel": "コンピューター名",
  "remote.deviceNamePlaceholder": "自宅 PC",
  "remote.domainLabel": "Remote アドレス",
  "remote.domainSuffix": ".opencodexpages.me",
  "remote.domainInvalid": "小文字、数字、ハイフンのみ使用できます。",
  "remote.activateFailed": "このコンピューターの Remote を有効化できませんでした。",
  "remote.activating": "アドレスを予約中…",
  "remote.activate": "Remote を有効化",
  "remote.provisioningTitle": "安全なアドレスを準備中",
  "remote.provisioningBody": "中央サービスがアドレスを予約し、暗号化 relay アクセスを準備しています。",
  "remote.connectorTitle": "ローカルヘルパーを接続",
  "remote.connectorBody": "アドレスの準備ができました。暗号化 outbound relay を維持する署名済み非特権 Agent を起動します。",
  "remote.pairingCode": "一回限りのペアリングコード",
  "remote.pairingFailed": "コネクターのペアリングを準備できませんでした。",
  "remote.preparingConnector": "準備中…",
  "remote.prepareConnector": "コネクターを準備",
  "remote.connectorRequirement": "コネクターは現在のユーザー権限で動作し、root やポート転送は不要です。このプラットフォーム用の署名済み binary が OCX に同梱されている必要があります。",
  "remote.connectingTitle": "このコンピューターを接続中",
  "remote.connectingBody": "Agent を起動しました。OCX、Agent、Relay、Gateway の確認を待っています。",
  "remote.readyTitle": "Remote はオンラインです",
  "remote.readyBody": "認証済みアドレスからローカル OpenCodex GUI にアクセスできます。",
  "remote.openRemote": "Remote GUI を開く",
  "remote.unavailableTitle": "Remote の確認が必要です",
  "remote.unavailableBody": "インスタンスが停止中か、プロビジョニングに失敗しました。",
  "remote.disconnect": "接続解除",
  "remote.disconnectConfirm": "この PC を OpenCodex Remote から切断しますか？",
  "remote.disconnectFailed": "このデバイスを解除できませんでした。",
  "remote.devicesTitle": "ペアリング済みコンピューター",
  "remote.devicesBody": "各コンピューターは暗号化されたアウトバウンド Relay 接続を1本だけ維持します。受信ポートやルーター設定は不要です。",
  "remote.changePasswordTitle": "暗号化パスワードを変更",
  "remote.changePasswordBody": "以前のパスワードが必要です。新しい封筒をサーバーへ送る前に、保管庫をローカルで再暗号化します。",
  "remote.currentPassword": "現在のパスワード",
  "remote.newPassword": "新しいパスワード",
  "remote.confirmNewPassword": "新しいパスワードを確認",
  "remote.changePassword": "パスワードを変更",
