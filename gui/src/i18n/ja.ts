...
export const ja: Record<TKey, string> = {
  ...
  "codexAuth.removeCleanupPending": "アカウントは削除されましたが、ローカル認証情報のクリーンアップが保留中です。",
  "codexAuth.removeCleanupRetry": "クリーンアップを再試行",
  "codexAuth.removeCleanupComplete": "アカウントのクリーンアップが完了しました。",
  "codexAuth.removeCleanupRetryRefused": "アカウントが存在しないことを確認できなかったため、クリーンアップの再試行を停止しました。",
