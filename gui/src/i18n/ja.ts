...
"common.discard": "破棄",
  ...
  "compactionRouting.providerWarningScoped": "この設定では、{sources} からの圧縮リクエストのみが会話の全内容を要約のため {provider} へ送信し、それ以外の会話は従来どおり自身のモデルで圧縮されます。",
  "compactionRouting.comboWarningScoped": "この設定では、{sources} からの圧縮リクエストのみが会話の全内容を要約のためコンボ {combo} へ送信し、それ以外の会話は従来どおり自身のモデルで圧縮されます。コンボはターゲット（{providers}）を順に試し、最初に応答したものを使うため、そのいずれもがこれらの会話を受け取る可能性があります。",
