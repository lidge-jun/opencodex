...
export const de = {
  ...
  "prov.accountLogin": "Providers",
  "prov.oauthProviders": "OAuth",
  "prov.apiProviders": "API-Anbieter",
  "prov.apiProvidersHint": "Nur konfigurierte API-Key-Anbieter werden angezeigt. Mit + weitere hinzufügen.",
  "prov.noApiProviders": "Noch keine API-Anbieter konfiguriert.",
  "prov.addApiProvider": "API-Anbieter hinzufügen",
  "prov.addApiProviderDesc": "Einen Anbieter mit API-Key-Unterstützung wählen und die Einrichtung abschließen.",
  "prov.apiReady": "Bereit",
  "prov.restartCodex": "Codex neu starten",
  "prov.restartCodexConfirm": "Codex wird geschlossen und erneut geöffnet. Laufende Vorgänge werden unterbrochen. Jetzt neu starten?",
  "prov.restartCodexFailed": "Codex konnte nicht neu gestartet werden: {error}",
  "prov.addedRestartRequired": "\"{name}\" wurde hinzugefügt und die Modelle wurden synchronisiert. Starte Codex neu, um die App zu aktualisieren.",
  "modal.addApiProvider": "API-Anbieter hinzufügen",
  "modal.apiProvidersHint": "Einen API-Key-Anbieter wählen und anschließend Schlüssel und Endpunkt eintragen.",
  "prov.noAccountProvidersMatch": "Keine passenden Account-Provider.",
  "prov.noConnectedAccounts": "Noch keine Account-Provider verbunden.",
  "prov.searchAccountProviders": "Account-Provider suchen",
  "prov.connectAccountDesc": "Suche Provider mit Account-Login. Verbundene Provider erscheinen in der Liste.",
  "prov.connectAccountTitle": "Account-Provider verbinden",
  "prov.connectAccount": "Verbinden",
  "prov.accountLoginHint": "Nur verbundene Account-Provider werden angezeigt. Mit + weitere finden und verbinden.",
  ...
  "prov.loginOk": "Bei {provider} angemeldet. Modelle wurden mit Codex synchronisiert.",
  "prov.modelSyncFailed": "Provider verbunden, aber die Modellsynchronisierung ist fehlgeschlagen. Führe zum Wiederholen {cmd} aus.",
  ...
  "prov.added": "\"{name}\" hinzugefügt. Sofort aktiv — Modelle wurden mit Codex synchronisiert.",
