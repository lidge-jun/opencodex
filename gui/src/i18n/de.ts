...
"common.discard": "Verwerfen",
  ...
  "subagentSurface.selectionBody": "Auf {mode} wird eine Aufgabe, die ein ChatGPT-Modell an ein geroutetes Modell wie Grok oder Claude übergibt, für das ChatGPT-Backend verschlüsselt — das geroutete Modell kann sie nicht lesen. Die Delegation über Anbieter hinweg schlägt mit unreadable_encrypted_agent_task fehl, bis das Problem upstream behoben ist. v1 delegiert zuverlässig über Anbieter hinweg.",
  "subagentSurface.advisoryTitle": "v1 ist jetzt die Standard-Sub-Agent-Oberfläche",
  "subagentSurface.advisoryBody": "Diese Installation nutzt {mode}; Aufgaben von ChatGPT an geroutete Modelle werden dabei verschlüsselt übergeben, und die Delegation über Anbieter hinweg bricht. Wir empfehlen v1, bis das Problem upstream behoben ist. Deine aktuelle Einstellung bleibt unverändert, bis du etwas wählst.",
