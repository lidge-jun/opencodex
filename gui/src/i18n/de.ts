...
export const de = {
  ...
  "prov.openaiDirectDesc": "Verwendet nur die primäre Codex-Anmeldung des Aufrufers, ohne Kontowechsel.",
  "prov.openaiMultiDesc": "Wechselt zwischen der primären Anmeldung und hinzugefügten Codex-Konten.",
  ...
  "codexAuth.multiOwnerTitle": "Codex-Multikontopool",
  "codexAuth.multiOwnerDesc": "Die primäre Codex-Anmeldung bleibt zusammen mit allen hier hinzugefügten Konten verfügbar.",
  "codexAuth.multiMissing": "Der Multi-Anbieter ist nicht konfiguriert.",
  "codexAuth.addMultiProvider": "Codex Multi-account hinzufügen",
  "codexAuth.multiDisabled": "Der Multi-Anbieter ist konfiguriert, aber deaktiviert.",
