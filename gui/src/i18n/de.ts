...
export const de = {
  ...
  "codexAuth.namespacesTitle": "Konto in der Modellauswahl wählen",
  "codexAuth.namespacesOnDesc": "Jedes GPT-Modell wird einmal pro Konto angezeigt. Persönlich oder Arbeit bindet den Thread strikt an dieses Konto.",
  "codexAuth.namespacesOffDesc": "GPT-Modelle verwenden den oben gewählten Pool- oder Direktmodus.",
  "codexAuth.namespacesCompatibilityNote": "Das aktive Pool-Konto bleibt unverändert. Einfache GPT-Einträge werden ausgeblendet; bestehende Threads und Einstellungen funktionieren weiter.",
