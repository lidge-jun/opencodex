...
"common.discard": "Verwerfen",
  ...
  "compactionRouting.providerWarningScoped": "Mit dieser Einstellung senden nur Komprimierungsanfragen von {sources} den vollständigen Gesprächsinhalt zur Zusammenfassung an {provider}; andere Gespräche nutzen weiterhin ihr eigenes Modell.",
  "compactionRouting.comboWarningScoped": "Mit dieser Einstellung senden nur Komprimierungsanfragen von {sources} den vollständigen Gesprächsinhalt zur Zusammenfassung an die Combo {combo}; andere Gespräche nutzen weiterhin ihr eigenes Modell. Die Combo versucht ihre Ziele ({providers}) der Reihe nach und verwendet das erste, das antwortet, sodass jedes davon diese Gespräche erhalten kann.",
