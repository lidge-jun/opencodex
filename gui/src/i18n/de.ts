...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
  ...
  "codexAuth.accountPickerCustomizeTitle": "Modelle je Konto anpassen",
  "codexAuth.accountPickerCustomizeOffDesc": "Jeder Kontoselektor zeigt derzeit alle verfügbaren Modelle, genau wie vor dieser Einstellung.",
  "codexAuth.accountPickerCustomizeOnDesc": "Wähle unten aus, welche Modelle unter jedem Kontoselektor erscheinen. Modelle aus dem gemeinsamen Pool bleiben überall sichtbar.",
  "codexAuth.accountPickerCustomizeUpdated": "Modellanpassung je Konto aktualisiert.",
  "codexAuth.accountPickerCustomizeUpdateFailed": "Die Modellanpassung je Konto konnte nicht aktualisiert werden. Die zuletzt bestätigte Einstellung wird angezeigt.",
  "codexAuth.accountPickerModelsCommonNote": "Modelle aus dem gemeinsamen Pool bleiben in der Auswahl sichtbar, unabhängig von der Auswahl unten.",
  "codexAuth.accountPickerModelsSearchPlaceholder": "Modelle suchen…",
  "codexAuth.accountPickerModelsNoMatch": "Keine Modelle entsprechen deiner Suche.",
  "codexAuth.accountPickerModelsSelectedCount": "{n} ausgewählt",
  "codexAuth.accountPickerModelsSaved": "Modellauswahl gespeichert.",
  "codexAuth.accountPickerModelsSaveFailed": "Die Modellauswahl konnte nicht gespeichert werden. Bitte erneut versuchen.",
  "codexAuth.accountPickerModelsNoAccounts": "Noch keine Kontoselektoren verfügbar.",
  "codexAuth.accountPickerOnDescCustomized": "Jeder Selektor ist eine öffentliche Bezeichnung für ein gespeichertes Konto. Seine Auswahl bindet die Unterhaltung an dieses Konto: keine Pool-Rotation, kein Fallback und keine Änderung des aktiven Pool-Kontos. Modelle aus dem gemeinsamen Pool erscheinen weiterhin neben deinen unten ausgewählten kontospezifischen Modellen.",
