...
export const de: Record<TKey, string> = {
  ...
  "nav.advisor": "Berater",
  "advisor.description": "Ein unabhängiges Expertenmodell, das die Aufgabe des Workers prüft und Rat zurückgibt. Die Konsultation gehört OpenCodex: Der Worker kann das synthetische Advisor-Tool aufrufen, und die Preflight-Politik garantiert eine automatische Konsultation pro Aufgabe.",
  ...
  "advisor.effort": "Denkintensität",
  "advisor.policy": "Richtlinie",
  "advisor.policy.manual": "Manuell — nur wenn der Worker fragt",
  "advisor.policy.preflight": "Preflight — garantierte Konsultation pro Aufgabe",
