...
export const de: Record<TKey, string> = {
  ...
  "codexAuth.resetCliOnly": "Reset-Gutschriften können nur im Loopback-Dashboard verwendet werden. Verwende bei einem Remote-Dashboard stattdessen den lokalen CLI-Zustimmungsablauf auf dem OpenCodex-Host.",
  "codexAuth.confirmResetTitle": "Reset-Gutschrift nutzen?",
  "codexAuth.confirmResetDesc": "Dies setzt deine aktuellen Ratenbegrenzungen sofort zurück. Nach der Bestätigung musst du das OpenCodex-Admin-Token erneut eingeben, um die Zustimmung des Kontoinhabers nachzuweisen. Du hast noch {count} Gutschrift(en).",
