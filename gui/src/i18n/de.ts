...
export const de = {
  ...
  "pws.notSignedInHint": "Nicht angemeldet — nutze die klassische Anbieter-Ansicht oder CLI-Login.",
  ...
  "quota.resetsRelativeDays": "Zurücksetzen in {n} T.",
  ...
  "pws.usageLast30d": "Nutzung der letzten 30 Tage",
