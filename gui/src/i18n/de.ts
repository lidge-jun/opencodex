...
export const de = {
  ...
  "modal.connectApiKey": "API-Schlüssel verbinden",
  "modal.badge.api": "API",
  ...
  "pws.sort.az": "A → Z",
  "pws.sort.za": "Z → A",
  "pws.sort.freePaid": "Gratis → Bezahlt",
  "pws.sort.paidFree": "Bezahlt → Gratis",
  ...
  "pws.quotaContext": "Quota-Kontext",
  "pws.quotaUpdatedFrom": "Aktualisiert {when} von {source}.",
  "pws.quotaUpdated": "Aktualisiert {when}.",
  ...
  "pws.freeTierDesc": "Dieser Anbieter benötigt keinen API-Schlüssel.",
  ...
  "pws.empty.browseFreeDesc": "Kein Schlüssel nötig",
