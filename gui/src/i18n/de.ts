...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
  ...
  "codexAuth.autoSwitchResetWindowDesc": "Reset-window: {threshold} % ist der Entleerungspunkt; Konten mit Reserve folgen ihrem aktuellen Reset-Zeitpunkt.",
  "codexAuth.autoSwitchResetWindowOffDesc": "Reset-window hat keinen Nutzungsschwellenwert; die aktuelle Reset-Reihenfolge weist weiterhin neue/ungebundene Aufgaben zu.",
  ...
  "accountPool.strategyResetWindow": "Reset-Fenster",
  ...
  "accountPool.strategyHintResetWindow": "Reset-Fenster ordnet ungebundene Aufgaben nach aktuellen Reset-Zeitpunkten; gesunde gebundene Aufgaben behalten ihre Affinität.",
  "accountPool.resetOrder": "Reset-Reihenfolge",
  "accountPool.resetOrderHelp": "Wähle, ob künftige Quota-Resets vom nächsten zum entferntesten oder umgekehrt geleert werden.",
  "accountPool.resetOrderSoonest": "Nächster zuerst",
  "accountPool.resetOrderLatest": "Entferntester zuerst",
