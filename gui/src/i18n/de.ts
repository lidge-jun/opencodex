...
export const de = {
  ...
  "models.contextWindowEdit": "Kontextfenster",
  "models.contextWindowHint": "Überschreibt das beworbene Kontextfenster pro Modell (Tokens). Leer = Anbieter-Standardwert.",
  "models.contextWindowModel": "Modell",
  "models.contextWindowValue": "Fenster",
  ...
  "models.noVisionLabel": "Kein Vis.",
  "models.noVisionHint": "Text-only Modelle markieren. Der Vision-Sidecar beschreibt Bilder für sie.",
  "models.noVisionApplied": "Vision-Einstellung gespeichert.",
  ...
  "modal.modelSource": "Modelle",
  "modal.modelSourceAuto": "Automatisch vom Anbieter ermitteln",
  "modal.modelSourceAutoHint": "Die Modellliste wird live vom /models-Endpunkt des Anbieters abgerufen.",
  "modal.modelSourceManual": "Modelle manuell festlegen",
  "modal.manualModelsPlaceholder": "Eine Modell-ID pro Zeile, z. B. gpt-5.5",
  "modal.manualModelsRequired": "Gib mindestens eine Modell-ID ein oder wechsle zu automatischer Ermittlung.",
  "modal.manualModelsDefaultHint": "Das Standardmodell ist nicht in der manuellen Liste enthalten.",
  "modal.manualModelsDefaultError": "Das Standardmodell muss in der manuellen Liste enthalten sein oder geleert werden.",
