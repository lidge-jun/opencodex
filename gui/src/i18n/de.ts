...
export const de = {
  ...
  "memory.title": "Speicher-Watchdog",
  "memory.disabledHint": "Watchdog deaktiviert. Aktivieren Sie ihn, um den Speicherdruck zu beobachten und Warnungen zu erhalten.",
  "memory.enable": "Aktivieren",
  "memory.intro": "Prozessspeicher im Verhältnis zum Gesamt-RAM beobachten. Standardmäßig nur Warnung; Auto-Neustart ist optional und wird nur ausgelöst, wenn ein Supervisor erkannt wird.",
  "memory.pressure": "Speicherdruck",
  "memory.pressureValue": "{used} / {total} MB ({pct}%)",
  "memory.sourceLabel": "Quelle:",
  "memory.growthLabel": "Wachstum:",
  "memory.growthValue": "{mb} MB/h",
  "memory.notAvailable": "n/v",
  "memory.restartsLabel": "Neustarts:",
  "memory.privateLabel": "Privat:",
  "memory.commitLabel": "System-Commit:",
  "memory.commitValue": "{used} / {limit} GB ({pct}%)",
  "memory.responseCacheLabel": "Antwort-Cache:",
  "memory.responseCacheValue": "{count} Einträge · {mb} MB",
  "memory.probeLabel": "Messung:",
  "memory.probeAgo": "vor {s}s",
  "memory.probeDegraded": "eingeschränkt ({code})",
  "memory.mbValue": "{mb} MB",
  "memory.supervisorLabel": "Supervisor:",
  "memory.supervisorDetected": "erkannt ({hint})",
  "memory.supervisorNotDetected": "nicht erkannt",
  "memory.recommended": "Empfohlen",
  "memory.recSummary": "Warnung {warn}% · kritisch {crit}% · Auto-Neustart {auto}",
  "memory.applyRecommended": "Empfehlung übernehmen",
  "memory.enabledLabel": "Aktiviert",
  "memory.warnLabel": "Warnung %",
  ...
  "memory.autoRestartNote": "Beim Start eines automatischen Neustarts werden neue Anfragen vorübergehend angehalten; laufende Antworten erhalten bis zu {seconds} Sekunden Zeit zum Abschluss. Eine Streaming-Antwort, die nicht rechtzeitig fertig wird, kann unterbrochen werden und muss ggf. vom Client wiederholt werden. Bereits abgeschlossene Antworten sind nicht betroffen; Neustarts sind ratenbegrenzt.",
  "memory.graceLabel": "Neustart-Karenzzeit (Sekunden)",
  "memory.applyGrace": "Karenzzeit übernehmen",
  "memory.graceRangeError": "Wert zwischen {min} und {max} Sekunden eingeben.",
  "memory.graceCooldownError": "Darf das minimale Neustart-Intervall ({seconds}s) nicht überschreiten.",
