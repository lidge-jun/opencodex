...
export const de = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.field.aliasHint": "Optional. Clients fordern genau diesen Namen statt des Standardnamens an. Verwenden Sie eine einfache ID wie deepseek-v4-flash, wenn ein vorgegebener Modellname erforderlich ist — ohne combo/-Präfix.",
