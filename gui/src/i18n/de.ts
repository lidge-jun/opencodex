...
export const de = {
  ...
  "api.tunnelModeQuick": "Quick Tunnel · Temporärer Entwicklungszugriff mit bis zu 200 gleichzeitig laufenden Anfragen, ohne SSE-Unterstützung. Die öffentliche URL ändert sich nach einem Neustart.",
  "api.tunnelModeNamed": "Named Tunnel · Stabiler öffentlicher Zugriff mit SSE-Unterstützung, geeignet für Streaming.",
