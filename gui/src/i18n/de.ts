...
export const de = {
  ...
  "codexAuth.namespacesTitle": "Kontospezifische Modelle",
  "codexAuth.namespacesOnDesc": "Persönliche und kontobezogene Modelloptionen sind verfügbar und bleiben strikt an das gewählte Konto gebunden.",
  "codexAuth.namespacesOffDesc": "Fügt der Codex-Modellauswahl explizite Optionen für Persönlich und Arbeit hinzu.",
  "codexAuth.namespacesSaved": "Kontospezifische Modelle aktualisiert. Öffne Codex erneut, falls die Liste veraltet ist.",
  "codexAuth.namespacesSaveFailed": "Kontospezifische Modelle konnten nicht aktualisiert werden. Die vorherige Einstellung bleibt erhalten.",
  "codexAuth.pickerModeTitle": "Anordnung der Auswahl",
  "codexAuth.pickerModeAdditive": "Standard + Konten",
  "codexAuth.pickerModeReplace": "Nur Konten",
  "codexAuth.pickerModeAdditiveDesc": "Zeigt Standard-OpenAI-Modelle neben den Kontooptionen Persönlich / Arbeit.",
  "codexAuth.pickerModeReplaceDesc": "Zeigt nur kontogebundene OpenAI-Optionen. Andere Anbieter bleiben unverändert.",
  "codexAuth.pickerModeSaved": "Auswahl aktualisiert. Öffne Codex erneut, falls die Modellliste veraltet ist.",
  "codexAuth.pickerModeSaveFailed": "Die Einstellung konnte nicht gespeichert werden. Die vorherige Auswahl bleibt erhalten.",
