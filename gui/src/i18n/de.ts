...
export const de = {
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "frontier.subtitle": "Vergleiche Modelle anhand öffentlicher Coding-Agent-Benchmarks: Fähigkeit vs. Kosten pro Aufgabe. Wähle eine Domain, dann ein Board; filter nach Modell, Effort, Preis oder Use-Case. Snapshot-Daten — bei OpenCodex-Releases aktualisieren, kein Live-Metering.",
  "frontier.updated": "Snapshot {date}",
  "frontier.tasks": "{count} Aufgaben",
  "frontier.domainsAria": "Aufgaben-Domains",
  "frontier.domainHint": "Domains gruppieren Boards nach dem, was sie messen — Coding, Frontend, Terminal, Security oder breite Intelligence.",
  "frontier.domain.all": "Alle",
  ...
  "frontier.chartAria": "Frontier-Diagramm",
  "frontier.chartKindsAria": "Diagrammtyp",
  "frontier.chart.scatter": "Streudiagramm",
  "frontier.chart.costStack": "Kosten-Stack",
  "frontier.chart.score": "Nach Score",
  "frontier.chart.efficiency": "Nach Wert",
  "frontier.chart.reasoning": "Nach Reasoning",
  "frontier.chartHint.scatter": "Kosten vs. Score — oben links ist meist das bessere Preis-Leistungs-Verhältnis.",
  "frontier.chartHint.costStack": "Kosten pro Intelligence-Index-Aufgabe gestapelt nach Answer, Reasoning, Cache-Write, Cache-Hit und Input.",
  "frontier.chartHint.score": "Horizontale Rangliste nach Benchmark-Score.",
  "frontier.chartHint.efficiency": "Horizontale Rangliste nach Score / $ (höher = besseres Preis-Leistungs-Verhältnis).",
  "frontier.chartHint.reasoning": "Score vs. Kosten pro Rollout — jede Linie ist ein Modell über Reasoning-Stufen. Hover zeigt die Stufe; der Name sitzt am Peak-Score-Punkt.",
  "frontier.effortViewAria": "Reasoning-Effort-Ansicht",
  "frontier.effortView.best": "Beste Reasoning-Stufe",
  "frontier.effortView.all": "Alle Reasoning-Stufen",
  "frontier.effortViewDisabled": "Dieses Board hat nur eine Effort-Zeile pro Modell — Best / All hat keine Wirkung.",
  "frontier.tableAria": "Frontier-Rangliste",
  "frontier.filter.models": "Modelle",
  "frontier.filter.effort": "Effort",
  "frontier.filter.price": "Preisband",
  "frontier.filter.tags": "Use-Case",
  "frontier.price.lt3": "Unter $3",
  "frontier.price.mid": "$3–8",
  "frontier.price.gt8": "Über $8",
  "frontier.tag.workhorse": "Arbeitstier",
  "frontier.tag.planner": "Planer",
  "frontier.tag.frontier": "Frontier",
  "frontier.tag.cheapSubagent": "Günstiger Subagent",
  "frontier.tag.fast": "Schnell",
  "frontier.ranking": "Rangliste",
  "frontier.rankingHint": "Sortiert nach Score / $ (höher = besseres Preis-Leistungs-Verhältnis)",
  "frontier.col.model": "Modell",
  "frontier.col.effort": "Effort",
  "frontier.col.cost": "Kosten / Aufgabe",
  "frontier.col.efficiency": "Score / $",
  "frontier.col.tags": "Use-Case",
  "frontier.bestValue": "Bestes Preis-Leistungs-Verhältnis",
  "frontier.bestScore": "Bester Score",
  "frontier.sourceLink": "Quelle",
  "frontier.costKindEstimated": "Kosten auf diesem Board sind Schätzungen oder API-Preis-Mischungen — Score/$-Ranking und „Bestes Preis-Leistungs-Verhältnis“ sind deaktiviert, bis jede Zeile eine gemessene Kosten/Aufgabe-Angabe aus der Quelle hat.",
  "frontier.chartValueDisabled": "„Nach Wert“ braucht ein Board, bei dem jede Zeile gemessene Kosten/Aufgabe aus der Quelle hat (keine Schätzungen).",
  "frontier.rankingHintScoreOnly": "Nur nach Score sortiert — Kosten sind auf diesem Board nicht einheitlich gemessen.",
  "frontier.col.costEstimated": "Schätz. Kosten",
  "frontier.col.efficiencyNa": "Score / $",
  "frontier.empty": "Keine Benchmark-Daten geladen.",
  "frontier.noMatches": "Keine Modelle passen zu diesen Filtern.",
  "frontier.noCostParts": "Dieses Board hat keine Token-Kostenaufschlüsselung. Öffne AA Intelligence Index für Answer / Reasoning / Cache / Input.",
  "frontier.boardNoCostParts": "Keine Kostenaufschlüsselung auf diesem Board — Cost-Stack nur bei Boards mit Token-Kostenanteilen.",
