...
export const de = {
  ...
  "modal.oauthDefaultNote": "Mit deinem Konto anmelden — kein API-Schlüssel erforderlich.",
  ...
  "pws.authForward": "Forward (Codex-Login)",
  ...
  "pws.removeConfirmDesc": "Das kann in der UI nicht rückgängig gemacht werden.",
  ...
  "pws.resetAll": "Alles zurücksetzen",
  ...
  "quota.resetsIn": "Zurücksetzen in {when}",
  "quota.resetsAt": "Zurücksetzen {when}",
  "quota.resetsRelativeHours": "Zurücksetzen in {n} Std.",
  "quota.resetsRelativeMinutes": "Zurücksetzen in {n} Min.",
  ...
  "pws.jsonInvalidAt": " in Zeile {line}",
