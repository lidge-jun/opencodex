...
export const de: Record<TKey, string> = {
  ...
  "googleAntigravityPool.title": "Google-Antigravity-Kontenpool",
  "googleAntigravityPool.enabledDesc": "Bei einem vorgelagerten HTTP 429 oder einem als HTTP 402 ausgegebenen Fehler wird auf ein anderes Konto umgeschaltet. Neue Sitzungen bevorzugen Konten mit weniger als {threshold}% Nutzung.",
  "googleAntigravityPool.disabledDesc": "Verwendet nur das aktive Google-Antigravity-Konto.",
  ...
  "googleAntigravityPool.needTwoAccounts": "Füge mindestens zwei Google-OAuth-Konten hinzu, bevor du den Pool aktivierst.",
  "anthropicPool.threshold": "Nutzungsschwelle für neue Sitzungen",
  "googleAntigravityPool.threshold": "Nutzungsschwelle für neue Sitzungen",
  "anthropicPool.thresholdAria": "Nutzungsschwelle für neue Sitzungen in Prozent",
  "googleAntigravityPool.thresholdAria": "Nutzungsschwelle für neue Sitzungen in Prozent",
  "anthropicPool.thresholdHelp": "0 deaktiviert die kontingentbasierte Auswahl (nur Affinität + aktives Konto). Standard 80.",
  "googleAntigravityPool.thresholdHelp": "Neue Sitzungen bevorzugen Konten unter dieser Nutzungsschwelle. 0 deaktiviert die kontingentbasierte Auswahl. Standard 80.",
  "anthropicPool.thresholdInvalid": "Gib eine ganze Zahl von 0 bis 100 ein",
  "googleAntigravityPool.thresholdInvalid": "Gib einen ganzzahligen Prozentwert von 0 bis 100 ein",
  "anthropicPool.loadFailed": "Claude-Pool-Einstellungen konnten nicht geladen werden.",
  "googleAntigravityPool.loadFailed": "Die Einstellungen des Google-Antigravity-Pools konnten nicht geladen werden.",
  "anthropicPool.saveFailed": "Claude-Pool-Einstellungen konnten nicht gespeichert werden.",
  "googleAntigravityPool.saveFailed": "Die Einstellungen des Google-Antigravity-Pools konnten nicht gespeichert werden.",
  "anthropicPool.on": "An",
  "anthropicPool.off": "Aus",
  "googleAntigravityPool.on": "An",
  "googleAntigravityPool.off": "Aus",
