...
export const de: Record<TKey, string> = {
  ...
  "codexAuth.confirmResetDesc": "Dies setzt deine aktuellen Ratenbegrenzungen sofort zurück. Nach der Bestätigung musst du das OpenCodex-Admin-Token erneut eingeben. Du hast noch {count} Gutschrift(en).",
