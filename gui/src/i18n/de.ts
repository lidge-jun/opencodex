...
export const de: Record<TKey, string> = {
  ...
  "navGroup.resources": "Ressourcen",
  "navGroup.observability": "Beobachtung",
  "navGroup.automation": "Automatisierung",
  ...
  "auth.adminTokenTitle": "hubapi-Admin-Token (OPENCODEX_ADMIN_AUTH_TOKEN)",
  ...
  "startup.subtitle": "Prüft, ob Codex hubapi nach einem Neustart erreicht, bevor lokales Proxy-Routing in einer Wiederverbindungsschleife endet.",
  ...
  "startup.summary.protected": "hubapi ist nach einem Neustart verfügbar",
  ...
  "startup.riskDetailCustomLocal": "Codex verwendet ein benutzerdefiniertes lokales Gateway. hubapi kann dessen Neustart-Lebenszyklus weder verwalten noch prüfen.",
  ...
  "startup.codexRuntime.clampHidden": "Einige Reasoning-Effort-Optionen wurden ausgeblendet, weil hubapi Codex {version} verwendet hat.",
  "startup.codexRuntime.clampHiddenWithEfforts": "Einige Reasoning-Effort-Optionen wurden ausgeblendet, weil hubapi Codex {version} verwendet hat (entfernt: {efforts}).",
  "startup.codexRuntime.olderBinary": "hubapi verwendet eine ältere Codex-Binary ({version}). Eine neuere Installation ist verfügbar.",
  "dash.subtitle": "Live-Status des lokalen hubapi-Proxys, seiner Anbieter und der in Codex gerouteten Modelle.",
  ...
  "dash.routes.title": "Letzte Routing-Evidenz",
  "dash.routes.hint": "Nur aufgezeichnete Anfragen; Konfigurationsvorschauen bleiben getrennt.",
  "dash.routes.viewAll": "Logs anzeigen",
  "dash.routes.unavailable": "Der persistente Anfrageverlauf ist nicht verfügbar.",
  "dash.routes.empty": "Noch keine persistierten Anfragen.",
  "dash.routes.unknown": "Routing-Trace nicht verfügbar",
  "dash.routes.attempts": "{count} Versuche",
  ...
  "dash.codexAutoStart": "hubapi mit Codex starten",
  ...
  "dash.shadowCallTooltip": "Die Codex-App ruft im Hintergrund ein Hilfsmodell für Titelgenerierung, Commit-Nachrichten und Skill-Orchestrierung auf. Das Modell wechselt zwischen Client-Versionen, daher fängt hubapi diesen Satz ab: {models}.",
  ...
  "dash.maintenanceHint": "Aktualisiere Codex’ Modellkatalog oder installiere eine neuere hubapi-Version.",
  ...
  "dash.projectConfigTitle": "Projekt-Codex-Konfig umgeht hubapi",
  "dash.projectConfigHint": "Diese repo-lokalen Einstellungen überschreiben den hubapi-Proxy (z. B. direkt zu OpenCode Go routen). Entferne sie, damit die Routing aus ~/.codex/config.toml in diesem Projekt greift.",
  "dash.checkUpdate": "Update prüfen",
  "dash.updateTitle": "hubapi aktualisieren",
  ...
  "dash.updateStatus.running": "hubapi wird aktualisiert.",
  ...
  "prov.subtitle": "Konfiguriere die Upstream-Anbieter, die hubapi in Codex routet. Melde dich mit einem Konto an, füge einen Anbieter hinzu oder bearbeite die Rohkonfiguration.",
  ...
  "oauthTos.anthropicBody": "Die direkte Wiederverwendung von Claude-Abo-OAuth-Tokens über einen Drittanbieter-Proxy wie hubapi ist keine von Anthropic unterstützte Integration und kann zu Zugriffsbeschränkungen führen. Unterstützte Agent-SDK-Integrationen, die Claude-Abos verwenden, sind davon getrennt.",
  "oauthTos.highBody": "hubapi verbindet {provider} über einen OAuth-Pfad eines Drittanbieters. Bei nicht unterstützter Nutzung kann der Zugriff eingeschränkt oder gesperrt werden.",
  "oauthTos.elevatedBody": "hubapi verbindet {provider} über einen inoffiziellen OAuth-Pfad. Nutze nach Möglichkeit den offiziellen Client; ungewöhnlicher oder automatisierter Traffic kann als Missbrauch gewertet und der Zugriff eingeschränkt oder gesperrt werden.",
  "oauthTos.saferPath": "Sicherere Option: Hinterlege stattdessen einen API-Schlüssel in hubapi.",
  ...
  "sub.subtitle": "Codex {cmd} bewirbt nur die ersten 5 Modelle (nach Priorität) als Overrides. Wähle hier bis zu 5 — natives gpt oder geroutet — und hubapi setzt ihre Katalog-Priorität, sodass genau diese führen. Jedes andere Modell bleibt über seinen exakten Namen aufrufbar; dies steuert nur die Anzeige.",
  ...
  "logs.subtitle": "Persistierte Anfragen über den lokalen hubapi-Proxy, neueste zuerst.",
  "logs.history.indexed": "{count} persistierte Anfragen indiziert",
  "logs.history.repaired": "Verlaufsindex wurde repariert",
  "logs.history.loadOlder": "Ältere Anfragen laden",
  "logs.history.loadError": "Ältere Anfragen konnten nicht geladen werden.",
  ...
  "logs.filter.advanced": "Filter für gespeicherten Verlauf",
  "logs.filter.provider": "Anbieter-ID",
  "logs.filter.model": "Finales Modell",
  "logs.filter.requestedModel": "Angefragtes Modell",
  "logs.filter.status": "HTTP-Status",
  "logs.filter.protocol": "Eingangsprotokoll",
  "logs.filter.apiKey": "API-Key-ID",
  "logs.filter.profile": "Routingprofil-ID",
  "logs.filter.fallback": "Fallback verwendet",
  "logs.filter.fallback.any": "Beliebig",
  "logs.filter.fallback.yes": "Ja",
  "logs.filter.fallback.no": "Nein",
  "logs.filter.apply": "Filter anwenden",
  "logs.filter.clearAll": "Alle löschen",
  ...
  "logs.detail.route.loading": "Aufgezeichnete Routing-Evidenz wird geladen…",
  "logs.detail.route.loadError": "Die Routing-Evidenz konnte nicht geladen werden; aus dem finalen Anbieter wird keine Route abgeleitet.",
  "logs.detail.route.requested": "Angefragtes Modell",
  "logs.detail.route.final": "Finales Ziel",
  "logs.detail.route.outcome": "Ergebnis",
  ...
  "integrations.subtitle": "Clients mit hubapi verbinden, Zugangsdaten verwalten und Client-Konfigurationen wiederherstellen.",
  ...
  "integrations.codex.body": "Die Codex-Anbindung wird vom Proxy-Dienst verwaltet. Beim Start von hubapi wird sie angewendet; beim Stoppen des Dienstes wird das native Routing wiederhergestellt.",
  ...
  "integrations.dialog.desktop.changes": "Falls {path} ein von hubapi verwaltetes Gateway-Profil enthält, wählt Desktop zuerst ein neues Standardprofil ohne Zugangsdaten und entfernt danach das alte Profil und dessen Sicherung.",
  "integrations.dialog.desktop.breakage": "Claude Desktop verwendet dann statt über hubapi gerouteter Modelle wieder das standardmäßige Claude.",
  "integrations.dialog.desktop.undo": "Beim erneuten Aktivieren wird das hubapi-Profil aus deinen gespeicherten Modellzuweisungen neu erstellt.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop zeigt auf den Standardmodus, aber alte hubapi-Zugangsdaten befinden sich noch unter: {paths}.",
  ...
  "integrations.detail.grokAbsent": "Kein hubapi-Block in der Konfiguration",
  "integrations.dialog.grok.title": "Grok-Build-Integration deaktivieren?",
  "integrations.dialog.grok.changes": "Aus {path} wird nur der von hubapi markierte Block entfernt. Manuell geschriebener Inhalt außerhalb des Blocks bleibt unverändert.",
  "integrations.dialog.grok.breakage": "Nach dem Deaktivieren verschwinden die hubapi-Modellaliase aus Grok Build. Modelle, die mit dem xAI-Konto verwendet wurden, bleiben erhalten.",
  "integrations.dialog.grok.undo": "Wenn hubapi unter einer Loopback-Adresse läuft, wird beim erneuten Aktivieren ein neuer Block aus der aktuell verfügbaren Modellliste geschrieben.",
  "integrations.dialog.grok.confirm": "Deaktivieren",
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build kann nur automatisch registriert werden, wenn hubapi unter einer Loopback-Adresse läuft. Der vorherige Block mit Verweis auf Loopback wurde entfernt.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build kann nur automatisch registriert werden, wenn hubapi unter einer Loopback-Adresse läuft. Es gab keinen vorherigen Block zu entfernen.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build kann nur automatisch registriert werden, wenn hubapi unter einer Loopback-Adresse läuft. Inzwischen hat eine andere Stelle einen neuen Block in die Konfiguration geschrieben; der aktuelle Block in der Datei wurde daher nicht von dieser Anfrage erstellt.",
  "integrations.native.error.orphanedMarker": "{path} enthält eine hubapi-Startmarkierung, aber keine Endmarkierung. Die Datei wurde nicht geändert, weil das Ende des Blocks nicht sicher bestimmt werden kann.",
  ...
  "integrations.onboarding": "Beim Anwenden wird nach dem Speichern einer Sicherung genau ein hubapi-Anbieterblock geschrieben. Beim Deaktivieren wird nur dieser Block entfernt; eine aufbewahrte Momentaufnahme kann wiederhergestellt werden.",
  "integrations.empty.title": "Keine installierten Clients erkannt",
  "integrations.empty.body": "Installiere einen unterstützten Client und kehre dann hierher zurück, um hubapi anzuwenden.",
  ...
  "integrations.error.conflict": "Die Konfiguration wurde geändert, nachdem hubapi sie geschrieben hatte. Es wurde nichts entfernt.",
  ...
  "integrations.bulk.body": "Nur der hubapi-eigene Block wird entfernt. Für jeden Client wird vorher eine Momentaufnahme gespeichert.",
  ...
  "integrations.semantics.dsh": "hubapi verwaltet nur llm-pi-ai.providers.opencodex in $DSH_HOME/settings.yaml. DSH lädt diesen Anbieter im laufenden Betrieb neu; Ihr Standardmodell und deepseek-official bleiben unverändert. Derzeit nur über Loopback; es werden keine echten Zugangsdaten geschrieben.",
  ...
  "accountPool.strategyDesc": "Wie hubapi einer neuen/ungebundenen Aufgabe ein Konto zuweist.",
  ...
  "api.title": "Proxy-API",
  "api.subtitle": "Mit generierten API-Schlüsseln greifen externe Apps auf den hubapi-Proxy zu. Die Authentifizierung läuft über den {authHeader}-Header; welche Header ein Endpunkt akzeptiert, steht in der Tabelle unten.",
  "api.proxy.title": "Einheitliches Proxy-Gateway",
  "api.proxy.online": "Online und bereit für API-Anfragen",
  "api.proxy.flowLabel": "Proxy-Anfragefluss",
  "api.proxy.clients": "Clients",
  "api.proxy.providers": "Anbieter",
  "api.proxy.baseUrl": "Basis-URL",
  "api.proxy.protocols": "Eingangsprotokolle",
  "api.proxy.auth": "Authentifizierung",
  ...
  "claude.smallFastModelNativeWarning": "Wenn kein Modell gewählt ist, setzt hubapi keine Hilfsmodell-Overrides. Claude Code kann dann sein natives Sonnet-Modell verwenden, wodurch Kosten bei deinem nativen Anbieter entstehen können.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.howBody": "Fordern Sie in Codex den öffentlichen Modellnamen der Combo an. Ohne eigenen Namen gilt combo/<id>. hubapi wählt ein Ziel und springt nur bei wiederholbaren Upstream-Fehlern. Ist kein Ziel verfügbar, schlägt die Anfrage geschlossen fehl, statt den globalen Standardanbieter zu verwenden.",
  ...
  "grok.subtitle": "Modelle, die hubapi in deiner Grok-Konfiguration registriert hat.",
  ...
  "grok.notConfiguredHint": "Starte den Proxy mit installiertem Grok neu; hubapi schreibt dann einen verwalteten Block nach:",
