...
"common.discard": "Verwerfen",
 ...
 "logs.filter.conversation.clear": "Löschen",
  ...
  "usage.retention.invalid": "Geben Sie ein Größenlimit zwischen 1 und {max} MiB ein.",
"usage.retention.error": "Das Größenlimit für den Nutzungsverlauf konnte nicht aktualisiert werden.",
  "usage.retention.disabled": "Unbegrenzt — automatische Verlaufsbereinigung ist deaktiviert.",
"usage.title": "Nutzung",
