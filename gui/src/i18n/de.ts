...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "sub.taskRecovery": "Verschlüsselte V2-Aufgaben wiederherstellen",
  "sub.taskRecoveryHint": "Für native ChatGPT-Eltern, die Arbeit an geroutete Modelle übergeben. Eine zusätzliche authentifizierte ChatGPT-Anfrage kann Kontingent verbrauchen und Latenz erhöhen. Wiederhergestellter Text bleibt nur in einem begrenzten Speicher-Cache; Fehler bleiben sicher geschlossen.",
  "sub.taskRecoveryConfirm": "Experimentelle Wiederherstellung verschlüsselter Aufgaben aktivieren? Sie kann zusätzliches ChatGPT-Kontingent verbrauchen, Latenz erhöhen und hängt von nicht dokumentiertem Backend-Verhalten ab.",
  ...
  "pws.openrouter.title": "Provider-Routing pro Modell",
  "pws.openrouter.hint": "Wähle die genauen OpenRouter-Endpunkte für jedes Modell. Die Erkennung erfordert einen autorisierten OpenRouter Management Key; das Routing nutzt weiterhin den konfigurierten API-Key.",
  "pws.openrouter.load": "Provider laden",
  "pws.openrouter.mode": "Routing-Verhalten",
  "pws.openrouter.inherit": "Provider-Standard übernehmen",
  "pws.openrouter.order": "Ausgewählte Provider priorisieren",
  "pws.openrouter.only": "Nur ausgewählte Provider verwenden",
  "pws.openrouter.allowFallbacks": "OpenRouter-Fallbacks nach den ausgewählten Providern zulassen",
  "pws.openrouter.managementKeyRequired": "Die Endpunkt-Erkennung erfordert einen autorisierten OpenRouter Management Key. Bestehendes manuelles Routing bleibt unverändert.",
  "pws.openrouter.keyRequired": "Füge vor der Provider-Erkennung einen OpenRouter API-Key hinzu.",
  "pws.openrouter.loadFailed": "Provider für dieses Modell konnten nicht geladen werden.",
  "pws.openrouter.loaded": "{count} Provider-Endpunkte geladen.",
  "pws.openrouter.notReturned": "Bei der letzten Erkennung nicht zurückgegeben",
  "pws.openrouter.saved": "Provider-Routing des Modells gespeichert.",
