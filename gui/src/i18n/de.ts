...
export const de = {
  ...
  "codexAuth.namespacesTitle": "Codex-Konten in der Modellauswahl anzeigen",
  "codexAuth.namespacesOnDesc": "Die Auswahl zeigt jedes GPT-Modell einmal pro hinzugefügtem Codex-Konto. Ein kontobeschriftetes Modell verwendet für den gesamten Thread das Kontingent dieses Kontos und wechselt nie das Konto.",
  "codexAuth.namespacesOffDesc": "GPT-Modelle folgen dem Pool- oder Direktverhalten oben. Aktiviere dies, um das genaue Konto für einen Thread zu wählen.",
  "codexAuth.namespacesCompatibilityNote": "Dies ändert nur die Anzeige neuer Modelloptionen. Das aktive Pool-Konto, bestehende Threads und gespeicherte Einstellungen bleiben unverändert.",
  "codexAuth.namespacesSaved": "Kontoauswahl aktualisiert. Öffne Codex erneut, falls die Liste veraltet ist.",
  "codexAuth.namespacesSaveFailed": "Die Kontoauswahl konnte nicht aktualisiert werden. Die vorherige Einstellung bleibt erhalten.",
