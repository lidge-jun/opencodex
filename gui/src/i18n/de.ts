...
export const de: Record<TKey, string> = {
  ...
  "codexAuth.removeCleanupPending": "Das Konto wurde entfernt, aber die lokale Bereinigung der Anmeldedaten steht noch aus.",
  "codexAuth.removeCleanupRetry": "Bereinigung erneut versuchen",
  "codexAuth.removeCleanupComplete": "Kontobereinigung abgeschlossen.",
  "codexAuth.removeCleanupRetryRefused": "Die Bereinigung wurde abgebrochen, weil die Abwesenheit des Kontos nicht bestätigt werden konnte.",
