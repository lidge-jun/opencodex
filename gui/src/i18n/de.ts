...
export const de = {
  ...
  "codexAuth.namespacesTitle": "Jedes Codex-Konto separat in der Modellauswahl anzeigen",
  "codexAuth.namespacesOnDesc": "Für jedes verfügbare Codex-Konto erscheint jedes GPT-Modell als eigener Eintrag. Main kennzeichnet den integrierten Login. Jede öffentliche Bezeichnung in der Modellauswahl wird intern genau einem gespeicherten Konto zugeordnet. Hinzugefügte Konten verwenden ihren selbst gewählten Anzeigenamen oder, falls keiner gesetzt ist, eine stabile datenschutzfreundliche Bezeichnung im Format pXXXXXX; gespeicherte Konto-IDs und E-Mail-Adressen werden nie verwendet. Bestehende und benutzerdefinierte Bezeichnungen bleiben unverändert. Die Auswahl bindet die Unterhaltung genau an dieses Konto; OpenCodex wechselt nicht und fällt nicht auf ein anderes Konto zurück.",
  "codexAuth.namespacesOffDesc": "Aktiviere dies, wenn du mehrere Codex-Konten hast und ohne Abmeldung genau auswählen möchtest, welches Konto eine Unterhaltung verwendet. Beim Ausschalten werden nur diese Einträge ausgeblendet; Konten werden nicht entfernt.",
  "codexAuth.namespacesCompatibilityNote": "Dies ersetzt die normalen GPT-Einträge in der Modellauswahl durch kontospezifische Optionen. Bestehende Unterhaltungen, benutzerdefinierte Kontobezeichnungen und gespeicherte Modellauswahlen behalten ihr aktuelles Routing; reine GPT-Modell-IDs behalten ihr Pool- oder Direktverhalten.",
  "codexAuth.namespacesSaved": "Kontospezifische Einträge aktualisiert. Öffne Codex erneut, falls die Liste veraltet ist.",
  "codexAuth.namespacesSaveFailed": "Die Modellauswahl konnte nicht aktualisiert werden. Die vorherige Einstellung bleibt erhalten.",
  ...
  "codexAuth.catalogRefreshPending": "Die Kontoänderung wurde gespeichert, aber die Modellauswahl konnte nicht aktualisiert werden. Führe `ocx sync` aus, um es erneut zu versuchen.",
