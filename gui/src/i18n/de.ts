...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "remoteLink.findHome.notice": "Beim Verbinden wird OpenCodex auf diesem Computer neu gestartet. Laufende Codex-Anfragen werden zuerst abgeschlossen, und neue Anfragen können bis zu einer Minute fehlschlagen. Danach behält Codex dieselbe lokale Adresse, und das Home bedient sie mit seinen eigenen Anbietern und Konten.",
  ...
  "remoteLink.restart.body": "Laufende Codex-Anfragen werden zuerst abgeschlossen, dann startet OpenCodex als Kind neu. Diese Seite lädt sich selbst neu, sobald das Kind bereit ist.",
  "remoteLink.restart.waiting": "Warten auf die erneute Verbindung als Kind …",
  "remoteLink.restart.slow": "Der Neustart dauert länger als üblich. Diese Seite prüft weiter und lädt sich selbst neu, sobald das Kind antwortet. Falls OpenCodex beendet wurde, starten Sie es erneut.",
  ...
  "remoteLink.error.fingerprint_failed": "Der SSH-Hostschlüssel konnte nicht gelesen werden. Testen Sie die Verbindung erneut.",
  "remoteLink.error.forbidden": "Diese Dashboard-Sitzung kann keine Remote-Links verwalten. Öffnen Sie das Dashboard auf diesem Computer (eigenständige Installation) oder verwenden Sie eine gekoppelte Hub-Sitzung.",
  ...
  "remoteLink.error.link_unavailable": "Remote Link ist in dieser Laufzeit nicht verfügbar. Starten Sie OpenCodex neu und versuchen Sie es erneut.",
  "remoteLink.error.listener_unavailable": "Der Remote-Link-Listener konnte auf diesem Computer nicht starten. Prüfen Sie, ob ein Portkonflikt besteht, und versuchen Sie es erneut.",
  "remoteLink.error.probe_failed": "Keine Verbindung zum SSH-Host möglich. Prüfen Sie, ob er Ihren SSH-Schlüssel akzeptiert und ob ein benötigter ProxyCommand-Helfer installiert ist.",
  "remoteLink.error.remote_connect_failed": "Der entfernte Computer konnte sich nicht mit diesem Home verbinden. Prüfen Sie dort den OpenCodex-Dienst und versuchen Sie es erneut.",
  "remoteLink.error.remote_disconnect_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.remote_ocx_missing": "ocx wurde auf dem entfernten Computer nicht gefunden. Installieren Sie dort OpenCodex oder stellen Sie sicher, dass ocx im PATH nicht interaktiver SSH-Sitzungen liegt.",
  "remoteLink.error.remote_ocx_outdated": "OpenCodex auf dem entfernten Computer ist für Remote Link zu alt. Führen Sie dort ocx update aus (2.66.0 oder neuer) und versuchen Sie es erneut.",
  "remoteLink.error.remote_ocx_unrecognized": "Der entfernte Computer hat keine OpenCodex-Version gemeldet. Remote Link benötigt OpenCodex 2.66.0 oder neuer unter macOS oder Linux.",
  "remoteLink.error.remote_port_failed": "Der entfernte Computer konnte seinen Link-Port nicht melden. Prüfen Sie, ob dort OpenCodex 2.66.0 oder neuer läuft, und versuchen Sie es erneut.",
  "remoteLink.error.tailscale_session_refused": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.version_probe_failed": "ocx konnte auf dem entfernten Computer nicht über SSH ausgeführt werden. Prüfen Sie den SSH-Zugang und versuchen Sie es erneut.",
