...
export const de = {
  ...
  "api.subtitle": "Nutze generierte API-Schlüssel, um von externen Apps auf den opencodex-Proxy zuzugreifen. Authentifiziere Anfragen mit {authHeader}.",
  "api.endpoint": "Endpunkt",
  "api.endpointNote": "Kompatibel mit dem OpenAI Responses API-Format.",
  "api.tunnelTitle": "Öffentlicher Cloudflare-Zugriff",
  "api.tunnelStatusStopped": "Aus",
  "api.tunnelStatusStarting": "Wird gestartet",
  "api.tunnelStatusRunning": "Öffentlich",
  "api.tunnelStatusStopping": "Wird beendet",
  ...
  "api.tunnelStarting": "Wird gestartet…",
  "api.tunnelStopping": "Wird beendet…",
  "api.tunnelRequestFailed": "Der öffentliche Cloudflare-Zugriff konnte nicht aktualisiert werden. Prüfe, ob der Proxy läuft, und versuche es erneut.",
  "api.tunnelConfigure": "Öffentlichen Zugriff einrichten",
  "api.tunnelReconfigure": "Neu konfigurieren",
  "api.tunnelUseQuick": "Quick Tunnel verwenden",
  "api.tunnelQuickNote": "Quick Tunnel ist eine temporäre Debugging-Option: keine Cloudflare-Einrichtung nötig, aber die Adresse ändert sich und SSE wird nicht unterstützt. Für produktiven öffentlichen API-Zugriff Named Tunnel verwenden.",
  "api.tunnelPublicUrl": "Öffentliche URL:",
  "api.tunnelOriginUrl": "Lokaler Ursprung:",
  "api.tunnelSetupTitle": "Named Tunnel einrichten",
  "api.tunnelSetupIntro": "Verbinde dein Cloudflare-Konto automatisch oder nutze die Zugangsdaten eines vorhandenen Tunnels.",
  "api.tunnelSseNote": "Named Tunnel ist der Standard und unterstützt SSE-Streaming durchgängig.",
  "api.tunnelSetupMethod": "Einrichtungsmethode",
  "api.tunnelSetupAutomatic": "Automatisch einrichten",
  "api.tunnelSetupAutomaticDesc": "Tunnel, DNS-Route und lokalen Connector mit einem eingeschränkten API-Token in einem Schritt erstellen.",
  "api.tunnelSetupExisting": "Vorhandenen Tunnel nutzen",
  "api.tunnelSetupExistingDesc": "Öffentliche URL und Tunnel-Token oder den cloudflared-Installationsbefehl einfügen.",
  "api.tunnelAccountId": "Cloudflare-Konto-ID",
  "api.tunnelAccountIdPlaceholder": "Konto-ID eingeben",
  "api.tunnelZoneId": "Cloudflare-Zonen-ID",
  "api.tunnelZoneIdPlaceholder": "Zonen-ID eingeben",
  "api.tunnelHostname": "Öffentlicher Hostname",
  "api.tunnelHostnamePlaceholder": "api.example.com",
  "api.tunnelName": "Tunnelname (optional)",
  "api.tunnelNamePlaceholder": "opencodex",
  "api.tunnelApiToken": "Cloudflare API-Token",
  "api.tunnelApiTokenPlaceholder": "Eingeschränktes API-Token einfügen",
  "api.tunnelApiPermissions": "Verwende ein eingeschränktes Token nur mit Account: Cloudflare Tunnel Edit und Zone: DNS Edit.",
  "api.tunnelReplaceExistingConfirm": "Mir ist bewusst, dass ein neuer Tunnel und DNS-Eintrag erstellt werden. Die bisherigen Cloudflare-Ressourcen werden nicht automatisch gelöscht und müssen nach der Prüfung manuell entfernt werden.",
  "api.tunnelExistingPublicUrl": "Vorhandene öffentliche URL",
  "api.tunnelExistingPublicUrlPlaceholder": "https://api.example.com",
  "api.tunnelTokenOrCommand": "Tunnel-Token oder Installationsbefehl",
  "api.tunnelTokenOrCommandPlaceholder": "Tunnel-Token oder cloudflared-Installationsbefehl einfügen",
  "api.tunnelTokenSecurity": "Das Cloudflare-API-Token wird nur für diese Einrichtung verwendet und nie gespeichert. Lokal bleibt nur das Tunnel-Runner-Token.",
  "api.tunnelRunnerTokenSecurity": "Das Tunnel-Runner-Token wird in einer geschützten lokalen Datei gespeichert und nie von der Verwaltungs-API zurückgegeben.",
  "api.tunnelOpenDashboard": "Cloudflare-Dashboard öffnen",
  "api.tunnelTokenGuide": "Anleitung für API-Tokens",
  "api.tunnelExistingGuide": "Named-Tunnel-Anleitung",
  "api.tunnelConfiguring": "Wird eingerichtet…",
  "api.tunnelConfigureStart": "Einrichten und aktivieren",
  "api.tunnelSetupFailed": "Der Named Tunnel konnte nicht eingerichtet werden. Prüfe die Angaben und Cloudflare-Berechtigungen und versuche es erneut.",
