...
export const de: Record<TKey, string> = {
  ...
  "models.customFieldCodexAccount": "Codex-Konto für dieses Modell",
  "models.customAccountTargetAutomatic": "Automatisch (Provider Pool/Direct)",
  "models.customAccountTargetHint": "Optionale feste Bindung. Ist das Ziel nicht verfügbar, wird kein anderes Konto verwendet.",
  "models.customAccountTargetPaused": "pausiert",
  "models.customAccountTargetUnavailable": "Zuvor gewähltes Konto (nicht verfügbar)",
  "models.customAccountTargetLoadFailed": "Codex-Kontoauswahl konnte nicht geladen werden",
