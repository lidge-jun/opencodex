...
export const de: Record<TKey, string> = {
  ...
  "brain.subtitle": "Read-only-Observatorium: Agenten, Aufgaben, Skills, Knoten, Memory.",
  "brain.askPlaceholder": "Frag Pao Brain...",
  "brain.search": "Suchen",
  "brain.loading": "Wird geladen...",
  "brain.loadFailed": "Observatoriumsdaten konnten nicht geladen werden.",
  "brain.tab.agents": "Agenten",
  "brain.tab.tasks": "Aufgaben",
  "brain.tab.skills": "Skills",
  "brain.tab.nodes": "Knoten",
  "brain.tab.memory": "Memory",
  "brain.tab.search": "Suchen",
  "brain.empty.agents": "Keine Agenten registriert.",
  "brain.empty.tasks": "Keine Aufgaben in der Warteschlange.",
  "brain.empty.skills": "Keine Skills registriert.",
  "brain.empty.nodes": "Keine Remote-Knoten registriert.",
  "brain.empty.memory": "Keine Memories gespeichert.",
  "brain.empty.search": "Stelle eine Frage, um das lokale Universum zu durchsuchen.",
  "brain.empty.searchResults": "Keine lokalen Treffer.",
  "brain.col.name": "Name",
  "brain.col.provider": "Anbieter",
  "brain.col.type": "Typ",
  "brain.col.health": "Status",
  "brain.col.enabled": "Aktiv",
  "brain.col.title": "Titel",
  "brain.col.kind": "Art",
  "brain.col.status": "Status",
  "brain.col.attempts": "Versuche",
  "brain.col.version": "Version",
  "brain.col.capabilities": "Fähigkeiten",
  "brain.permits.pending": "Ausstehende Schreibgenehmigungen",
  "brain.permits.grant": "Erteilen",
  "brain.permits.deny": "Ablehnen",
  "brain.tab.policies": "Richtlinien",
  "brain.policies.capability": "Fähigkeit",
  "brain.policies.subject": "Subjekt",
  "brain.policies.effect": "Wirkung",
  "brain.policies.addAllow": "Erlauben",
  "brain.policies.addDeny": "Verbieten",
  "brain.policies.empty": "Keine Richtlinien konfiguriert.",
  "brain.policies.remove": "Entfernen",
  "brain.tab.projects": "Projekte",
  "brain.projects.name": "Projektname",
  "brain.projects.path": "Wurzelverzeichnis",
  "brain.projects.add": "Hinzufügen",
  "brain.projects.scan": "Scannen",
  "brain.projects.empty": "Keine Projekte registriert.",
  "brain.projects.files": "Dateien",
  "brain.projects.lastScan": "Letzter Scan",
  "brain.tab.atlas": "Atlas",
  "brain.tab.universe": "Universum",
  ...
  "demo.loadScenario": "Smart-Factory-Szenario laden",
  "demo.reset": "Demo zurücksetzen",
  "demo.noProject": "Noch kein Projekt. Szenario laden.",
  "demo.scenarioLoaded": "Szenario geladen.",
  "demo.resetDone": "Demo zurückgesetzt.",
  "demo.approvalsTitle": "Ausstehende Genehmigungen",
  "demo.approvalsNone": "Keine ausstehenden Genehmigungen.",
  "demo.activityTitle": "Agent-Aktivität",
  "demo.activityNone": "Noch keine Agent-Aktivität.",
  "brain.tab.tools": "Werkzeuge",
  "brain.tab.activity": "Aktivität",
  "brain.tool.risk": "Risiko",
  "brain.tool.readOnly": "Schreibgeschützt",
  "brain.tool.execute": "Ausführen",
  "brain.tool.empty": "Keine Werkzeuge registriert.",
  "brain.activity.empty": "Noch keine Agent-Aktivität.",
  "brain.activity.tool": "Werkzeug",
  "brain.activity.actor": "Akteur",
  "brain.activity.result": "Ergebnis",
  "brain.graph.selectProject": "Projekt",
  "brain.graph.empty": "Keine Graphdaten. Scannen Sie zuerst ein Projekt.",
  "brain.graph.nodes": "Knoten",
  "brain.graph.edges": "Kanten",
  "brain.graph.capped": "Die ersten 180 Knoten werden angezeigt.",
