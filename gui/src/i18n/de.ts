...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
  ...
  "codexAuth.managedByCodex": "Von Codex verwaltet",
  "codexAuth.keyringDetailsPending": "OpenCodex kann die Codex-Anmeldung im Schlüsselbund nicht lesen. Kontotyp und Kontingent werden nach der ersten erfolgreichen Anfrage über diesen Proxy angezeigt.",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "pws.capacity.incomplete": "Unvollständige Abdeckung: {excluded} Konto/Konten ausgeschlossen.",
  "pws.capacity.missingQuota": "Keine aktuellen Kontingentdaten: {count} Konto/Konten.",
  "pws.capacity.unknownPlan": "Unbekannter Tarif: {count} Konto/Konten.",
  "pws.capacity.pausedAccounts": "Pausiert: {count} Konto/Konten.",
  "pws.capacity.reauthAccounts": "Erneute Anmeldung erforderlich: {count} Konto/Konten.",
  "pws.capacity.staleQuota": "Veraltete Kontingentdaten: {count} Konto/Konten.",
