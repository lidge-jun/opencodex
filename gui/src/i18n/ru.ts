...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "cws.group.weighted": "Взвешенный",
  "cws.group.leastUsed": "Наименее исп.",
  "cws.group.resetWindow": "Окно сброса",
  ...
  "cws.count.weighted": "Взвешенный",
  "cws.count.leastUsed": "Наименее исп.",
  "cws.count.resetWindow": "Окно сброса",
  ...
  "cws.strategy.randomHint": "Взвешенный случайный выбор. Цели с большим весом выбираются чаще.",
  "cws.strategy.resetWindowHint": "Предпочитает цели, чьё известное окно квоты сбросится раньше. Цели без известного времени сброса остаются резервными.",
  "cws.strategy.leastUsedHint": "Выбирает цель с наименьшим количеством записей использования.",
  ...
  "cws.targets.randomHint": "Веса задают вероятность выбора каждой цели для запроса.",
  "cws.targets.leastUsedHint": "Порядок разрешает равенство при одинаковом числе успешных использований.",
  "cws.targets.resetWindowHint": "Порядок разрешает равенства и служит запасным вариантом, когда нет кэшированного времени сброса квоты.",
