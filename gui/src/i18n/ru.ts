...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "codexAuth.autoSwitchResetWindowDesc": "Reset-window: {threshold}% — точка исчерпания; аккаунты с запасом идут по свежему времени сброса.",
  "codexAuth.autoSwitchResetWindowOffDesc": "У reset-window нет порога использования; свежий порядок сбросов всё равно назначает новые/непривязанные задачи.",
  ...
  "accountPool.strategyResetWindow": "Окно сброса",
