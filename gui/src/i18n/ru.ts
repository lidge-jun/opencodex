...
export const ru: Record<TKey, string> = {
  ...
  "app.logoAria": "Логотип PaohupByPaoZa",
  ...
  "brain.title": "Обсерватория только для чтения: агенты, задачи, навыки, узлы, память.",
  "brain.subtitle": "Обсерватория только для чтения: агенты, задачи, навыки, узлы, память.",
  "brain.askPlaceholder": "Спросите Pao Brain...",
  "brain.search": "Поиск",
  "brain.loading": "Загрузка...",
  "brain.loadFailed": "Не удалось загрузить данные обсерватории.",
  "brain.tab.agents": "Агенты",
  "brain.tab.tasks": "Задачи",
  "brain.tab.skills": "Навыки",
  "brain.tab.nodes": "Узлы",
  "brain.tab.memory": "Память",
  "brain.tab.search": "Поиск",
  "brain.empty.agents": "Агенты не зарегистрированы.",
  "brain.empty.tasks": "В очереди нет задач.",
  "brain.empty.skills": "Навыки не зарегистрированы.",
  "brain.empty.nodes": "Удалённые узлы не зарегистрированы.",
  "brain.empty.memory": "Память не записана.",
  "brain.empty.search": "Введите вопрос для поиска локальной вселенной.",
  "brain.empty.searchResults": "Локальных совпадений нет.",
  "brain.col.name": "Имя",
  "brain.col.provider": "Провайдер",
  "brain.col.type": "Тип",
  "brain.col.health": "Состояние",
  "brain.col.enabled": "Включён",
  "brain.col.title": "Заголовок",
  "brain.col.kind": "Вид",
  "brain.col.status": "Статус",
  "brain.col.attempts": "Попытки",
  "brain.col.version": "Версия",
  "brain.col.capabilities": "Возможности",
  "brain.permits.pending": "Ожидающие разрешения на запись",
  "brain.permits.grant": "Разрешить",
  "brain.permits.deny": "Отклонить",
  "brain.tab.policies": "Политики",
  "brain.policies.capability": "Способность",
  "brain.policies.subject": "Субъект",
  "brain.policies.effect": "Действие",
  "brain.policies.addAllow": "Разрешить",
  "brain.policies.addDeny": "Запретить",
  "brain.policies.empty": "Политики не настроены.",
  "brain.policies.remove": "Удалить",
  "brain.tab.projects": "Проекты",
  "brain.projects.name": "Имя проекта",
  "brain.projects.path": "Корневой путь",
  "brain.projects.add": "Добавить",
  "brain.projects.scan": "Сканировать",
  "brain.projects.empty": "Проекты не зарегистрированы.",
  "brain.projects.files": "файлов",
  "brain.projects.lastScan": "Последнее сканирование",
  "brain.tab.atlas": "Атлас",
  "brain.tab.universe": "Вселенная",
  ...
  "demo.loadScenario": "Загрузить сценарий Smart Factory",
  "demo.reset": "Сбросить демо",
  "demo.noProject": "Проекта нет. Загрузите сценарий.",
  "demo.scenarioLoaded": "Сценарий загружен.",
  "demo.resetDone": "Демо сброшено.",
  "demo.approvalsTitle": "Ожидающие одобрения",
  "demo.approvalsNone": "Ожидающих одобрений нет.",
  "demo.activityTitle": "Активность агента",
  "demo.activityNone": "Активности агента пока нет.",
  "brain.tab.tools": "Инструменты",
  "brain.tab.activity": "Активность",
  "brain.tool.risk": "Риск",
  "brain.tool.readOnly": "Только чтение",
  "brain.tool.execute": "Выполнить",
  "brain.tool.empty": "Инструменты не зарегистрированы.",
  "brain.activity.empty": "Активности агента пока нет.",
  "brain.activity.tool": "Инструмент",
  "brain.activity.actor": "Актор",
  "brain.activity.result": "Результат",
  "brain.graph.selectProject": "Проект",
  "brain.graph.empty": "Нет данных графа. Сначала просканируйте проект.",
  "brain.graph.nodes": "узлов",
  "brain.graph.edges": "связей",
  "brain.graph.capped": "Показаны первые 180 узлов.",
  "brain.graph.aria": "Граф Brain Universe",
