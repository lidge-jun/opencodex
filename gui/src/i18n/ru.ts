...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "integrations.cursor.ladderFromStatic": "Уровни рассуждения — статическая копия Cursor 3.18.25 (установка Private Inference для чтения не найдена). Столбец «Контекст» показывает окно по умолчанию и опциональное окно.",
