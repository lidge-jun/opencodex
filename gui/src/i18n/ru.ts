...
export const ru: Record<TKey, string> = {
  ...
  "models.customFieldCodexAccount": "Аккаунт Codex для этой модели",
  "models.customAccountTargetAutomatic": "Автоматически (Pool/Direct провайдера)",
  "models.customAccountTargetHint": "Необязательная точная привязка. Если аккаунт недоступен, другой аккаунт не используется.",
  "models.customAccountTargetPaused": "приостановлен",
  "models.customAccountTargetUnavailable": "Ранее выбранный аккаунт (недоступен)",
  "models.customAccountTargetLoadFailed": "Не удалось загрузить варианты аккаунтов Codex",
