...
export const ru: Record<TKey, string> = {
  ...
  "api.clientConfig.whereBodyLoopback": "Путь выше — глобальное расположение. Файл конфигурации проекта в рабочем каталоге имеет приоритет. В сгенерированном файле хранится несекретный loopback-заполнитель, а не учётные данные; переменная окружения для ключа не нужна.",
