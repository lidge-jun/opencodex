...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "pws.openrouter.hint": "Выберите точные endpoints OpenRouter для каждой модели. Обнаружение и маршрутизация используют настроенный API-ключ OpenRouter.",
  ...
  "pws.openrouter.authorizationFailed": "OpenRouter отклонил настроенный API-ключ для обнаружения endpoints. Ручная маршрутизация не изменена.",
