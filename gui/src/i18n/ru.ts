...
export const ru: Record<TKey, string> = {
  ...
  "codexAuth.removeCleanupPending": "Аккаунт удалён, но локальная очистка учётных данных ещё не завершена.",
  "codexAuth.removeCleanupRetry": "Повторить очистку",
  "codexAuth.removeCleanupComplete": "Очистка аккаунта завершена.",
  "codexAuth.removeCleanupRetryRefused": "Повторная очистка остановлена: отсутствие аккаунта не удалось подтвердить.",
