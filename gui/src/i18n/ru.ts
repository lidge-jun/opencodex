...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "sub.taskRecovery": "Восстанавливать зашифрованные задачи V2",
  "sub.taskRecoveryHint": "Для нативного родителя ChatGPT, передающего работу маршрутизируемой модели. Дополнительный аутентифицированный запрос ChatGPT может расходовать квоту и увеличивать задержку. Восстановленный текст хранится только в ограниченном кэше памяти; ошибки остаются fail-closed.",
  "sub.taskRecoveryConfirm": "Включить экспериментальное восстановление зашифрованных задач? Оно может расходовать дополнительную квоту ChatGPT, увеличивать задержку и зависит от недокументированного поведения backend.",
  ...
  "pws.openrouter.hint": "Выберите точные endpoints OpenRouter для каждой модели. Для обнаружения нужен авторизованный OpenRouter Management Key; маршрутизация продолжает использовать настроенный API-ключ.",
  "pws.openrouter.load": "Загрузить провайдеров",
  "pws.openrouter.mode": "Поведение маршрутизации",
  "pws.openrouter.inherit": "Наследовать настройку провайдера",
  "pws.openrouter.order": "Отдать приоритет выбранным",
  "pws.openrouter.only": "Использовать только выбранные",
  "pws.openrouter.allowFallbacks": "Разрешить fallback OpenRouter после выбранных провайдеров",
  "pws.openrouter.managementKeyRequired": "Для обнаружения endpoints нужен авторизованный OpenRouter Management Key. Ручная маршрутизация не изменена.",
  "pws.openrouter.keyRequired": "Добавьте API-ключ OpenRouter перед обнаружением провайдеров.",
  "pws.openrouter.loadFailed": "Не удалось загрузить провайдеров этой модели.",
  "pws.openrouter.loaded": "Загружено endpoints провайдеров: {count}.",
  "pws.openrouter.notReturned": "Нет в последнем результате обнаружения",
  "pws.openrouter.saved": "Маршрутизация провайдеров модели сохранена.",
  "pws.openrouter.cache": "Кэш",
};
