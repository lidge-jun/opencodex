...
export const ru: Record<TKey, string> = {
  ...
  "prov.connections": "Подключенные провайдеры",
  "prov.noConnections": "Нет подключенных провайдеров. Используйте «Добавить провайдера» для подключения.",
  ...
  "modal.endpoint.chinaMainland": "Материковый Китай",
  "modal.endpoint.international": "Международный",
  ...
  "modal.catalogModes": "Режимы доступа к провайдерам",
  "modal.accessGroups": "Группы бесплатного доступа",
  "modal.providerDirectory": "Каталог провайдеров",
  "modal.searchCount": "Поиск среди {count} провайдеров",
  "modal.group.all": "Все провайдеры",
  "modal.group.recurring-or-keyless": "Регулярно / без ключа",
  "modal.group.recurring-uncapped": "Без публичного лимита токенов",
  "modal.group.recurring-credit": "Регулярные кредиты",
  "modal.group.signup-credit": "Кредиты за регистрацию",
  "modal.group.existing": "Существующие бесплатные и локальные",
  "modal.paidHint": "Просматривайте платных провайдеров и провайдеров с разовым кредитом за регистрацию.",
  "modal.selectProvider": "Выберите провайдера",
  "modal.selectProviderHint": "Выберите провайдера, чтобы просмотреть настройку и найти модели.",
  "modal.badge.recurring": "Регулярно бесплатно",
  "modal.badge.reference": "Справка",
  "modal.badge.experimental": "Экспериментально",
  "modal.badge.supported": "Поддерживается",
  "modal.verification.official": "Официальная документация",
  "modal.verification.primary": "Первичный источник",
  "modal.verification.unverified": "Не проверено",
  "modal.providerDocs": "Документация провайдера",
  "modal.referenceExplanation": "Эта запись предназначена только для справки. Автоматические вызовы и поиск моделей останутся отключёнными, пока не будет проверен документированный способ подключения.",
  ...
  "modal.discoveredModels": "Найденные модели",
  "modal.discoveryFailed": "Не удалось найти модели для этой настройки.",
  "modal.backToDirectory": "Вернуться к каталогу провайдеров",
  "modal.setupReviewProvider": "Ознакомьтесь с документацией по настройке {label}.",
  "modal.setupReferenceStep": "Используйте эту запись как руководство по настройке, пока не появится поддержка проверенных вызовов.",
  "modal.setupKeylessStep": "Подтвердите конечную точку ниже; API-ключ необязателен.",
  "modal.setupDiscoverStep": "Найдите модели и выберите модель по умолчанию.",
