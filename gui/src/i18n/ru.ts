...
export const ru: Record<TKey, string> = {
  ...
  "codexAuth.namespacesTitle": "Показывать аккаунты Codex в списке моделей",
  "codexAuth.namespacesOnDesc": "Каждая GPT-модель показывается отдельно для каждого добавленного аккаунта Codex. Модель с именем аккаунта использует его квоту для всего потока и никогда не переключается.",
  "codexAuth.namespacesOffDesc": "GPT-модели следуют режиму Пул или Прямой выше. Включите, чтобы выбрать точный аккаунт для потока.",
  "codexAuth.namespacesCompatibilityNote": "Меняется только отображение новых вариантов моделей. Активный аккаунт пула, существующие потоки и сохранённые настройки не меняются.",
  "codexAuth.namespacesSaved": "Выбор аккаунта обновлён. Если список устарел, откройте Codex заново.",
  "codexAuth.namespacesSaveFailed": "Не удалось обновить выбор аккаунта. Предыдущая настройка сохранена.",
