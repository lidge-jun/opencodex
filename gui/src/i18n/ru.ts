...
export const ru: Record<TKey, string> = {
  ...
  "prov.pasteCommandCodePlaceholder": "Вставьте API-ключ Command Code, код авторизации или URL перенаправления",
  "prov.pasteCommandCodeHint": "Вставьте API-ключ Command Code (user_… из ~/.commandcode/auth.json), код авторизации или URL перенаправления из браузера, чтобы добавить его как ещё один аккаунт.",
  "prov.pasteSubmit": "Отправить",
  "prov.pasteSubmitting": "Отправка…",
  "prov.pasteOk": "Код отправлен — завершаем вход…",
    "prov.manualErrorEmpty": "Введите URL перенаправления, код авторизации или API-ключ.",
  "prov.manualErrorTooLarge": "Вставленное содержимое слишком велико.",
  "prov.manualErrorNoLogin": "Вход не выполняется. Снова нажмите «Добавить аккаунт».",
  "prov.manualErrorStale": "Эта вставка относится к предыдущей попытке входа. Снова начните «Добавить аккаунт» и вставьте новую ссылку или код.",
  "prov.manualErrorNoCode": "Код авторизации не найден во вставленном содержимом.",
  "prov.manualErrorMissingState": "В URL перенаправления отсутствует параметр state. Вставьте полный URL этой попытки входа.",
  "prov.manualErrorStateMismatch": "Несовпадение state — вставьте URL перенаправления именно этой попытки входа.",
  "prov.manualErrorInvalid": "Не удалось отправить код. Проверьте вставленное значение и повторите попытку.",
