...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "codexAuth.accountPickerModelsSearchPlaceholder": "Поиск моделей…",
  "codexAuth.accountPickerModelsNoMatch": "Нет моделей, соответствующих поиску.",
  "codexAuth.accountPickerModelsSelectedCount": "Выбрано: {n}",
  "codexAuth.accountPickerModelsSaved": "Выбор моделей сохранён.",
  "codexAuth.accountPickerModelsSaveFailed": "Не удалось сохранить выбор моделей. Попробуйте снова.",
  "codexAuth.accountPickerModelsNoAccounts": "Пока нет доступных селекторов аккаунтов.",
  "codexAuth.accountPickerOnDescCustomized": "Каждый селектор — публичная метка одного сохранённого аккаунта. Выбор закрепляет разговор за этим аккаунтом: без ротации и перехода на другой аккаунт, а активный аккаунт Pool не меняется. Модели общего пула по-прежнему отображаются рядом с выбранными ниже моделями для конкретного аккаунта.",
