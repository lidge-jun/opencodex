...
"common.discard": "Отбросить",
  ...
  "dash.codexDesktopAuthlessHint": "По умолчанию для автономных loopback-подключений (127.0.0.1 или ::1). Доступ к провайдеру по-прежнему требует учётных данных: Pool использует сохранённые аккаунты, Direct — аккаунт вызывающей стороны/основной. Новых прав это не даёт. После изменения перезапустите Codex. Функции, требующие входа в аккаунт, могут быть недоступны.",
