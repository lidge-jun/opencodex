...
export const ru: Record<TKey, string> = {
  ...
  "codexAuth.namespacesTitle": "Выбирать аккаунт в списке моделей",
  "codexAuth.namespacesOnDesc": "Каждая GPT-модель показана отдельно для каждого аккаунта. Выбор Личный или Рабочий строго закрепляет поток за ним.",
  "codexAuth.namespacesOffDesc": "GPT-модели используют режим Пул или Прямой выше.",
  "codexAuth.namespacesCompatibilityNote": "Активный аккаунт пула не меняется. Обычные GPT-пункты скрыты, но существующие потоки и настройки продолжают работать.",
