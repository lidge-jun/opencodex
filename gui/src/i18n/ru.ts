...
export const ru: Record<TKey, string> = {
  ...
  "googleAntigravityPool.title": "Пул аккаунтов Google Antigravity",
  "googleAntigravityPool.enabledDesc": "Переключается на другой аккаунт при ответе HTTP 429 от вышестоящего сервиса или при выведенном наружу ответе HTTP 402. Для новых сессий предпочтительны аккаунты с использованием ниже {threshold}%.",
  "googleAntigravityPool.disabledDesc": "Используется только активный аккаунт Google Antigravity.",
  ...
  "googleAntigravityPool.needTwoAccounts": "Перед включением пула добавьте минимум два OAuth-аккаунта Google.",
  "anthropicPool.threshold": "Порог использования для новых сессий",
  "googleAntigravityPool.threshold": "Порог использования для новых сессий",
  "anthropicPool.thresholdAria": "Порог использования для новых сессий в процентах",
  "googleAntigravityPool.thresholdAria": "Порог использования для новых сессий в процентах",
  "anthropicPool.thresholdHelp": "0 отключает выбор по квоте (только аффинити + активный аккаунт). По умолчанию 80.",
  "googleAntigravityPool.thresholdHelp": "Для новых сессий предпочтительны аккаунты ниже этого порога использования. 0 отключает выбор по квоте. По умолчанию 80.",
  "anthropicPool.thresholdInvalid": "Введите целое число от 0 до 100",
  "googleAntigravityPool.thresholdInvalid": "Введите целое значение в процентах от 0 до 100",
  "anthropicPool.loadFailed": "Не удалось загрузить настройки пула Claude.",
  "googleAntigravityPool.loadFailed": "Не удалось загрузить настройки пула Google Antigravity.",
  "anthropicPool.saveFailed": "Не удалось сохранить настройки пула Claude.",
  "googleAntigravityPool.saveFailed": "Не удалось сохранить настройки пула Google Antigravity.",
  "anthropicPool.on": "Вкл",
  "anthropicPool.off": "Выкл",
  "googleAntigravityPool.on": "Вкл",
  "googleAntigravityPool.off": "Выкл",
