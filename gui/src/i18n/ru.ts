...
export const ru: Record<TKey, string> = {
  ...
  "codexAuth.namespacesTitle": "Модели для конкретных аккаунтов",
  "codexAuth.namespacesOnDesc": "Личные и именованные варианты моделей доступны и строго привязаны к выбранному аккаунту.",
  "codexAuth.namespacesOffDesc": "Добавляет в список моделей Codex явные варианты Личный и Рабочий.",
  "codexAuth.namespacesSaved": "Модели аккаунтов обновлены. Если список устарел, откройте Codex заново.",
  "codexAuth.namespacesSaveFailed": "Не удалось обновить модели аккаунтов. Предыдущая настройка сохранена.",
  "codexAuth.pickerModeTitle": "Расположение списка",
  "codexAuth.pickerModeAdditive": "Обычные + аккаунты",
  "codexAuth.pickerModeReplace": "Только аккаунты",
  "codexAuth.pickerModeAdditiveDesc": "Показывает обычные модели OpenAI вместе с вариантами Личный / Рабочий.",
  "codexAuth.pickerModeReplaceDesc": "Показывает только привязанные к аккаунтам модели OpenAI. Другие провайдеры не меняются.",
  "codexAuth.pickerModeSaved": "Список обновлён. Если модели не изменились, откройте Codex заново.",
  "codexAuth.pickerModeSaveFailed": "Не удалось сохранить настройку. Предыдущий выбор не изменён.",
