...
export const ru: Record<TKey, string> = {
  ...
  "remote.subtitle": "Подключите этот OpenCodex к аккаунту и работайте с терминалами через зашифрованный исходящий relay.",
  "remote.refresh": "Обновить состояние Remote",
  "remote.progressLabel": "Настройка удалённого доступа",
  "remote.stepAccount": "Аккаунт GitHub",
  "remote.stepPassword": "Пароль доступа",
  "remote.stepTunnel": "Подключение ПК",
  "remote.loading": "Загрузка состояния Remote…",
  "remote.loadFailed": "Не удалось загрузить состояние Remote.",
  "remote.signedOutTitle": "Подключить этот компьютер",
  "remote.signedOutBody": "Вход выполняется через сервис OpenCodex. GitHub подтверждает личность, а локальный OCX получает только учётные данные устройства OpenCodex.",
  "remote.signIn": "Продолжить через GitHub",
  "remote.starting": "Запуск…",
  "remote.identityTitle": "Идентификация на центральном сервере",
  "remote.identityBody": "Сервис обрабатывает GitHub OAuth и не отправляет токен GitHub на этот компьютер.",
  "remote.deviceTitle": "Отдельные данные для устройства",
  "remote.deviceBody": "Этот OCX создаёт собственный ключ устройства, который можно отозвать отдельно.",
  "remote.tunnelTitle": "Без входящего порта",
  "remote.tunnelBody": "Agent открывает только одно исходящее зашифрованное соединение, не публикуя домашнюю или офисную сеть.",
  "remote.startFailed": "Не удалось начать вход через GitHub.",
  "remote.cancelFailed": "Не удалось отменить вход устройства.",
  "remote.pendingTitle": "Подтвердите компьютер в браузере",
  "remote.pendingBody": "Завершите вход GitHub на opencodexpages.me и сравните показанный там код с локальным.",
  "remote.codeLabel": "Код устройства",
  "remote.openBrowser": "Открыть страницу входа",
  "remote.waiting": "Ожидание подтверждения в браузере…",
  "remote.connectedAs": "Подключено как",
  "remote.passwordTitle": "Создайте пароль удалённого доступа",
  "remote.passwordBody": "Этот пароль защищает доступ из браузера и отделён от пароля GitHub.",
  "remote.passwordLabel": "Пароль Remote",
  "remote.passwordConfirm": "Подтвердите пароль",
  "remote.passwordLength": "Используйте не менее 10 символов.",
  "remote.passwordMismatch": "Пароли не совпадают.",
  "remote.passwordFailed": "Не удалось сохранить пароль Remote.",
  "remote.savePassword": "Сохранить пароль Remote",
  "remote.accountReadyTitle": "Аккаунт и устройство готовы",
  "remote.accountReadyBody": "GitHub, этот компьютер и пароль удалённого доступа подключены.",
  "remote.connectorNext": "Далее: запустить подписанный коннектор OCX и назначить компьютеру адрес opencodexpages.me.",
  "remote.privateBetaTitle": "Нужен доступ к закрытой бете",
  "remote.privateBetaBody": "Аккаунт подключен, но активация Remote на этом сервере доступна только по приглашению.",
  "remote.domainTitle": "Выберите адрес компьютера",
  "remote.domainBody": "OpenCodex зарезервирует уникальный адрес opencodexpages.me для аккаунта и этого ПК.",
  "remote.deviceNameLabel": "Имя компьютера",
  "remote.deviceNamePlaceholder": "Домашний ПК",
  "remote.domainLabel": "Remote-адрес",
  "remote.domainSuffix": ".opencodexpages.me",
  "remote.domainInvalid": "Используйте строчные буквы, цифры и дефисы.",
  "remote.activateFailed": "Не удалось активировать Remote для этого компьютера.",
  "remote.activating": "Резервирование адреса…",
  "remote.activate": "Включить Remote",
  "remote.provisioningTitle": "Подготовка защищённого адреса",
  "remote.provisioningBody": "Центральный сервис резервирует адрес и готовит доступ к зашифрованному relay.",
  "remote.connectorTitle": "Подключите локальный помощник",
  "remote.connectorBody": "Адрес готов. Запустите подписанный непривилегированный Agent с исходящим зашифрованным relay-соединением.",
  "remote.pairingCode": "Одноразовый код сопряжения",
  "remote.pairingFailed": "Не удалось подготовить сопряжение коннектора.",
  "remote.preparingConnector": "Подготовка…",
  "remote.prepareConnector": "Подготовить коннектор",
  "remote.connectorRequirement": "Коннектор работает от текущего пользователя без root и перенаправления портов. OCX должен содержать подписанный бинарник для этой платформы.",
  "remote.connectingTitle": "Подключение компьютера",
  "remote.connectingBody": "Agent запущен. Ожидаются проверки OCX, Agent, Relay и Gateway.",
  "remote.readyTitle": "Remote в сети",
  "remote.readyBody": "Локальный OpenCodex GUI доступен через защищённый адрес.",
  "remote.openRemote": "Открыть Remote GUI",
  "remote.unavailableTitle": "Remote требует внимания",
  "remote.unavailableBody": "Инстанс остановлен или не удалось завершить подготовку.",
  "remote.disconnect": "Отключить",
  "remote.disconnectConfirm": "Отключить этот компьютер от OpenCodex Remote?",
  "remote.disconnectFailed": "Не удалось отозвать это устройство.",
  "remote.devicesTitle": "Подключённые компьютеры",
  "remote.devicesBody": "Каждый компьютер поддерживает одно исходящее зашифрованное Relay-соединение. Входящие порты и настройка роутера не нужны.",
  "remote.changePasswordTitle": "Изменить пароль шифрования",
  "remote.changePasswordBody": "Нужен старый пароль. Хранилище повторно шифруется локально до отправки нового конверта серверу.",
  "remote.currentPassword": "Текущий пароль",
  "remote.newPassword": "Новый пароль",
  "remote.confirmNewPassword": "Подтвердите новый пароль",
  "remote.changePassword": "Изменить пароль",
