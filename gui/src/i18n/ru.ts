...
"common.discard": "Отбросить",
 ...
 "quota.fiveHourLimit": "5-часовой лимит",
  ...
  "modal.azureEntraSetupGuide": "Настройка Azure OpenAI",
  "modal.azureEntraIntro": "Azure OpenAI поддерживает API-ключ или Microsoft Entra ID через DefaultAzureCredential.",
  "modal.azureEntraResource": "Замените заполнитель ресурса в базовом URL именем ресурса Azure OpenAI.",
  "modal.azureEntraCredential": "Для Microsoft Entra ID оставьте поле API-ключа пустым и настройте DefaultAzureCredential на компьютере, где запущен OpenCodex.",
