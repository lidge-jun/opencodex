...
"common.discard": "Отбросить",
  ...
  "pws.capacity.missingQuota": "Нет актуальных данных о квоте: {count} аккаунт(а/ов).",
  "pws.capacity.unknownPlan": "Неизвестный план: {count} аккаунт(а/ов).",
  "pws.capacity.pausedAccounts": "Приостановлено: {count} аккаунт(а/ов).",
  "pws.capacity.reauthAccounts": "Требуется повторная аутентификация: {count} аккаунт(а/ов).",
  "pws.capacity.staleQuota": "Устаревшие данные о квоте: {count} аккаунт(а/ов).",
...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "codexAuth.managedByCodex": "Управляется Codex",
  "codexAuth.keyringDetailsPending": "OpenCodex не может прочитать данные входа Codex из системного хранилища ключей. Тип аккаунта и квота появятся после первого успешного запроса через этот прокси.",
