...
export const ru: Record<TKey, string> = {
  ...
  "models.fastRows.desc": "Добавляет подходящие селекторы «Model Fast» во внешние меню выбора моделей. Это не меняет параметры глубины рассуждений базовой модели.",
