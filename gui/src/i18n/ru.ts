...
export const ru: Record<TKey, string> = {
  ...
  "cws.field.idHint": "Клиенты запрашивают: {model}",
  "cws.field.idInternalHint": "Внутренний id комбо. Без публичного имени модели клиенты используют combo/<id>.",
  "cws.field.idHintEdit": "При изменении id комбо будет переименовано. Без публичного имени модели клиенты используют combo/<id>.",
  "cws.field.alias": "Публичное имя модели",
  "cws.field.aliasPlaceholder": "deepseek-v4-flash или vendor/model",
  "cws.field.aliasHint": "Необязательно. Переопределяет имя, которое запрашивают клиенты. Имя без префикса, свой префикс вроде vendor/model или пустое поле для combo/<id>.",
  "cws.field.publicModelPreview": "Клиенты запрашивают: {model}",
