...
"common.discard": "Отбросить",
  ...
  "models.orderHint": "Порядок в селекторе моделей: применяется к маршрутизируемым моделям в основном селекторе моделей Codex. Переключатели видимости лишь фильтруют модели и не меняют этот порядок.",
...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "models.pickerOrder.hint": "Сортирует маршрутизируемые модели в главном списке Codex. Это не меняет избранные модели субагентов или маршрутизацию резервного выбора.",
  ...
  "models.pickerOrder.saved": "Порядок выбора моделей сохранён. Применяется к новым сеансам Codex.",
