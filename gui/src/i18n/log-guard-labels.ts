...
const LABELS: Record<Locale, Record<LogGuardLabelKey, string>> = {
  ...
  "pt-BR": {
    compact: "Compactar",
    compactComplete: "Compactação concluída (lógica / espaço recuperado no disco)",
    pagesUnit: "páginas",
    compactPartial: "Compactação parcial (lógica / espaço recuperado no disco)",
    confirmCompact: "Confirmar compactação",
    cancel: "Cancelar",
    inspectionOnly: "Apenas inspeção",
    externalSqliteHome: "Armazenamento SQLite externo",
    inspectionUnavailable: "A inspeção de logs de diagnóstico está indisponível.",
    metricsSkippedLarge: "Métricas de linhas ignoradas: o banco de dados excede {threshold}, e a leitura bloquearia o proxy.",
    protection: "Proteção",
    compat: "Compatibilidade",
    quiet: "Silencioso",
    disable: "Desativar proteção",
    repair: "Reparar proteção",
    applying: "Aplicando proteção…",
    "error.generic": "Não foi possível alterar a proteção de logs do Codex.",
    "error.codex_running": "Feche o Codex antes de alterar a proteção de logs.",
    "error.process_enumeration_failed": "Não foi possível verificar se o Codex está finalizado. A proteção não foi alterada.",
    "error.busy": "O banco de dados de logs do Codex está ocupado. Feche o Codex e tente novamente.",
    "error.unsupported_schema": "Este esquema de logs do Codex não é suportado para proteção.",
    "error.trigger_collision": "Um nome de trigger reservado do Log Guard já está em uso. A proteção não foi alterada.",
    ...
    "error.config_write_failed": "O banco de dados mudou, mas o OpenCodex não conseguiu salvar a configuração de proteção. Corrija o armazenamento de config e execute Reparar.",
  },
};
