...
const LABELS: Record<Locale, Record<LogGuardLabelKey, string>> = {
  ...
  th: {
    compact: "บีบอัด",
    compactComplete: "บีบอัดเสร็จแล้ว (คืนพื้นที่เชิงตรรกะ / บนดิสก์)",
    pagesUnit: "หน้า",
    compactPartial: "บีบอัดบางส่วน (คืนพื้นที่เชิงตรรกะ / บนดิสก์)",
    confirmCompact: "ยืนยันการบีบอัด",
    cancel: "ยกเลิก",
    ...
    quiet: "เงียบ",
    disable: "ปิดการป้องกัน",
    repair: "ซ่อมการป้องกัน",
    applying: "กำลังใช้การป้องกัน…",
    "error.generic": "เปลี่ยนการป้องกันบันทึก Codex ไม่ได้",
    "error.codex_running": "ปิด Codex ก่อนเปลี่ยนการป้องกันบันทึก",
    "error.process_enumeration_failed": "ยืนยันไม่ได้ว่า Codex ปิดแล้ว จึงยังไม่เปลี่ยนการป้องกัน",
    "error.busy": "ฐานข้อมูลบันทึก Codex ไม่ว่าง ปิด Codex แล้วลองใหม่",
    "error.unsupported_schema": "สคีมาบันทึก Codex นี้ไม่รองรับการป้องกัน",
    "error.trigger_collision": "ชื่อทริกเกอร์ Log Guard ที่สงวนไว้ถูกใช้แล้ว จึงยังไม่เปลี่ยนการป้องกัน",
    ...
    "error.config_write_failed": "ฐานข้อมูลเปลี่ยนแล้ว แต่ PaohupByPaoZa บันทึกการตั้งค่าการป้องกันไม่ได้ ซ่อมที่เก็บคอนฟิก แล้วกดซ่อม",
  },
};
