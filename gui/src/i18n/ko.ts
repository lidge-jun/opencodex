...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
  ...
  "codexAuth.managedByCodex": "Codex에서 관리",
  "codexAuth.keyringDetailsPending": "OpenCodex는 Codex의 키체인 로그인을 읽을 수 없습니다. 계정 유형과 할당량은 이 프록시를 통한 첫 번째 요청이 성공한 후 표시됩니다.",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.capacity.incomplete": "불완전한 범위: {excluded}개 계정이 제외되었습니다.",
  "pws.capacity.missingQuota": "현재 할당량 데이터 없음: {count}개 계정.",
  "pws.capacity.unknownPlan": "알 수 없는 요금제: {count}개 계정.",
  "pws.capacity.pausedAccounts": "일시 중지됨: {count}개 계정.",
  "pws.capacity.reauthAccounts": "재인증 필요: {count}개 계정.",
  "pws.capacity.staleQuota": "오래된 할당량 데이터: {count}개 계정.",
