...
export const ko: Record<TKey, string> = {
  ...
  "codexAuth.namespacesTitle": "모델 선택기에 Codex 계정 표시",
  "codexAuth.namespacesOnDesc": "추가한 각 Codex 계정마다 GPT 모델이 하나씩 표시됩니다. 계정 이름이 붙은 모델을 선택하면 전체 스레드에서 해당 계정의 할당량을 사용하며 계정을 전환하지 않습니다.",
  "codexAuth.namespacesOffDesc": "GPT 모델은 위의 풀 또는 직접 동작을 따릅니다. 스레드에 사용할 정확한 계정을 선택하려면 켜세요.",
  "codexAuth.namespacesCompatibilityNote": "새 모델 선택 항목의 표시 방식만 변경합니다. 활성 풀 계정, 기존 스레드 및 저장된 설정은 변경되지 않습니다.",
  "codexAuth.namespacesSaved": "계정 선택이 업데이트되었습니다. 목록이 오래된 경우 Codex를 다시 여세요.",
  "codexAuth.namespacesSaveFailed": "계정 선택을 업데이트하지 못했습니다. 이전 설정은 유지됩니다.",
  "codexAuth.add": "추가",
