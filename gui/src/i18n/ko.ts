...
export const ko: Record<TKey, string> = {
  ...
  "codexAuth.resetCliOnly": "리셋 크레딧 사용은 루프백 대시보드에서만 가능합니다. 원격 대시보드에서는 OpenCodex 호스트에서 로컬 CLI 동의 절차를 사용하세요.",
  "codexAuth.confirmResetTitle": "리셋 크레딧을 사용하시겠습니까?",
  "codexAuth.confirmResetDesc": "현재 사용량 제한이 즉시 초기화됩니다. 확인 후 소유자 동의를 증명하기 위해 OpenCodex 관리자 토큰을 다시 입력합니다. 남은 크레딧: {count}개.",
  ...
  "codexAuth.resetHistoryFull": "리셋 크레딧 작업 이력이 가득 찼습니다. 다시 시도하기 전에 유지관리자에게 용량 확대 또는 승인된 이력 폐기 정책 적용을 요청하세요.",
