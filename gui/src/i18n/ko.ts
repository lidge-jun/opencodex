...
export const ko: Record<TKey, string> = {
  ...
  "memory.title": "메모리 워치독",
  "memory.disabledHint": "워치독이 비활성화되었습니다. 메모리 압력을 관찰하고 경고를 받으려면 활성화하세요.",
  "memory.enable": "활성화",
  "memory.intro": "전체 RAM 대비 프로세스 메모리를 관찰합니다. 기본적으로 경고만 하며, 자동 재시작은 선택 사항이고 supervisor가 감지된 경우에만 실행됩니다.",
  "memory.pressure": "메모리 압력",
  "memory.pressureValue": "{used} / {total} MB ({pct}%)",
  "memory.sourceLabel": "소스:",
  "memory.growthLabel": "증가:",
  "memory.growthValue": "{mb} MB/h",
  "memory.notAvailable": "해당 없음",
  "memory.restartsLabel": "재시작:",
  "memory.privateLabel": "프라이빗:",
  "memory.commitLabel": "시스템 커밋:",
  "memory.commitValue": "{used} / {limit} GB ({pct}%)",
  "memory.responseCacheLabel": "응답 캐시:",
  "memory.responseCacheValue": "{count}개 · {mb} MB",
  "memory.probeLabel": "측정:",
  "memory.probeAgo": "{s}초 전",
  "memory.probeDegraded": "제한됨 ({code})",
  "memory.mbValue": "{mb} MB",
  "memory.supervisorLabel": "supervisor:",
  "memory.supervisorDetected": "감지됨 ({hint})",
  "memory.supervisorNotDetected": "감지되지 않음",
  "memory.recommended": "권장",
  "memory.recSummary": "경고 {warn}% · 위험 {crit}% · 자동 재시작 {auto}",
  "memory.applyRecommended": "권장값 적용",
  "memory.enabledLabel": "활성화됨",
  "memory.warnLabel": "경고 %",
  "memory.criticalLabel": "위험 %",
  "memory.applyThresholds": "임계값 적용",
  "memory.autoRestartLabel": "위험 시 자동 재시작 (선택)",
  "memory.autoRestartNote": "자동 재시작이 시작되면 새 요청 수신을 잠시 중단하고, 진행 중인 응답이 완료되도록 최대 {seconds}초까지 기다립니다. 이 시간 안에 끝나지 않은 스트리밍 응답은 중단될 수 있으며 클라이언트에서 재시도가 필요할 수 있습니다. 이미 완료된 응답에는 영향이 없으며, 재시작 빈도는 제한됩니다.",
  "memory.graceLabel": "재시작 유예 시간 (초)",
  "memory.applyGrace": "유예 시간 적용",
  "memory.graceRangeError": "{min}–{max}초 사이의 값을 입력하세요.",
  "memory.graceCooldownError": "최소 재시작 간격({seconds}초)을 초과할 수 없습니다.",
