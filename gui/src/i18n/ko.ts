...
export const ko: Record<TKey, string> = {
  ...
  "navGroup.resources": "리소스",
  "navGroup.observability": "관측",
  "navGroup.automation": "자동화",
  "navGroup.system": "시스템",
  // sidebar / nav / common
  "nav.dashboard": "대시보드",
  "uptime.day": "일",
  ...
  "common.retry": "재시도",
  "auth.adminTokenTitle": "hubapi 관리자 토큰 (OPENCODEX_ADMIN_AUTH_TOKEN)",
  ...
  "startup.subtitle": "재부팅 후 로컬 프록시 라우팅이 재연결 반복으로 이어지기 전에 Codex가 hubapi에 연결될 수 있는지 확인합니다.",
  ...
  "startup.summary.protected": "재부팅 후에도 hubapi가 자동으로 준비됩니다",
  ...
  "startup.riskDetailCustomLocal": "Codex가 사용자 지정 로컬 게이트웨이를 바라봅니다. hubapi는 해당 게이트웨이의 재시작 수명주기를 관리하거나 검증할 수 없습니다.",
  ...
  "startup.codexRuntime.clampHidden": "hubapi가 Codex {version}을(를) 사용해 일부 reasoning effort 옵션이 숨겨졌습니다.",
  "startup.codexRuntime.clampHiddenWithEfforts": "hubapi가 Codex {version}을(를) 사용해 일부 reasoning effort 옵션이 숨겨졌습니다(제거됨: {efforts}).",
  "startup.codexRuntime.olderBinary": "hubapi가 더 오래된 Codex 바이너리({version})를 사용 중입니다. 더 새 설치를 사용할 수 있습니다.",

  // dashboard
  "dash.subtitle": "로컬 hubapi 프록시와 프로바이더, 그리고 Codex로 라우팅되는 모델의 실시간 상태입니다.",
  ...
  "dash.routes.title": "최근 라우팅 근거",
  "dash.routes.hint": "기록된 요청만 표시하며 구성 미리보기와 분리됩니다.",
  "dash.routes.viewAll": "로그 보기",
  "dash.routes.unavailable": "영구 요청 기록을 사용할 수 없습니다.",
  "dash.routes.empty": "저장된 요청이 아직 없습니다.",
  "dash.routes.unknown": "라우팅 추적 없음",
  "dash.routes.attempts": "{count}회 시도",
  ...
  "dash.codexAutoStart": "Codex 실행 시 hubapi 시작",
  ...
  "dash.shadowCallTooltip": "Codex 앱은 스레드 제목 자동 생성, 커밋 메시지 생성, 스킬 오케스트레이션 같은 내부 작업을 백그라운드로 호출합니다. 이때 쓰는 모델은 클라이언트 버전마다 달라서 hubapi는 {models}를 모두 가로챕니다. 이 설정을 켜면 해당 호출이 선택한 모델로 넘어갑니다.",
  ...
  "dash.maintenanceHint": "Codex 모델 카탈로그를 새로고침하거나 최신 hubapi 릴리스를 설치합니다.",
  ...
  "dash.projectConfigTitle": "프로젝트 Codex 설정이 hubapi를 우회합니다",
  "dash.projectConfigHint": "저장소 로컬 설정이 hubapi 프록시를 덮어씁니다(예: OpenCode Go로 직접 라우팅). 해당 프로젝트에서 ~/.codex/config.toml 프록시를 쓰려면 제거하세요.",
  "dash.checkUpdate": "업데이트 확인",
  "dash.updateTitle": "hubapi 업데이트",
  ...
  "dash.updateStatus.running": "hubapi 업데이트 중입니다.",
  ...
  // providers
  "prov.subtitle": "hubapi가 Codex로 라우팅하는 업스트림 프로바이더를 설정합니다. 계정으로 로그인하거나, 프로바이더를 추가하거나, 원본 설정을 편집하세요.",
  "prov.add": "프로바이더 추가",
  ...
  "oauthTos.anthropicBody": "Claude 구독 OAuth 토큰을 hubapi 같은 타사 프록시에서 직접 재사용하는 방식은 Anthropic이 지원하는 통합이 아니며 접근이 제한될 수 있습니다. Claude 구독을 사용하는 공식 Agent SDK 통합은 별도입니다.",
  "oauthTos.highBody": "hubapi는 {provider}를 타사 OAuth 경로로 연결합니다. 지원되지 않는 사용 방식이면 접근이 제한되거나 정지될 수 있습니다.",
  "oauthTos.elevatedBody": "hubapi는 {provider}를 비공식 OAuth 경로로 연결합니다. 가능하면 공식 클라이언트를 사용하세요. 비정상적이거나 자동화된 트래픽은 남용으로 간주되어 접근이 제한되거나 정지될 수 있습니다.",
  "oauthTos.saferPath": "더 안전한 방법: hubapi에 API 키를 대신 설정하세요.",
  ...
  "models.subtitle": "Codex가 보는 모델을 켜고 끕니다 — 네이티브 GPT passthrough와 라우팅된 모델을 프로바이더별로 묶어 보여줍니다(헤더를 클릭하면 접힘). 숨긴 모델은 카탈로그와 선택기에서 빠지지만 정확한 id로 직접 호출할 수 있습니다. 변경 사항은 다음 Codex 턴에 적용됩니다 — hubapi가 Codex의 5분 모델 캐시를 무효화하므로 재시작이 필요 없습니다.",
  ...
  // subagents
  "sub.subtitle": "Codex의 {cmd} 는 우선순위 상위 5개 모델만 오버라이드로 노출합니다. 여기서 최대 5개를 선택하면 — 네이티브 gpt 또는 라우팅된 모델 — hubapi가 카탈로그 우선순위를 설정해 정확히 이들이 앞에 옵니다. 다른 모델도 정확한 이름으로 호출할 수 있으며, 이 설정은 표시 항목만 제어합니다.",
  "sub.featured": "추천",
  ...
  "logs.tabLogs": "로그",
  "logs.tabDebug": "디버그",
  "logs.subtitle": "로컬 hubapi 프록시를 거친 영구 저장 요청입니다. 최신순.",
  "logs.history.indexed": "영구 저장된 요청 {count}개 색인됨",
  "logs.history.repaired": "기록 색인이 복구됨",
  "logs.history.loadOlder": "이전 요청 불러오기",
  "logs.history.loadError": "이전 요청을 불러오지 못했습니다.",
  ...
  "logs.filter.advanced": "영구 기록 필터",
  "logs.filter.provider": "공급자 ID",
  "logs.filter.model": "최종 모델",
  "logs.filter.requestedModel": "요청 모델",
  "logs.filter.status": "HTTP 상태",
  "logs.filter.protocol": "인바운드 프로토콜",
  "logs.filter.apiKey": "API 키 ID",
  "logs.filter.profile": "라우팅 프로필 ID",
  "logs.filter.fallback": "폴백 사용",
  "logs.filter.fallback.any": "전체",
  "logs.filter.fallback.yes": "예",
  "logs.filter.fallback.no": "아니요",
  "logs.filter.apply": "필터 적용",
  "logs.filter.clearAll": "모두 지우기",
  ...
  "logs.detail.route.loading": "기록된 라우팅 근거 불러오는 중…",
  "logs.detail.route.loadError": "라우팅 근거를 불러오지 못했습니다. 최종 공급자로 경로를 추론하지 않습니다.",
  "logs.detail.route.requested": "요청 모델",
  "logs.detail.route.final": "최종 대상",
  "logs.detail.route.outcome": "결과",
  ...
  "nav.openMenu": "메뉴 열기",
  "nav.closeMenu": "메뉴 닫기",
  "integrations.subtitle": "클라이언트를 hubapi에 연결하고 자격 증명과 설정 복원을 관리합니다.",
  ...
  "integrations.codex.body": "Codex 연결은 프록시 서비스가 관리합니다. hubapi를 시작하면 적용되고 서비스를 중지하면 기본 라우팅으로 복원됩니다.",
  ...
  "integrations.dialog.desktop.changes": "{path}에 hubapi 게이트웨이 프로필이 있으면 먼저 자격 증명 없는 표준 프로필을 선택한 뒤 이전 프로필과 백업을 제거합니다.",
  "integrations.dialog.desktop.breakage": "Claude Desktop은 hubapi를 통한 모델 대신 표준 Claude로 돌아갑니다.",
  "integrations.dialog.desktop.undo": "다시 켜면 저장된 모델 할당으로 hubapi 프로필을 새로 만듭니다.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop은 표준 모드를 가리키지만 이전 hubapi 자격 증명 파일이 남아 있습니다: {paths}.",
  ...
  "integrations.detail.grokAbsent": "설정에 hubapi 블록이 없습니다",
  "integrations.dialog.grok.title": "Grok Build 연동을 해제할까요?",
  "integrations.dialog.grok.changes": "{path}에서 hubapi가 표시해 둔 블록만 제거합니다. 블록 바깥에 직접 쓴 내용은 그대로 둡니다.",
  "integrations.dialog.grok.breakage": "해제하면 Grok Build에서 hubapi 모델 별칭이 사라집니다. xAI 계정으로 쓰던 모델은 그대로입니다.",
  "integrations.dialog.grok.undo": "hubapi가 loopback 주소로 실행 중이면, 다시 켤 때 지금 쓸 수 있는 모델 목록으로 블록을 새로 씁니다.",
  "integrations.dialog.grok.confirm": "해제",
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build은 hubapi가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. loopback 주소를 가리키던 이전 블록은 제거했습니다.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build은 hubapi가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. 제거할 이전 블록은 없었습니다.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build은 hubapi가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. 그 사이 다른 곳에서 설정에 블록이 새로 쓰여, 지금 파일에 있는 블록은 이 요청이 만든 것이 아닙니다.",
  "integrations.native.error.orphanedMarker": "{path}에 hubapi 시작 표시는 있는데 끝 표시가 없습니다. 어디까지가 우리 블록인지 확신할 수 없어 파일을 건드리지 않았습니다.",
  ...
  "integrations.onboarding": "적용하면 먼저 백업을 보관한 뒤 hubapi 제공자 블록 하나만 씁니다. 해제는 그 블록만 제거하며 보관된 스냅샷으로 복원할 수 있습니다.",
  "integrations.empty.title": "설치된 클라이언트가 감지되지 않았습니다",
  "integrations.empty.body": "지원 클라이언트를 설치한 뒤 돌아와 hubapi를 적용하세요.",
  ...
  "integrations.error.conflict": "hubapi가 쓴 뒤 설정이 변경되었습니다. 아무 내용도 제거하지 않았습니다.",
  ...
  "integrations.bulk.body": "hubapi가 소유한 블록만 제거합니다. 각 클라이언트의 변경 전 스냅샷을 보관합니다.",
  ...
  "integrations.semantics.dsh": "hubapi는 $DSH_HOME/settings.yaml의 llm-pi-ai.providers.opencodex만 관리합니다. DSH는 이 provider를 hot reload하며 기본 model과 deepseek-official은 변경하지 않습니다. 현재 loopback 전용이며 실제 credential을 기록하지 않습니다.",
  ...
  "accountPool.strategyDesc": "hubapi가 새 작업/바인딩 없는 작업에 계정을 배정하는 방식입니다.",
  ...
  // api access page
  "api.title": "프록시 API",
  "api.subtitle": "생성한 API 키로 외부 앱에서 hubapi 프록시에 접속합니다. 인증은 {authHeader} 헤더로 하며, 엔드포인트별로 받는 헤더는 아래 표에 있습니다.",
  "api.proxy.title": "통합 프록시 게이트웨이",
  "api.proxy.online": "온라인 — API 요청 수신 중",
  "api.proxy.flowLabel": "프록시 요청 흐름",
  "api.proxy.clients": "클라이언트",
  "api.proxy.providers": "프로바이더",
  "api.proxy.baseUrl": "Base URL",
  "api.proxy.protocols": "인바운드 프로토콜",
  "api.proxy.auth": "인증",
  ...
  "claude.authModeHint": "subscription은 Claude 계정 필요, proxy는 hubapi 프록시만으로 사용 가능",
  ...
  "claude.smallFastModelNativeWarning": "비워 두면 hubapi가 보조 모델 환경 변수를 설정하지 않습니다. Claude Code가 네이티브 Sonnet 모델을 사용할 수 있으며, 네이티브 프로바이더 요금이 발생할 수 있습니다.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.howTitle": "동작 방식",
  "cws.howBody": "Codex에서 콤보의 공개 모델 이름을 요청하세요. 설정하지 않으면 combo/<id>가 기본값입니다. hubapi는 재시도 가능한 업스트림 오류에서만 다음 대상으로 넘깁니다. 사용 가능한 대상이 없으면 전역 기본 프로바이더로 우회하지 않고 요청을 실패 처리합니다.",
  ...
  "grok.subtitle": "hubapi가 Grok 설정에 등록한 모델입니다.",
  "grok.loading": "Grok 상태를 불러오는 중…",
  "grok.loadFail": "Grok 설정을 읽지 못했습니다.",
  "grok.notConfiguredTitle": "Grok Build가 연결되지 않았습니다",
  "grok.notConfiguredHint": "Grok을 설치한 뒤 프록시를 다시 시작하면 hubapi가 관리 블록을 다음 위치에 씁니다:",
  "grok.endpoint": "엔드포인트",
  "grok.colModel": "모델",
