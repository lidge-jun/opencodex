...
export const ko: Record<TKey, string> = {
  ...
  "claude.systemEnvDesc": "켜면 터미널에서 claude를 바로 실행해도 프록시를 거칩니다. 새 터미널부터 적용됩니다.",
  "claude.systemEnvWarning": "⚠️ 이 옵션을 켜면 ~/.zshrc가 수정되고 환경변수가 주입됩니다.\n\n새 터미널 창에서 claude가 프록시를 거쳐 실행됩니다.\n이미 열린 터미널에는 영향 없음 — 활성화 후 새 탭을 여세요.\n\n프록시 재시작 필요 (ocx stop && ocx start).\n\n계속하시겠습니까?",
  "claude.systemEnvRestart": "재시작 필요: ocx stop && ocx start. 새 터미널부터 적용됩니다.",
