...
export const ko: Record<TKey, string> = {
  ...
  "nav.advisor": "어드바이저",
  "advisor.description": "Worker의 작업을 검토하고 조언을 반환하는 독립 전문가 모델입니다. 상담은 OpenCodex가 직접 실행하며, Worker는 합성 advisor 도구를 호출할 수 있고 preflight 정책은 작업당 한 번의 자동 상담을 보장합니다.",
  "advisor.enabled": "어드바이저 사용",
  "advisor.model": "전문가 모델",
  "advisor.modelPlaceholder": "예: gpt-6-astra 또는 anthropic/claude-sonnet-4-6",
  "advisor.effort": "추론 강도",
  "advisor.policy": "정책",
  "advisor.policy.manual": "수동 — Worker가 요청할 때만",
  "advisor.policy.preflight": "Preflight — 작업당 한 번의 자동 상담 보장",
