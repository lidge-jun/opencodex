...
export const ko: Record<TKey, string> = {
  ...
  "models.customFieldCodexAccount": "이 모델에 사용할 Codex 계정",
  "models.customAccountTargetAutomatic": "자동(프로바이더 Pool/Direct)",
  "models.customAccountTargetHint": "선택 사항인 정확한 바인딩입니다. 대상 계정을 사용할 수 없으면 다른 계정으로 전환하지 않고 실패합니다.",
  "models.customAccountTargetPaused": "일시 중지됨",
  "models.customAccountTargetUnavailable": "이전에 선택한 계정(사용할 수 없음)",
  "models.customAccountTargetLoadFailed": "Codex 계정 선택지를 불러오지 못했습니다",
