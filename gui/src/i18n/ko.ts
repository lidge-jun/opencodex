...
"common.discard": "버리기",
  ...
  "compactionRouting.sources": "소스 범위",
  "compactionRouting.sourcesAll": "모든 대화 모델",
  "compactionRouting.sourcesSelected": "선택한 소스만",
  "compactionRouting.sourcesProviders": "전체 제공자",
  "compactionRouting.sourcesModels": "개별 모델",
  "compactionRouting.sourcesSaved": "현재 카탈로그에 없는 저장된 선택자",
  "compactionRouting.sourcesNone": "소스를 하나 이상 선택하거나 모든 대화 모델로 되돌리세요.",
  "compactionRouting.sourcesHint": "압축 요청의 원본 모델이 선택한 모델 또는 provider/*와 일치할 때만 재정의를 적용합니다. 일치하지 않는 요청은 원래 모델을 사용합니다.",
  "compactionRouting.sourcesGridTitle": "원본 모델이 다음 선택 항목과 일치하는 압축 요청을 다시 라우팅합니다:",
