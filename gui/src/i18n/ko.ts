...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "modal.azureEntraSetupGuide": "Azure OpenAI 설정",
  "modal.azureEntraIntro": "Azure OpenAI는 API 키 또는 DefaultAzureCredential을 통한 Microsoft Entra ID를 지원합니다.",
  "modal.azureEntraResource": "Base URL의 리소스 자리 표시자를 Azure OpenAI 리소스 이름으로 바꾸세요.",
  "modal.azureEntraCredential": "Microsoft Entra ID를 사용하려면 API 키를 비워 두고 OpenCodex가 실행되는 컴퓨터에서 DefaultAzureCredential을 구성하세요.",
