...
"common.discard": "버리기",
  ...
  "sub.taskRecovery": "암호화된 V2 작업 복구",
  "sub.taskRecoveryHint": "네이티브 ChatGPT 부모가 라우팅 모델에 작업을 넘길 때 사용합니다. 추가 인증 ChatGPT 요청으로 할당량과 지연이 늘 수 있습니다. 복구된 텍스트는 제한된 메모리 캐시에만 보관되며 실패 시 안전하게 차단됩니다.",
  "sub.taskRecoveryConfirm": "실험적 암호화 작업 복구를 켤까요? 추가 ChatGPT 할당량과 지연이 발생할 수 있고 문서화되지 않은 백엔드 동작에 의존합니다.",
...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "pws.openrouter.title": "모델별 제공자 라우팅",
  "pws.openrouter.hint": "모델마다 사용할 정확한 OpenRouter 엔드포인트를 선택합니다. 검색에는 승인된 OpenRouter Management Key가 필요하며 실제 라우팅은 구성된 API 키를 계속 사용합니다.",
  "pws.openrouter.load": "제공자 불러오기",
  "pws.openrouter.mode": "라우팅 방식",
  "pws.openrouter.inherit": "제공자 기본값 상속",
  "pws.openrouter.order": "선택한 제공자 우선",
  "pws.openrouter.only": "선택한 제공자만 사용",
  "pws.openrouter.allowFallbacks": "선택한 제공자 이후 OpenRouter 폴백 허용",
  "pws.openrouter.managementKeyRequired": "엔드포인트 검색에는 승인된 OpenRouter Management Key가 필요합니다. 기존 수동 라우팅은 유지됩니다.",
  "pws.openrouter.keyRequired": "제공자를 검색하기 전에 OpenRouter API 키를 추가하세요.",
  "pws.openrouter.loadFailed": "이 모델의 제공자를 불러오지 못했습니다.",
  "pws.openrouter.loaded": "제공자 엔드포인트 {count}개를 불러왔습니다.",
  "pws.openrouter.notReturned": "최신 검색에서 반환되지 않음",
  "pws.openrouter.saved": "모델 제공자 라우팅을 저장했습니다.",
  "pws.openrouter.cache": "캐시",
};
