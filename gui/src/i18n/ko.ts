...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "remoteLink.findHome.notice": "연결하면 이 컴퓨터의 OpenCodex가 다시 시작됩니다. 실행 중인 Codex 작업은 먼저 끝나고, 다시 시작되는 동안 최대 1분 정도 새 요청이 실패할 수 있습니다. 그 뒤에도 Codex는 같은 로컬 주소를 그대로 쓰며, 홈이 자신의 제공자와 계정으로 응답합니다.",
  "remoteLink.findHome.empty": "아직 연결된 홈이 없습니다.",
  "remoteLink.joining": "홈에 연결하는 중…",
  "remoteLink.restart.title": "이 컴퓨터는 자식으로 연결하기 위해 재시작합니다.",
  "remoteLink.restart.body": "실행 중인 Codex 작업이 먼저 끝난 뒤 OpenCodex가 자식으로 다시 시작됩니다. 자식이 준비되면 이 페이지가 자동으로 새로 고쳐집니다.",
  "remoteLink.restart.waiting": "자식으로 다시 연결되기를 기다리는 중…",
  "remoteLink.restart.slow": "재시작이 평소보다 오래 걸리고 있습니다. 이 페이지는 계속 확인하다가 자식이 응답하면 자동으로 새로 고쳐집니다. OpenCodex가 멈췄다면 다시 시작하세요.",
  ...
  "remoteLink.error.fingerprint_failed": "SSH 호스트 키를 읽지 못했습니다. 연결 테스트를 다시 실행하세요.",
  "remoteLink.error.forbidden": "이 대시보드 세션으로는 원격 연결을 관리할 수 없습니다. 이 컴퓨터에서 대시보드를 열거나(독립형 설치), 페어링된 Hub 세션을 사용하세요.",
  ...
  "remoteLink.error.link_unavailable": "이 런타임에서는 원격 연결을 사용할 수 없습니다. OpenCodex를 다시 시작한 뒤 다시 시도하세요.",
  "remoteLink.error.listener_unavailable": "이 컴퓨터에서 원격 연결 리스너를 시작하지 못했습니다. 포트 충돌이 있는지 확인한 뒤 다시 시도하세요.",
  "remoteLink.error.probe_failed": "SSH 호스트에 접속하지 못했습니다. SSH 키로 로그인할 수 있는지, ProxyCommand 도우미가 설치되어 있는지 확인하세요.",
  "remoteLink.error.remote_connect_failed": "원격 컴퓨터를 이 홈에 연결하지 못했습니다. 그 컴퓨터의 OpenCodex 서비스를 확인한 뒤 다시 시도하세요.",
  "remoteLink.error.remote_disconnect_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.remote_ocx_missing": "원격 컴퓨터에서 ocx를 찾지 못했습니다. 그 컴퓨터에 OpenCodex를 설치하거나, 비대화형 SSH 세션의 PATH에 ocx가 있는지 확인하세요.",
  "remoteLink.error.remote_ocx_outdated": "원격 컴퓨터의 OpenCodex가 원격 연결을 쓰기에는 오래되었습니다. 그 컴퓨터에서 ocx update를 실행해 2.66.0 이상으로 올린 뒤 다시 시도하세요.",
  "remoteLink.error.remote_ocx_unrecognized": "원격 컴퓨터가 OpenCodex 버전을 알려 주지 않았습니다. 원격 연결에는 macOS 또는 Linux의 OpenCodex 2.66.0 이상이 필요합니다.",
  "remoteLink.error.remote_port_failed": "원격 컴퓨터의 링크 포트를 확인하지 못했습니다. 그 컴퓨터에서 OpenCodex 2.66.0 이상이 실행 중인지 확인한 뒤 다시 시도하세요.",
  "remoteLink.error.tailscale_session_refused": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.version_probe_failed": "SSH로 원격 컴퓨터의 ocx를 실행하지 못했습니다. SSH 접속을 확인한 뒤 다시 시도하세요.",
