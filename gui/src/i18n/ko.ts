...
export const ko: Record<TKey, string> = {
  ...
  // api access page
  "api.title": "API 액세스",
  "api.subtitle": "생성한 API 키로 외부 앱에서 opencodex 프록시에 접근합니다. {authHeader}로 요청을 인증합니다.",
  "api.endpoint": "엔드포인트",
  "api.endpointNote": "OpenAI Responses API 형식과 호환됩니다.",
  "api.tunnelTitle": "Cloudflare 공개 액세스",
  "api.tunnelStatusStopped": "꺼짐",
  "api.tunnelStatusStarting": "시작 중",
  "api.tunnelStatusRunning": "공개됨",
  "api.tunnelStatusStopping": "종료 중",
  ...
  "api.tunnelStarting": "시작 중…",
  "api.tunnelStopping": "종료 중…",
  ...
  "api.tunnelSetupIntro": "Cloudflare 계정을 자동으로 연결하거나 기존 Tunnel의 자격 증명을 사용하세요.",
  "api.tunnelSseNote": "Named Tunnel이 기본 모드이며 종단 간 SSE 스트리밍을 지원합니다.",
  "api.tunnelSetupMethod": "Tunnel 설정 방법",
  "api.tunnelSetupAutomatic": "자동 구성",
  "api.tunnelSetupAutomaticDesc": "제한된 API 토큰으로 Tunnel, DNS 경로, 로컬 커넥터를 한 번에 만듭니다.",
  "api.tunnelSetupExisting": "기존 Tunnel 사용",
  "api.tunnelSetupExistingDesc": "공개 URL과 Tunnel 토큰 또는 cloudflared 설치 명령을 붙여 넣으세요.",
  "api.tunnelAccountId": "Cloudflare 계정 ID",
  "api.tunnelAccountIdPlaceholder": "계정 ID 입력",
  "api.tunnelZoneId": "Cloudflare 영역 ID",
  "api.tunnelZoneIdPlaceholder": "영역 ID 입력",
  "api.tunnelHostname": "공개 호스트 이름",
  "api.tunnelHostnamePlaceholder": "api.example.com",
  "api.tunnelName": "Tunnel 이름(선택 사항)",
  "api.tunnelNamePlaceholder": "opencodex",
  "api.tunnelApiToken": "Cloudflare API 토큰",
  "api.tunnelApiTokenPlaceholder": "제한된 API 토큰 붙여 넣기",
  "api.tunnelApiPermissions": "Account: Cloudflare Tunnel Edit 및 Zone: DNS Edit 권한만 있는 제한된 토큰을 사용하세요.",
  "api.tunnelReplaceExistingConfirm": "새 Tunnel과 DNS 레코드가 생성되며 기존 Cloudflare 리소스는 자동 삭제되지 않으므로 확인 후 직접 정리해야 함을 이해합니다.",
  "api.tunnelExistingPublicUrl": "기존 공개 URL",
  "api.tunnelExistingPublicUrlPlaceholder": "https://api.example.com",
  "api.tunnelTokenOrCommand": "Tunnel 토큰 또는 설치 명령",
  "api.tunnelTokenOrCommandPlaceholder": "Tunnel 토큰 또는 cloudflared 설치 명령 붙여 넣기",
  "api.tunnelTokenSecurity": "Cloudflare API 토큰은 이번 설정 요청에만 사용되며 디스크에 저장되지 않습니다. 로컬에는 Tunnel runner 토큰만 저장됩니다.",
  "api.tunnelRunnerTokenSecurity": "Tunnel runner 토큰은 보호된 로컬 자격 증명 파일에 저장되며 관리 API에서 반환되지 않습니다.",
  "api.tunnelOpenDashboard": "Cloudflare 대시보드 열기",
  "api.tunnelTokenGuide": "API 토큰 가이드",
  "api.tunnelExistingGuide": "Named Tunnel 가이드",
  "api.tunnelConfiguring": "구성 중…",
  "api.tunnelConfigureStart": "구성하고 활성화",
  "api.tunnelSetupFailed": "Named Tunnel을 구성하지 못했습니다. 입력값과 Cloudflare 권한을 확인한 후 다시 시도하세요.",
