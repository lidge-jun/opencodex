...
export const ko: Record<TKey, string> = {
  ...
  "codexAuth.namespacesTitle": "모델 선택기에서 계정 선택",
  "codexAuth.namespacesOnDesc": "각 GPT 모델이 계정별로 표시됩니다. 개인 또는 업무를 선택하면 해당 계정에 고정되며 대체되지 않습니다.",
  "codexAuth.namespacesOffDesc": "GPT 모델은 위의 풀 또는 직접 계정 모드를 사용합니다.",
  "codexAuth.namespacesCompatibilityNote": "활성 풀 계정은 변경되지 않습니다. 일반 GPT 항목은 숨겨지지만 기존 스레드와 저장된 설정은 계속 작동합니다.",
