...
export const ko: Record<TKey, string> = {
  ...
  "prov.openaiDirectDesc": "호출자의 기본 Codex 로그인만 사용하며 계정을 전환하지 않습니다.",
  "prov.openaiMultiDesc": "기본 로그인과 여기서 추가한 Codex 계정을 함께 순환합니다.",
  ...
  "codexAuth.multiOwnerTitle": "Codex 멀티계정 풀",
  "codexAuth.multiOwnerDesc": "기본 Codex 로그인도 이곳에 추가한 계정과 함께 항상 후보로 유지됩니다.",
  "codexAuth.multiMissing": "Multi 프로바이더가 아직 설정되지 않았습니다.",
  "codexAuth.addMultiProvider": "Codex Multi-account 추가",
  "codexAuth.multiDisabled": "Multi 프로바이더가 설정되어 있지만 비활성화되어 있습니다.",
