...
export const ko: Record<TKey, string> = {
  ...
  "modal.endpoint.chinaMainland": "중국 본토",
  "modal.endpoint.international": "국제",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "time.daysAgo": "{n}일 전",
  "modal.catalogModes": "프로바이더 접근 방식",
  "modal.accessGroups": "무료 접근 그룹",
  "modal.providerDirectory": "프로바이더 디렉터리",
  "modal.searchCount": "프로바이더 {count}개 검색",
  "modal.group.all": "모든 프로바이더",
  "modal.group.recurring-or-keyless": "정기 무료 / 키 불필요",
  "modal.group.recurring-uncapped": "공개 토큰 한도 없음",
  "modal.group.recurring-credit": "정기 크레딧",
  "modal.group.signup-credit": "가입 크레딧",
  "modal.group.existing": "기존 무료 및 로컬",
  "modal.paidHint": "유료 프로바이더와 가입 시 일회성 크레딧을 제공하는 프로바이더를 찾아보세요.",
  "modal.selectProvider": "프로바이더 선택",
  "modal.selectProviderHint": "프로바이더를 선택해 설정을 확인하고 모델을 검색하세요.",
  "modal.badge.recurring": "정기 무료",
  "modal.badge.reference": "참고 자료",
  "modal.badge.experimental": "실험적",
  "modal.badge.supported": "지원됨",
  "modal.verification.official": "공식 문서",
  "modal.verification.primary": "1차 출처",
  "modal.verification.unverified": "검증되지 않음",
  "modal.providerDocs": "프로바이더 문서",
  "modal.referenceExplanation": "이 항목은 참고용입니다. 문서화된 전송 방식이 검증될 때까지 자동 호출과 모델 검색은 비활성화됩니다.",
  ...
  "modal.discoveredModels": "검색된 모델",
  "modal.discoveryFailed": "이 설정에서 모델을 찾지 못했습니다.",
  "modal.backToDirectory": "프로바이더 디렉터리로 돌아가기",
  "modal.setupReviewProvider": "{label} 설정 문서를 확인하세요.",
  "modal.setupReferenceStep": "검증된 호출 지원이 제공될 때까지 이 항목을 설정 안내로 사용하세요.",
  "modal.setupKeylessStep": "아래 엔드포인트를 확인하세요. API 키는 선택 사항입니다.",
  "modal.setupDiscoverStep": "모델을 검색하고 기본 모델을 선택하세요.",
