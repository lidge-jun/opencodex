...
export const ko: Record<TKey, string> = {
  ...
  "models.setAll": "전체 적용",
  "models.contextWindowEdit": "컨텍스트 윈도우",
  "models.contextWindowHint": "모델별로 광고된 컨텍스트 윈도우를 덮어씁니다 (토큰). 비워두면 제공자 기본값을 사용합니다.",
  "models.contextWindowModel": "모델",
  "models.contextWindowValue": "윈도우",
  "models.contextWindowLive": "실측",
  ...
  "models.noVisionLabel": "비전 없음",
  "models.noVisionHint": "텍스트 전용 모델을 표시합니다. 비전 사이드카가 이미지를 설명합니다.",
  "models.noVisionApplied": "비전 설정이 저장되었습니다.",
  "models.custom": "직접 입력…",
  ...
  "modal.modelSource": "모델",
  "modal.modelSourceAuto": "프로바이더에서 자동 발견",
  "modal.modelSourceAutoHint": "모델 목록을 프로바이더의 /models 엔드포인트에서 실시간으로 가져옵니다.",
  "modal.modelSourceManual": "모델 수동 설정",
  "modal.manualModelsPlaceholder": "한 줄에 하나의 모델 ID, 예: gpt-5.5",
  "modal.manualModelsRequired": "최소 한 개의 모델 ID를 입력하거나, 자동 발견으로 전환하세요.",
  "modal.manualModelsDefaultHint": "기본 모델이 수동 목록에 없습니다.",
  "modal.manualModelsDefaultError": "기본 모델은 수동 목록에 포함되어야 하며, 비우려면 비워 두세요.",
