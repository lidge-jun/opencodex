...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "pws.openrouter.hint": "모델마다 사용할 정확한 OpenRouter 엔드포인트를 선택합니다. 검색과 라우팅은 구성된 OpenRouter API 키를 사용합니다.",
  ...
  "pws.openrouter.authorizationFailed": "OpenRouter가 엔드포인트 검색에 사용된 구성된 API 키를 거부했습니다. 기존 수동 라우팅은 유지됩니다.",
