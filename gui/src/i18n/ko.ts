...
export const ko: Record<TKey, string> = {
  ...
  "codexAuth.removeCleanupPending": "계정은 제거되었지만 로컬 자격 증명 정리가 아직 보류 중입니다.",
  "codexAuth.removeCleanupRetry": "정리 다시 시도",
  "codexAuth.removeCleanupComplete": "계정 정리가 완료되었습니다.",
  "codexAuth.removeCleanupRetryRefused": "계정이 없음을 확인할 수 없어 정리 재시도를 중단했습니다.",
