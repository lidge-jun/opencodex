...
export const ko: Record<TKey, string> = {
  ...
  "googleAntigravityPool.title": "Google Antigravity 계정 풀",
  "googleAntigravityPool.enabledDesc": "업스트림 HTTP 429 또는 외부로 표출된 HTTP 402에서 다른 계정으로 장애 조치합니다. 새 세션은 사용량이 {threshold}% 미만인 계정을 우선합니다.",
  "googleAntigravityPool.disabledDesc": "활성 Google Antigravity 계정만 사용합니다.",
  ...
  "googleAntigravityPool.needTwoAccounts": "풀을 켜기 전에 Google OAuth 계정을 두 개 이상 추가하세요.",
  "anthropicPool.threshold": "새 세션 사용량 임계값",
  "googleAntigravityPool.threshold": "새 세션 사용량 임계값",
  "anthropicPool.thresholdAria": "새 세션 사용량 임계값(퍼센트)",
  "googleAntigravityPool.thresholdAria": "새 세션 사용량 임계값(퍼센트)",
  "anthropicPool.thresholdHelp": "0은 할당량 기반 선택을 끕니다(어피니티 + 활성 계정만). 기본값 80.",
  "googleAntigravityPool.thresholdHelp": "새 세션은 이 사용량 임계값보다 낮은 계정을 우선합니다. 0은 할당량 기반 선택을 끕니다. 기본값은 80입니다.",
  "anthropicPool.thresholdInvalid": "0에서 100 사이의 정수를 입력하세요",
  "googleAntigravityPool.thresholdInvalid": "0에서 100 사이의 정수 백분율을 입력하세요",
  "anthropicPool.loadFailed": "Claude 풀 설정을 불러오지 못했습니다.",
  "googleAntigravityPool.loadFailed": "Google Antigravity 풀 설정을 불러오지 못했습니다.",
  "anthropicPool.saveFailed": "Claude 풀 설정을 저장하지 못했습니다.",
  "googleAntigravityPool.saveFailed": "Google Antigravity 풀 설정을 저장하지 못했습니다.",
  "anthropicPool.on": "켜짐",
  "anthropicPool.off": "꺼짐",
  "googleAntigravityPool.on": "켜짐",
  "googleAntigravityPool.off": "꺼짐",
