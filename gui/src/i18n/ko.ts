...
export const ko: Record<TKey, string> = {
  ...
  "common.retry": "재시도",
  "remote.title": "리모트",
  "remote.subtitle": "이 컴퓨터의 OpenCodex를 계정에 연결하고 리모트 주소에서 종단간 암호화 터미널을 사용합니다.",
  "remote.refresh": "리모트 상태 새로고침",
  "remote.progressLabel": "리모트 설정 진행 상태",
  "remote.stepAccount": "OpenCodex 계정",
  "remote.stepPassword": "접속 비밀번호",
  "remote.stepTunnel": "컴퓨터 연결",
  "remote.loading": "리모트 상태를 불러오는 중…",
  "remote.loadFailed": "리모트 상태를 불러오지 못했습니다.",
  "remote.signedOutTitle": "이 컴퓨터 연결",
  "remote.signedOutBody": "OpenCodex Remote에 이 컴퓨터를 연결합니다. 이 로컬 OCX에는 폐기 가능한 OpenCodex 장치 자격증명만 전달됩니다.",
  "remote.signIn": "Remote 연결",
  "remote.starting": "시작 중…",
  "remote.identityTitle": "신원 처리는 중앙에서",
  "remote.identityBody": "서버가 GitHub OAuth를 처리하며 GitHub 토큰은 이 컴퓨터로 전달하지 않습니다.",
  "remote.deviceTitle": "컴퓨터별 자격증명",
  "remote.deviceBody": "각 OCX가 자체 장치 키를 만들기 때문에 다른 컴퓨터의 로그인을 유지한 채 이 장치만 해제할 수 있습니다.",
  "remote.tunnelTitle": "인바운드 포트 불필요",
  "remote.tunnelBody": "이 컴퓨터가 중앙으로 WSS 연결 하나만 엽니다. 공유기 포트포워딩이나 인바운드 방화벽 설정은 필요 없습니다.",
  "remote.startFailed": "GitHub 로그인을 시작하지 못했습니다.",
  "remote.cancelFailed": "장치 로그인을 취소하지 못했습니다.",
  "remote.pendingTitle": "브라우저에서 이 컴퓨터를 승인하세요",
  "remote.pendingBody": "opencodexpages.me에서 이 컴퓨터를 승인하고 사이트의 코드가 아래 로컬 코드와 같은지 확인하세요.",
  "remote.codeLabel": "장치 코드",
  "remote.openBrowser": "로그인 페이지 열기",
  "remote.waiting": "브라우저 승인을 기다리는 중…",
  "remote.connectedAs": "연결된 계정",
  "remote.passwordTitle": "리모트 접속 비밀번호 만들기",
  "remote.passwordBody": "GitHub 비밀번호와 별개이며 Argon2id와 AES-GCM으로 리모트 금고를 로컬에서 암호화합니다.",
  "remote.passwordLabel": "리모트 비밀번호",
  "remote.passwordConfirm": "비밀번호 확인",
  "remote.passwordLength": "10자 이상 입력하세요.",
  "remote.passwordMismatch": "비밀번호가 일치하지 않습니다.",
  "remote.passwordFailed": "리모트 비밀번호를 저장하지 못했습니다.",
  "remote.savePassword": "리모트 비밀번호 저장",
  "remote.accountReadyTitle": "계정과 이 컴퓨터가 준비됐습니다",
  "remote.accountReadyBody": "GitHub 신원, 이 컴퓨터, 리모트 접속 비밀번호 연결이 완료됐습니다.",
  "remote.connectorNext": "다음 단계: 서명된 OCX 커넥터를 설치·실행하고 이 컴퓨터에 opencodexpages.me 주소를 할당합니다.",
  "remote.privateBetaTitle": "비공개 베타 승인이 필요합니다",
  "remote.privateBetaBody": "계정 연결은 끝났지만 현재 서버는 초대받은 계정만 리모트를 활성화할 수 있습니다.",
  "remote.domainTitle": "이 컴퓨터의 주소 선택",
  "remote.domainBody": "계정용 리모트 주소 하나를 예약하고 이 컴퓨터를 중복되지 않는 이름으로 등록합니다.",
  "remote.deviceNameLabel": "컴퓨터 이름",
  "remote.deviceNamePlaceholder": "집 PC",
  "remote.domainLabel": "리모트 주소",
  "remote.domainSuffix": ".opencodexpages.me",
  "remote.domainInvalid": "주소에는 영문 소문자, 숫자, 하이픈만 사용할 수 있습니다.",
  "remote.activateFailed": "이 컴퓨터의 리모트를 활성화하지 못했습니다.",
  "remote.activating": "주소 예약 중…",
  "remote.activate": "리모트 활성화",
  "remote.provisioningTitle": "리모트 작업공간 생성 중",
  "remote.provisioningBody": "중앙 서버가 계정 주소를 예약하고 이 컴퓨터를 등록하고 있습니다.",
  "remote.connectorTitle": "로컬 커넥터 시작",
  "remote.connectorBody": "주소 준비가 끝났습니다. 중앙으로 암호화 Relay 연결 하나를 유지하는 비특권 서명 Agent를 시작합니다.",
  "remote.pairingCode": "일회용 페어링 코드",
  "remote.pairingFailed": "커넥터 페어링을 준비하지 못했습니다.",
  "remote.preparingConnector": "준비 중…",
  "remote.prepareConnector": "커넥터 시작",
  "remote.connectorRequirement": "커넥터는 현재 사용자 권한으로 실행되며 root나 포트포워딩이 필요 없습니다. 이 플랫폼용 서명 바이너리는 OCX에 함께 설치되어야 합니다.",
  "remote.connectingTitle": "이 컴퓨터 연결 중",
  "remote.connectingBody": "헬퍼 페어링이 끝났습니다. 로컬 OCX, Agent, Tunnel, Gateway 검사를 기다리고 있습니다.",
  "remote.readyTitle": "리모트 온라인",
  "remote.readyBody": "종단간 암호화 리모트 작업공간에서 이 컴퓨터의 Shell, Codex CLI, Claude Code를 사용할 수 있습니다.",
  "remote.openRemote": "리모트 작업공간 열기",
  "remote.unavailableTitle": "리모트 확인 필요",
  "remote.unavailableBody": "인스턴스가 정지됐거나 프로비저닝에 실패했습니다. 상태를 새로고침하거나 운영자에게 문의하세요.",
  "remote.disconnect": "연결 해제",
  "remote.disconnectConfirm": "이 컴퓨터의 OpenCodex Remote 연결을 해제할까요?",
  "remote.disconnectFailed": "이 장치를 해제하지 못했습니다.",
  "remote.devicesTitle": "연결된 컴퓨터",
  "remote.devicesBody": "각 컴퓨터는 중앙으로 암호화 Relay 연결 하나만 유지합니다. 인바운드 포트나 공유기 설정은 필요 없습니다.",
  "remote.changePasswordTitle": "암호화 비밀번호 변경",
  "remote.changePasswordBody": "이전 비밀번호가 필요합니다. 서버에 새 봉투를 보내기 전에 로컬에서 금고를 다시 암호화합니다.",
  "remote.currentPassword": "현재 비밀번호",
  "remote.newPassword": "새 비밀번호",
  "remote.confirmNewPassword": "새 비밀번호 확인",
  "remote.changePassword": "비밀번호 변경",
  "theme.label": "테마",
  "theme.light": "라이트",
  "theme.dark": "다크",
  "theme.system": "시스템",
