...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.group.weighted": "가중치",
  "cws.group.leastUsed": "최소 사용",
  "cws.group.resetWindow": "재설정 기간",
  ...
  "cws.count.weighted": "가중치",
  "cws.count.leastUsed": "최소 사용",
  "cws.count.resetWindow": "재설정 기간",
  ...
  "cws.strategy.random": "무작위",
  "cws.strategy.leastUsed": "최소 사용",
  "cws.strategy.resetWindow": "재설정 기간",
  "cws.strategy.roundRobin": "라운드로빈",
  "cws.strategy.failoverHint": "대상을 순서대로 시도합니다. 재시도 가능한 오류(한도, 장애, 구독 게이트)면 다음으로 넘어갑니다.",
  "cws.strategy.randomHint": "가중 무작위 선택. 가중치가 높은 대상이 선택될 가능성이 높습니다.",
  "cws.strategy.resetWindowHint": "알려진 할당량 기간이 가장 빨리 재설정되는 대상을 우선합니다. 재설정 시간이 알려지지 않은 대상은 대체 대상으로 남습니다.",
  "cws.strategy.leastUsedHint": "기록된 사용 횟수가 가장 적은 대상을 선택합니다.",
  ...
  "cws.targets.randomHint": "가중치는 요청마다 각 대상이 선택될 확률을 제어합니다.",
  "cws.targets.leastUsedHint": "성공 사용 횟수가 같은 대상은 순서로 동률을 해소합니다.",
  "cws.targets.resetWindowHint": "순서로 동률을 해소하며, 캐시된 할당량 재설정 시간이 없을 때 대체 순서로 사용됩니다.",
