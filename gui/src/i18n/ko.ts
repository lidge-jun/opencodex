...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
  ...
  "codexAuth.autoSwitchResetWindowDesc": "리셋 윈도우: {threshold}%를 소진 기준으로 삼고, 여유가 있는 계정을 설정한 향후 리셋 순서에 따라 새 작업에 배정합니다.",
  "codexAuth.autoSwitchResetWindowOffDesc": "리셋 윈도우의 사용량 소진 기준은 없지만, 설정한 향후 리셋 순서에 따라 계정을 새 작업/바인딩 없는 작업에 배정합니다.",
  ...
  "accountPool.strategyResetWindow": "리셋 윈도우",
  ...
  "accountPool.strategyHintResetWindow": "리셋 윈도우는 설정한 향후 리셋 순서에 따라 계정을 바인딩 없는 작업에 배정하며, 정상적인 바인딩 작업은 어피니티를 유지합니다.",
  "accountPool.resetOrder": "리셋 순서",
  "accountPool.resetOrderHelp": "향후 quota 리셋 시각에 따라 계정을 가까운 순서 또는 먼 순서로 새 작업에 배정할지 선택합니다.",
  "accountPool.resetOrderSoonest": "가까운 리셋부터",
  "accountPool.resetOrderLatest": "먼 리셋부터",
