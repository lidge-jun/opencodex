...
export const ko: Record<TKey, string> = {
  ...
  "modal.notListedSub": "OpenAI 호환 엔드포인트는 모두 추가할 수 있습니다",
  "modal.connectApiKey": "사용자 지정 엔드포인트 추가",
  "modal.badge.api": "API",
  "modal.accountsEmpty": "계정 로그인 프로바이더가 없습니다.",
  "modal.search": "프로바이더 검색…",
  "modal.logInWith": "{label}로 로그인",
  "modal.connectWith": "{label} 연결",
  "modal.signInWithProvider": "{label}로 로그인",
  ...
  "codexAuth.appLoginHint": "Codex/ChatGPT 앱 세션으로 로그인됨(풀 계정 아님).",
  ...
  "codexAuth.autoSwitchDesc": "선택한 할당량이 80%에 도달하면 새 세션이 전환됩니다. Go 및 Free 계정은 30일 사용 기간을 사용합니다.",
  "codexAuth.switched": "다음 세션부터 {email}을(를) 사용합니다",
  "codexAuth.removeConfirm": "{id}을(를) 삭제하시겠습니까?",
  "codexAuth.addTitle": "Codex 계정 추가",
  "codexAuth.addIdLabel": "계정 이름",
  "codexAuth.addIdPlaceholder": "codex-work, codex-alt, team…",
  "codexAuth.addIdHint": "선택 사항. Codex 계정 풀에 ID/슬러그로 저장됩니다(예: ~/.codex/accounts/codex-work). 비워 두면 로그인 후 자동 생성됩니다.",
  "codexAuth.slugDuplicate": "계정 이름 \"{id}\"가 이미 풀에 있습니다.",
  "codexAuth.signInWithChatGpt": "ChatGPT로 로그인",
  "codexAuth.resetCreditsTitleTooltip": "속도 제한 리셋 크레딧 {count}개. 클릭하여 확인하거나 사용하세요.",
  ...
  "modal.oauthDefaultNote": "사용 가능한 모델과 사용량 한도를 이용하려면 계정으로 로그인하세요 — API 키가 필요 없습니다.",
  "modal.oauthConnectTitle": "{label} 연결",
  "modal.oauthConnectBody": "사용 가능한 모델과 사용량 한도를 이용하려면 {label} 계정으로 로그인하세요.",
  "pws.providerGone": "이 프로바이더는 구성에 더 이상 없습니다.",
  "pws.providerGoneAction": "개요로 돌아가기",
  "pws.catalogLoading": "카탈로그 로딩 중…",
  "pws.modelsLoadFailed": "이 프로바이더의 모델을 불러오지 못했습니다.",
  "pws.modelsLoading": "모델 로딩 중…",
  "pws.quotaRefreshFailed": "할당량을 새로고침하지 못했습니다.",
  "modal.invalidApiKey": "잘못된 API 키입니다. 키를 확인한 뒤 다시 시도하세요.",
  "modal.oauthCancelled": "로그인이 취소되었거나 만료되었습니다.",
  "pws.quotaUnavailable": "속도 제한 데이터를 사용할 수 없습니다.",
  "pws.noSearchResults": "검색과 일치하는 프로바이더가 없습니다.",
  "pws.loadingProviders": "프로바이더 로딩 중…",
  "pws.jsonSaveFailed": "구성을 저장하지 못했습니다.",
  "pws.jsonSaved": "구성이 저장되었습니다.",
  "pws.jsonRestoreTitle": "편집기를 열었을 때의 내용으로 초안을 복원합니다(저장되지 않은 편집 취소).",
  "codexAuth.addAccount": "계정 추가",
  "codexAuth.noPoolInline": "아직 풀 계정이 없습니다.",
  "modal.forwardNote": "Codex 로그인을 사용합니다 — API 키가 필요하지 않습니다.",
  "modal.anthropicOauthNote": "Claude 계정으로 로그인하여 사용 가능한 모델과 사용량 한도를 이용하세요.",
  ...
  "modal.duplicateWarn": "{name}이(가) 이미 구성되어 있으며 덮어씁니다.",
  ...
  "pws.notesAria": "프로바이더 메모",
  "pws.notes": "메모",
  "pws.notesPlaceholder": "이 프로바이더에 대한 메모 추가…",
  "pws.apiKeys": "API 키",
  "pws.loggedInTitle": "로그인됨",
  "pws.notLoggedInTitle": "로그인 안 됨",
  "pws.reauth": "재인증",
  "pws.activeAccount": "활성 계정",
  "pws.switchAccount": "이 계정으로 전환",
  "pws.removeAccountAria": "계정 {id} 제거",
  "pws.noApiKey": "API 키가 설정되지 않음",
  "pws.activeKey": "활성 키",
  "pws.switchKey": "이 키로 전환",
  "pws.modelsAvailable": "{count}개 사용 가능",
  "pws.selected": "선택됨",
  "pws.noDefaultModel": "기본 모델이 설정되지 않았습니다.",
  "pws.modelsResolvedRuntime": "모델은 런타임에 이 프로바이더 엔드포인트에서 확인됩니다.",
  "pws.noStaticModels": "정적 모델 목록 없음",
  "pws.noStaticModelsDesc": "사용 가능한 모델은 요청마다 엔드포인트에서 동적으로 확인되므로 여기에 고정 목록을 표시할 수 없습니다.",
  "pws.defaultModelUnset": "기본 모델: 설정되지 않음",
  "pws.defaultModelLabel": "기본 모델",
  "pws.defaultModelNone": "설정되지 않음",
  "pws.usageTotals": "사용량 합계 (30일)",
  "pws.noUsageFor": "{name}에 대한 사용량이 없습니다.",
  "pws.usageSummary": "요청 {requests}건, 토큰 {tokens}.",
  "pws.quotaContext": "할당량 정보",
  "pws.quotaUpdatedFrom": "{when} 업데이트됨 (출처: {source}).",
  "pws.quotaUpdated": "{when} 확인됨.",
  "pws.rateLimits": "속도 제한",
  "pws.noRateLimits": "아직 보고된 속도 제한 창이 없습니다. ChatGPT 또는 Claude에 로그인한 뒤 할당량을 새로고침하면 5시간 / 주간 사용량과 리셋 시각을 볼 수 있습니다.",
  "pws.jsonUnsavedTitle": "저장되지 않은 JSON 변경사항",
  "pws.jsonUnsavedDesc": "프록시 설정에 저장되지 않은 편집이 있습니다. 저장하거나 버리거나 계속 편집하세요.",
  "pws.jsonUnsavedBadge": "미저장",
  "pws.jsonDiscard": "버리기",
  "pws.jsonKeepEditing": "계속 편집",
  "pws.updatesUnavailable": "업데이트를 사용할 수 없습니다.",
  "pws.adapterBaseRequired": "어댑터와 Base URL이 필요합니다.",
  "pws.settingsSaved": "설정이 저장되었습니다.",
  "pws.connectionSettings": "연결 설정",
  "pws.renameUnsupported": "이름 변경은 아직 지원되지 않습니다 — ID를 바꾸려면 삭제 후 다시 추가하세요.",
  "pws.immutableId": "라우팅 및 설정 키에 사용되는 변경 불가 ID입니다.",
  "pws.note": "메모",
  "pws.notePlaceholder": "선택 메모",
  "pws.optionalPlaceholder": "선택",
  "pws.authMode": "인증 모드",
  "pws.authForward": "패스스루",
  "pws.authForwardDesc": "요청은 ChatGPT 로그인을 통해 전달됩니다. 이 프로바이더에는 별도의 API 키가 필요하지 않습니다.",
  "pws.authForwardManageHint": "ChatGPT 계정은 개요 → 계정 로그인에서 관리하세요.",
  "pws.authForwardCredentials": "개요에서 관리",
  "pws.authForwardPoolHint": "이 ChatGPT 계정은 모든 ChatGPT 패스스루 공급자가 공유합니다. 전환은 다음 Codex 세션부터 적용됩니다.",
  "pws.authForwardNextSession": "다음 세션: {email}",
  "pws.authCurrent": "현재: {mode}",
  "pws.authCurrentForward": "{label} ({technical})",
  "pws.apiKeyKeepPlaceholder": "••••••••  (유지하려면 비워 두세요)",
  "pws.configured": "구성됨",
  "pws.missing": "없음",
  "pws.keyReplaceHint": "교체할 때만 새 값을 입력하세요.",
  "pws.keyRequiredHint": "키 인증 프로바이더에 필요합니다.",
  "pws.signInStatus": "로그인 상태",
  "pws.signedInAs": "{email}(으)로 로그인됨.",
  "pws.signedIn": "로그인됨.",
  "pws.notSignedInHint": "로그인되지 않음 — CLI 로그인을 사용하거나 프로바이더에서 계정을 추가하세요.",
  "pws.freeTierDesc": "이 프로바이더는 API 키가 필요하지 않습니다.",
  "pws.saving": "저장 중…",
  "pws.saveSettings": "설정 저장",
  "pws.providerState": "프로바이더 상태",
  "pws.providerDisabledLabel": "프로바이더 비활성",
  "pws.providerEnabledLabel": "프로바이더 활성",
  "pws.disabledRoutingHint": "비활성 프로바이더는 모델 라우팅에서 제외됩니다.",
  "pws.detailAria": "{name} 프로바이더 세부정보",
  "pws.backToAll": "프로바이더 개요",
  "pws.allProviders": "프로바이더 개요",
  "pws.checking": "확인 중…",
  "pws.testConnection": "연결 테스트",
  "pws.testing": "테스트 중…",
  "pws.enableFirst": "먼저 프로바이더를 활성화하세요",
  "pws.probeModels": "이 프로바이더의 모델 조회",
  "pws.removeProvider": "프로바이더 제거",
  "pws.removeProviderAria": "프로바이더 {name} 제거",
  "pws.enabledLabel": "활성",
  "pws.tabsAria": "{name} 탭",
  "pws.connectionFailed": "연결 실패",
  "pws.removeConfirmTitle": "프로바이더 \"{name}\"을(를) 제거할까요?",
  "pws.removeConfirmDesc": "저장된 자격 증명과 설정을 포함해 이 프로바이더를 OpenCodex에서 제거합니다. UI에서 되돌릴 수 없습니다.",
  "pws.removeConfirmUi": "프로바이더 \"{name}\"을(를) 제거할까요? UI에서 되돌릴 수 없습니다.",
  "pws.emptyTitle": "아직 프로바이더 없음",
  "pws.emptySub": "첫 프로바이더를 연결해 시작하세요.",
  "pws.addProvider": "프로바이더 추가",
  "pws.connectFirst": "첫 프로바이더 연결",
  "pws.connectFirstSub": "카탈로그 프로바이더를 고르거나 OpenAI 호환 엔드포인트를 연결하세요.",
  "pws.empty.browseFree": "무료 프로바이더 둘러보기",
  "pws.empty.browseFreeDesc": "키 불필요",
  "pws.empty.connectAccount": "계정 연결",
  "pws.empty.connectAccountDesc": "ChatGPT, Claude, Cursor 등 사용",
  "pws.empty.addEndpoint": "API 엔드포인트 추가",
  "pws.empty.addEndpointDesc": "API 키 또는 OpenAI 호환 엔드포인트 사용",
  "pws.browseProviders": "프로바이더 둘러보기",
  "pws.browseProvidersDesc": "인기 클라우드 프로바이더에 연결",
  "pws.customProviderDesc": "OpenAI 호환 Base URL + 키",
  "pws.notSure": "어디서 시작할지 모르겠나요?",
  "pws.viewDocs": "문서 보기",
  "pws.overviewTitle": "프로바이더 개요",
  "pws.overviewSub": "모든 모델 프로바이더를 한곳에서 관리하세요.",
  "pws.needSetup": "설정 필요",
  "pws.addProviderDesc": "카탈로그 프로바이더 둘러보기",
  "pws.customEndpointDesc": "OpenAI 호환 엔드포인트",
  "pws.editJsonDesc": "원본 프록시 설정을 JSON으로 편집",
  "pws.attentionRequired": "주의 필요",
  "pws.attentionAria": "{name}: {reason}",
  "pws.recentlyUsed": "최근 사용",
  "pws.noUsageRecorded": "사용량이 없습니다.",
  "pws.openProvider": "{name} 열기",
  "pws.requestsCount": "요청 {count}건",
  ...
  "pws.resetAll": "필터 초기화",
  "pws.noResults": "“{search}”에 대한 결과 없음",
  "pws.noMatchFilters": "현재 필터에 맞는 프로바이더가 없습니다.",
  "pws.noProvidersConfigured": "설정된 프로바이더가 없습니다.",
  "pws.groupReady": "준비됨 ({count})",
  "pws.groupNeedsSetup": "설정 필요 ({count})",
  "pws.groupDisabled": "비활성 ({count})",
  "pws.workspaceMainAria": "프로바이더 워크스페이스",
  "pws.providersAria": "프로바이더",
  "pws.providerFiltersAria": "프로바이더 필터",
  "pws.savedName": "{name} 저장됨",
  "pws.updateFailed": "{name} 업데이트 실패",
  "pws.jsonEditorDesc": "라이브 프록시 설정을 JSON으로 편집합니다. 이 보기에서는 비밀이 마스킹됩니다 — 자격 증명은 프로바이더별 설정 또는 API 키 추가를 사용하세요.",
  "pws.workspace": "워크스페이스",
  "pws.freeTier": "무료 티어",
  "modal.overwriteProvider": "프로바이더 덮어쓰기",
  "modal.overwriteWarnDetail": "이 프로바이더의 기존 자격 증명, 모델, 사용자 설정이 교체됩니다.",
  "modal.overwriteConfirm": "기존 프로바이더 “{name}”을(를) 덮어쓸까요?",
  "time.justNow": "방금 업데이트됨",
  ...
  "quota.usedPercentExhausted": "{pct}% 사용 · 한도 도달",
  "quota.limitReached": "한도 도달",
  "quota.resetsIn": "{when} 후 초기화",
  "quota.resetsAt": "{date} {time}에 초기화",
  "quota.resetsToday": "오늘 {time}에 초기화",
  "quota.resetsTomorrow": "내일 {time}에 초기화",
  "quota.resetsRelativeHours": "{n}시간 후 초기화",
  "quota.resetsRelativeMinutes": "{n}분 후 초기화",
  "pws.currentLogin": "현재 로그인",
  "pws.availableAccounts": "사용 가능한 계정",
  "pws.searchModels": "모델 검색…",
  "pws.copyModelId": "모델 ID 복사",
  "pws.modelCopied": "복사됨",
  "pws.noModelsMatch": "검색과 일치하는 모델이 없습니다.",
  "pws.usageLast30d": "최근 30일",
  "pws.metricRequests": "요청",
  "pws.metricTokens": "토큰",
  "pws.usageUnavailable": "이 프로바이더의 사용량 데이터를 사용할 수 없습니다.",
  "pws.quotaSource": "출처",
  "pws.quotaSource.anthropicOauthUsage": "Anthropic OAuth",
  "pws.quotaSource.cursorUsage": "Cursor 사용량",
  "pws.quotaSource.codex": "ChatGPT",
  "pws.quotaSource.unknown": "{source}",
  "pws.lastUpdated": "마지막 업데이트",
  "pws.dailyLimit": "일일 한도",
  "pws.unavailable": "사용 불가",
  "pws.jsonFormat": "서식 지정",
  "pws.jsonRestore": "복원",
  "pws.jsonInvalid": "잘못된 JSON{where}",
  "pws.jsonInvalidAt": " (줄 {line}, 열 {column})",
  "pws.jsonLiveConfig": "라이브 구성",
  "pws.settingsDirty": "저장되지 않은 변경사항",
  "pws.settingsUnsavedBar": "저장되지 않은 변경사항",
  "pws.settingsUnsavedLeave": "저장되지 않은 설정이 있습니다. 버릴까요?",
  "pws.discardSettings": "버리기",
  "pws.advancedSettings": "고급 설정",
