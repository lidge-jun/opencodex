...
export const ko: Record<TKey, string> = {
  ...
  "pws.quickActions": "빠른 작업",
  "pws.qa.manageModels": "모델 관리",
  "pws.qa.manageModelsDesc": "사용 가능한 모델 보기 및 구성",
  "pws.qa.viewUsage": "사용량 보기",
  "pws.qa.viewUsageDesc": "사용량과 한도 확인",
  "pws.qa.apiSettings": "API 설정",
  "pws.qa.apiSettingsDesc": "고급 API 설정 구성",
  ...
  "pws.backToAll": "모든 프로바이더로 돌아가기",
  "pws.allProviders": "모든 프로바이더",
  "pws.checking": "확인 중…",
