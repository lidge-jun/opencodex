...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
  ...
  "codexAuth.autoSwitchResetWindowDesc": "리셋 윈도우: {threshold}%를 소진 기준으로 삼고, 여유가 있는 계정을 최신 리셋 정보 순서로 배정합니다.",
  "codexAuth.autoSwitchResetWindowOffDesc": "리셋 윈도우의 사용량 소진 기준은 없지만, 최신 리셋 순서로 새 작업/바인딩 없는 작업을 배정합니다.",
  ...
  "accountPool.strategyHintResetWindow": "리셋 윈도우는 최신 리셋 시각을 기준으로 바인딩 없는 작업을 배정하며, 정상적인 바인딩 작업은 어피니티를 유지합니다.",
  "accountPool.resetOrder": "리셋 순서",
  "accountPool.resetOrderHelp": "향후 quota 리셋을 가까운 순서 또는 먼 순서로 소진할지 선택합니다.",
