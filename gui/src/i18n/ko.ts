...
export const ko: Record<TKey, string> = {
  ...
  "codexAuth.namespacesTitle": "계정별 모델",
  "codexAuth.namespacesOnDesc": "개인 및 계정 별칭 모델 선택을 사용할 수 있으며 선택한 계정에 엄격하게 고정됩니다.",
  "codexAuth.namespacesOffDesc": "Codex 모델 선택기에 개인 및 업무 계정 선택을 명시적으로 추가합니다.",
  "codexAuth.namespacesSaved": "계정별 모델이 업데이트되었습니다. 목록이 오래된 경우 Codex를 다시 여세요.",
  "codexAuth.namespacesSaveFailed": "계정별 모델을 업데이트하지 못했습니다. 이전 설정은 유지됩니다.",
  "codexAuth.pickerModeTitle": "선택기 배치",
  "codexAuth.pickerModeAdditive": "기본 + 계정",
  "codexAuth.pickerModeReplace": "계정만",
  "codexAuth.pickerModeAdditiveDesc": "기본 OpenAI 모델과 개인 / 업무 계정 선택을 함께 표시합니다.",
  "codexAuth.pickerModeReplaceDesc": "계정이 지정된 OpenAI 선택만 표시합니다. 다른 공급자는 변경되지 않습니다.",
  "codexAuth.pickerModeSaved": "선택기가 업데이트되었습니다. 모델 목록이 오래된 경우 Codex를 다시 여세요.",
  "codexAuth.pickerModeSaveFailed": "선택기 설정을 저장하지 못했습니다. 이전 선택은 유지됩니다.",
  "codexAuth.add": "추가",
