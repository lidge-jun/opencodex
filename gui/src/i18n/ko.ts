...
export const ko: Record<TKey, string> = {
  ...
  "brain.title": "읽기 전용 관측소: 에이전트, 작업, 스킬, 노드, 메모리.",
  "brain.subtitle": "읽기 전용 관측소: 에이전트, 작업, 스킬, 노드, 메모리.",
  "brain.askPlaceholder": "Pao Brain에게 질문...",
  "brain.search": "검색",
  "brain.loading": "불러오는 중...",
  "brain.loadFailed": "관측소 데이터를 불러오지 못했습니다.",
  "brain.tab.agents": "에이전트",
  "brain.tab.tasks": "작업",
  "brain.tab.skills": "스킬",
  "brain.tab.nodes": "노드",
  "brain.tab.memory": "메모리",
  "brain.tab.search": "검색",
  "brain.empty.agents": "등록된 에이전트가 없습니다.",
  "brain.empty.tasks": "대기 중인 작업이 없습니다.",
  "brain.empty.skills": "등록된 스킬이 없습니다.",
  "brain.empty.nodes": "등록된 원격 노드가 없습니다.",
  "brain.empty.memory": "저장된 메모리가 없습니다.",
  "brain.empty.search": "질문을 입력해 로컬을 검색하세요.",
  "brain.empty.searchResults": "로컬 결과가 없습니다.",
  "brain.col.name": "이름",
  "brain.col.provider": "공급자",
  "brain.col.type": "유형",
  "brain.col.health": "상태",
  "brain.col.enabled": "활성",
  "brain.col.title": "제목",
  "brain.col.kind": "종류",
  "brain.col.status": "상태",
  "brain.col.attempts": "시도",
  "brain.col.version": "버전",
  "brain.col.capabilities": "기능",
  "brain.permits.pending": "승인 대기 중인 쓰기 허가",
  "brain.permits.grant": "승인",
  "brain.permits.deny": "거부",
  "brain.tab.policies": "정책",
  "brain.policies.capability": "기능",
  "brain.policies.subject": "대상",
  "brain.policies.effect": "효과",
  "brain.policies.addAllow": "허용",
  "brain.policies.addDeny": "차단",
  "brain.policies.empty": "구성된 정책이 없습니다.",
  "brain.policies.remove": "제거",
  "brain.tab.projects": "프로젝트",
  "brain.projects.name": "프로젝트 이름",
  "brain.projects.path": "루트 경로",
  "brain.projects.add": "추가",
  "brain.projects.scan": "스캔",
  "brain.projects.empty": "등록된 프로젝트가 없습니다.",
  "brain.projects.files": "파일",
  "brain.projects.lastScan": "마지막 스캔",
  "brain.tab.atlas": "아틀라스",
  "brain.tab.universe": "유니버스",
  ...
  "demo.loadScenario": "스마트 팩토리 시나리오 로드",
  "demo.reset": "데모 재설정",
  "demo.noProject": "프로젝트가 없습니다. 시나리오를 로드하세요.",
  "demo.scenarioLoaded": "시나리오가 로드되었습니다.",
  "demo.resetDone": "데모가 재설정되었습니다.",
  "demo.approvalsTitle": "보류 중인 승인",
  "demo.approvalsNone": "보류 중인 승인이 없습니다.",
  "demo.activityTitle": "에이전트 활동",
  "demo.activityNone": "아직 에이전트 활동이 없습니다.",
  "brain.tab.tools": "도구",
  "brain.tab.activity": "활동",
  "brain.tool.risk": "위험",
  "brain.tool.readOnly": "읽기 전용",
  "brain.tool.execute": "실행",
  "brain.tool.empty": "등록된 도구가 없습니다.",
  "brain.activity.empty": "아직 에이전트 활동이 없습니다.",
  "brain.activity.tool": "도구",
  "brain.activity.actor": "행위자",
  "brain.activity.result": "결과",
  "brain.graph.selectProject": "프로젝트",
  "brain.graph.empty": "그래프 데이터가 없습니다. 먼저 프로젝트를 스캔하세요.",
  "brain.graph.nodes": "노드",
  "brain.graph.edges": "연결",
  "brain.graph.capped": "처음 180개 노드를 표시합니다.",
  "brain.graph.aria": "Brain Universe 그래프",
