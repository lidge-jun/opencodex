...
export const ko: Record<TKey, string> = {
  ...
  "api.tunnelModeQuick": "Quick Tunnel · 임시 개발용이며 동시에 진행 중인 요청은 최대 200개이고 SSE를 지원하지 않습니다. 재시작하면 공개 URL이 바뀝니다.",
  "api.tunnelModeNamed": "Named Tunnel · 안정적인 공개 주소와 SSE를 지원해 스트리밍 요청에 적합합니다.",
