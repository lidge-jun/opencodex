...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
  ...
  "codexAuth.accountPickerCustomizeTitle": "계정별 세부 설정",
  "codexAuth.accountPickerCustomizeOffDesc": "이 설정이 생기기 전과 마찬가지로 모든 계정 선택기에 사용 가능한 모든 모델이 표시됩니다.",
  "codexAuth.accountPickerCustomizeOnDesc": "아래에서 각 계정 선택기에 표시할 모델을 선택하세요. 공통 풀 모델은 계속 모든 곳에 표시됩니다.",
  "codexAuth.accountPickerCustomizeUpdated": "계정별 모델 사용자 지정을 업데이트했습니다.",
  "codexAuth.accountPickerCustomizeUpdateFailed": "계정별 모델 사용자 지정을 업데이트하지 못했습니다. 마지막으로 확인된 설정을 표시합니다.",
  "codexAuth.accountPickerModelsCommonNote": "아래 선택과 관계없이 공통 풀 모델은 선택기에 계속 표시됩니다.",
  "codexAuth.accountPickerModelsSearchPlaceholder": "모델 검색…",
  "codexAuth.accountPickerModelsNoMatch": "검색과 일치하는 모델이 없습니다.",
  "codexAuth.accountPickerModelsSelectedCount": "{n}개 선택됨",
  "codexAuth.accountPickerModelsSaved": "모델 선택을 저장했습니다.",
  "codexAuth.accountPickerModelsSaveFailed": "모델 선택을 저장하지 못했습니다. 다시 시도하세요.",
  "codexAuth.accountPickerModelsNoAccounts": "아직 사용할 수 있는 계정 선택기가 없습니다.",
  "codexAuth.accountPickerOnDescCustomized": "각 선택기는 저장된 계정 하나를 나타내는 공개 레이블입니다. 선택하면 해당 대화가 그 계정에 고정되며 Pool 순환이나 대체가 일어나지 않고 활성 Pool 계정도 바뀌지 않습니다. 공통 풀 모델은 아래에서 선택한 계정별 모델과 함께 계속 표시됩니다.",
