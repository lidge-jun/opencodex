...
"common.discard": "버리기",
  ...
  "subagentSurface.selectionBody": "{mode}에서는 ChatGPT 모델이 Grok나 Claude 같은 routed 모델에 넘긴 작업이 ChatGPT 백엔드용으로 암호화된 채 도착하고, routed 모델은 읽지 못합니다. 업스트림에서 고쳐질 때까지 다른 프로바이더로 위임하면 unreadable_encrypted_agent_task로 실패합니다. v1은 프로바이더가 달라도 안정적으로 위임합니다.",
  "subagentSurface.advisoryTitle": "v1이 이제 기본 서브에이전트 서피스입니다",
  "subagentSurface.advisoryBody": "이 설치는 {mode}로 동작하며, ChatGPT에서 routed로 넘어가는 작업은 암호화돼 전달되기 때문에 프로바이더가 다른 위임은 깨집니다. 업스트림에서 고쳐질 때까지는 v1을 권합니다. 직접 바꾸기 전까지 현재 설정은 그대로 유지됩니다.",
