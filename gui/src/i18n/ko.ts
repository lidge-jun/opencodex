...
export const ko: Record<TKey, string> = {
  ...
  "prov.apiProviders": "API 프로바이더",
  "prov.apiProvidersHint": "설정된 API 키 프로바이더만 표시됩니다. +로 더 추가하세요.",
  "prov.noApiProviders": "설정된 API 프로바이더가 없습니다.",
  "prov.addApiProvider": "API 프로바이더 추가",
  "prov.addApiProviderDesc": "API 키를 지원하는 프로바이더를 선택하고 설정을 완료하세요.",
  "prov.apiReady": "준비됨",
  "prov.restartCodex": "Codex 다시 시작",
  "prov.restartCodexConfirm": "Codex가 종료된 후 다시 열립니다. 진행 중인 작업이 중단됩니다. 지금 다시 시작할까요?",
  "prov.restartCodexFailed": "Codex를 다시 시작하지 못했습니다: {error}",
  "prov.addedRestartRequired": "\"{name}\"을(를) 추가하고 모델을 동기화했습니다. 앱을 새로 고치려면 Codex를 다시 시작하세요.",
  "modal.addApiProvider": "API 프로바이더 추가",
  "modal.apiProvidersHint": "API 키 프로바이더를 선택한 다음 키와 엔드포인트 설정을 입력하세요.",
  "prov.noAccountProvidersMatch": "일치하는 계정 Provider가 없습니다.",
  "prov.noConnectedAccounts": "연결된 계정형 provider가 없습니다.",
  "prov.searchAccountProviders": "계정 Provider 검색",
  "prov.connectAccountDesc": "계정 로그인을 지원하는 provider를 검색하세요. 연결한 항목만 목록에 표시됩니다.",
  "prov.connectAccountTitle": "계정 Provider 연결",
  "prov.connectAccount": "연결",
  "prov.accountLoginHint": "연결된 계정형 provider만 표시됩니다. +로 더 찾아 연결하세요.",
  ...
  "prov.loginOk": "{provider} 에 로그인했습니다. 모델을 Codex와 동기화했습니다.",
  "prov.modelSyncFailed": "Provider는 연결되었지만 모델 동기화에 실패했습니다. 다시 시도하려면 {cmd} 를 실행하세요.",
  ...
  "prov.added": "\"{name}\" 을(를) 추가했습니다. 지금 활성화됨 — 모델을 Codex와 동기화했습니다.",
