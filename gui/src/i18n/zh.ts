...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "modal.azureEntraSetupGuide": "Azure OpenAI 设置",
  "modal.azureEntraIntro": "Azure OpenAI 支持 API 密钥，也支持通过 DefaultAzureCredential 使用 Microsoft Entra ID。",
  "modal.azureEntraResource": "将 Base URL 中的资源占位符替换为 Azure OpenAI 资源名称。",
  "modal.azureEntraCredential": "使用 Microsoft Entra ID 时，请将 API 密钥留空，并在运行 OpenCodex 的计算机上配置 DefaultAzureCredential。",
