...
export const zh: Record<TKey, string> = {
  ...
  "codexAuth.namespacesTitle": "在模型选择器中选择账户",
  "codexAuth.namespacesOnDesc": "每个 GPT 模型按账户分别显示。选择个人或工作后，线程会严格绑定该账户且不会回退。",
  "codexAuth.namespacesOffDesc": "GPT 模型使用上方的账户池或直接模式。",
  "codexAuth.namespacesCompatibilityNote": "不会更改当前账户池账户。普通 GPT 条目会隐藏，但现有线程和已保存设置仍然有效。",
