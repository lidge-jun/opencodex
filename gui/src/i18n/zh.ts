...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "sub.taskRecovery": "恢复加密的 V2 任务",
  "sub.taskRecoveryHint": "用于原生 ChatGPT 父代理向路由模型分派工作。会额外发送一次经过身份验证的 ChatGPT 请求，可能消耗额度并增加延迟。恢复文本仅保存在有界内存缓存中；失败时仍会安全关闭。",
  "sub.taskRecoveryConfirm": "启用实验性的加密任务恢复吗？它可能额外消耗 ChatGPT 额度、增加延迟，并依赖未公开的后端行为。",
  ...
  "pws.openrouter.title": "按模型设置提供商路由",
  "pws.openrouter.hint": "为每个模型选择准确的 OpenRouter endpoint。发现列表需要授权的 OpenRouter Management Key；实际路由仍使用已配置的 API 密钥。",
  "pws.openrouter.load": "加载提供商",
  "pws.openrouter.mode": "路由行为",
  "pws.openrouter.inherit": "继承提供商默认值",
  "pws.openrouter.order": "优先使用所选提供商",
  "pws.openrouter.only": "仅使用所选提供商",
  "pws.openrouter.allowFallbacks": "所选提供商之后允许 OpenRouter 回退",
  "pws.openrouter.managementKeyRequired": "发现 endpoint 需要授权的 OpenRouter Management Key。现有手动路由保持不变。",
  "pws.openrouter.keyRequired": "发现提供商前请添加 OpenRouter API 密钥。",
  "pws.openrouter.loadFailed": "无法加载此模型的提供商。",
  "pws.openrouter.loaded": "已加载 {count} 个提供商 endpoint。",
  "pws.openrouter.notReturned": "最新发现中未返回",
  "pws.openrouter.saved": "模型提供商路由已保存。",
  "pws.openrouter.cache": "缓存",
};
