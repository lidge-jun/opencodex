...
export const zh: Record<TKey, string> = {
  ...
  "models.setAll": "全部设置",
  "models.contextWindowEdit": "上下文窗口",
  "models.contextWindowHint": "按模型覆盖广告的上下文窗口（token）。留空 = 使用提供方默认值。",
  "models.contextWindowModel": "模型",
  "models.contextWindowValue": "窗口",
  "models.contextWindowLive": "实测",
  ...
  "models.noVisionLabel": "无视觉",
  "models.noVisionHint": "标记纯文本模型。视觉侧车会为它们描述图片。",
  "models.noVisionApplied": "视觉设置已保存。",
  "models.custom": "自定义…",
  ...
  "modal.modelSource": "模型",
  "modal.modelSourceAuto": "从提供商自动发现",
  "modal.modelSourceAutoHint": "模型列表从提供商的 /models 端点实时获取。",
  "modal.modelSourceManual": "手动设置模型",
  "modal.manualModelsPlaceholder": "每行一个模型 ID，例如 gpt-5.5",
  "modal.manualModelsRequired": "请输入至少一个模型 ID，或切换到自动发现。",
  "modal.manualModelsDefaultHint": "默认模型不在手动列表中。",
  "modal.manualModelsDefaultError": "默认模型必须在手动列表中，或将其清空。",
