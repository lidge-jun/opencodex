...
export const zh: Record<TKey, string> = {
  ...
  "pws.quickActions": "快捷操作",
  "pws.qa.manageModels": "管理模型",
  "pws.qa.manageModelsDesc": "查看并配置可用模型",
  "pws.qa.viewUsage": "查看用量",
  "pws.qa.viewUsageDesc": "检查用量与限额",
  "pws.qa.apiSettings": "API 设置",
  "pws.qa.apiSettingsDesc": "配置高级 API 设置",
  "pws.statsAria": "提供方统计",
  ...
  "pws.backToAll": "返回所有提供方",
  "pws.allProviders": "所有提供方",
  "pws.checking": "检查中…",
