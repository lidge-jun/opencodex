...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
  ...
  "codexAuth.autoSwitchResetWindowDesc": "重置窗口：{threshold}% 是耗尽点；有余量的账号按所选的未来重置顺序分配给新任务。",
  "codexAuth.autoSwitchResetWindowOffDesc": "重置窗口没有用量耗尽点；仍按所选的未来重置顺序将账号分配给新建/未绑定任务。",
  ...
  "accountPool.strategyResetWindow": "重置窗口",
  ...
  "accountPool.strategyHintResetWindow": "重置窗口按所选的新鲜有效未来重置顺序将账号分配给未绑定任务；健康的已绑定任务保持亲和性。",
  "accountPool.resetOrder": "重置顺序",
  "accountPool.resetOrderHelp": "选择按未来配额重置时间将账号从近到远或从远到近分配给新任务。",
  "accountPool.resetOrderSoonest": "最近重置优先",
  "accountPool.resetOrderLatest": "最远重置优先",
