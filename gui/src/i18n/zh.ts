...
export const zh: Record<TKey, string> = {
  ...
  "prov.openaiDirectDesc": "仅使用调用方的主 Codex 登录，不轮换账户。",
  "prov.openaiMultiDesc": "在主登录和已添加的 Codex 账户之间轮换。",
  ...
  "codexAuth.multiOwnerTitle": "Codex 多账户池",
  "codexAuth.multiOwnerDesc": "主 Codex 登录会与此处添加的所有账户一起保持可用。",
  "codexAuth.multiMissing": "尚未配置 Multi 提供方。",
  "codexAuth.addMultiProvider": "添加 Codex Multi-account",
  "codexAuth.multiDisabled": "Multi 提供商已配置但已禁用。",
