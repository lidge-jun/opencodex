...
export const zh: Record<TKey, string> = {
  ...
  "googleAntigravityPool.title": "Google Antigravity 账户池",
  "googleAntigravityPool.enabledDesc": "上游返回 HTTP 429 或对外呈现 HTTP 402 时故障转移。新会话优先选择用量低于 {threshold}% 的账户。",
  "googleAntigravityPool.disabledDesc": "仅使用当前活跃的 Google Antigravity 账户。",
  ...
  "googleAntigravityPool.needTwoAccounts": "启用账户池前请至少添加两个 Google OAuth 账户。",
  "anthropicPool.threshold": "新会话用量阈值",
  "googleAntigravityPool.threshold": "新会话用量阈值",
  "anthropicPool.thresholdAria": "新会话用量阈值（百分比）",
  "googleAntigravityPool.thresholdAria": "新会话用量阈值（百分比）",
  "anthropicPool.thresholdHelp": "0 表示禁用基于配额的选择（仅亲和性 + 活跃账户）。默认 80。",
  "googleAntigravityPool.thresholdHelp": "新会话优先选择用量低于此阈值的账户。0 表示禁用基于配额的选择。默认值为 80。",
  "anthropicPool.thresholdInvalid": "请输入 0 到 100 之间的整数",
  "googleAntigravityPool.thresholdInvalid": "请输入 0 到 100 之间的整数百分比",
  "anthropicPool.loadFailed": "无法加载 Claude 账户池设置。",
  "googleAntigravityPool.loadFailed": "无法加载 Google Antigravity 账户池设置。",
  "anthropicPool.saveFailed": "无法保存 Claude 账户池设置。",
  "googleAntigravityPool.saveFailed": "无法保存 Google Antigravity 账户池设置。",
  "anthropicPool.on": "开",
  "anthropicPool.off": "关",
  "googleAntigravityPool.on": "开",
  "googleAntigravityPool.off": "关",
