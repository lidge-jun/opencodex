...
export const zh: Record<TKey, string> = {
  ...
  "memory.title": "内存看门狗",
  "memory.disabledHint": "看门狗已禁用。启用后可观察内存压力并接收警告。",
  "memory.enable": "启用",
  "memory.intro": "观察进程内存与总内存的比例。默认仅警告；自动重启为可选项，且仅在检测到 supervisor 时触发。",
  "memory.pressure": "内存压力",
  "memory.pressureValue": "{used} / {total} MB ({pct}%)",
  "memory.sourceLabel": "来源：",
  "memory.growthLabel": "增长：",
  "memory.growthValue": "{mb} MB/h",
  "memory.notAvailable": "不可用",
  "memory.restartsLabel": "重启：",
  "memory.privateLabel": "专用内存：",
  "memory.commitLabel": "系统提交：",
  "memory.commitValue": "{used} / {limit} GB（{pct}%）",
  "memory.responseCacheLabel": "响应缓存：",
  "memory.responseCacheValue": "{count} 项 · {mb} MB",
  "memory.probeLabel": "探测：",
  "memory.probeAgo": "{s} 秒前",
  "memory.probeDegraded": "受限（{code}）",
  "memory.mbValue": "{mb} MB",
  "memory.supervisorLabel": "supervisor：",
  "memory.supervisorDetected": "已检测 ({hint})",
  "memory.supervisorNotDetected": "未检测",
  "memory.recommended": "推荐",
  "memory.recSummary": "警告 {warn}% · 严重 {crit}% · 自动重启 {auto}",
  "memory.applyRecommended": "应用推荐值",
  "memory.enabledLabel": "已启用",
  "memory.warnLabel": "警告 %",
  "memory.criticalLabel": "严重 %",
  "memory.applyThresholds": "应用阈值",
  "memory.autoRestartLabel": "严重时自动重启（可选）",
  "memory.autoRestartNote": "自动重启开始时会暂停接收新请求，并为进行中的响应留出最多 {seconds} 秒完成时间。未能在此时间内完成的流式响应可能被中断，客户端可能需要重试。已完成的响应不受影响，重启有频率限制。",
  "memory.graceLabel": "重启宽限时间（秒）",
  "memory.applyGrace": "应用宽限时间",
  "memory.graceRangeError": "请输入 {min}–{max} 秒之间的值。",
  "memory.graceCooldownError": "不能超过最小重启间隔（{seconds} 秒）。",
