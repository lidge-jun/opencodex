...
export const zh: Record<TKey, string> = {
  ...
  "prov.pasteCommandCodePlaceholder": "粘贴 Command Code API 密钥、授权码或重定向 URL",
  "prov.pasteCommandCodeHint": "粘贴 Command Code API 密钥（~/.commandcode/auth.json 中的 user_…）、授权码或浏览器中的重定向 URL，以添加为另一个账号。",
  "prov.pasteSubmit": "提交",
  "prov.pasteSubmitting": "提交中…",
  "prov.pasteOk": "已提交代码 — 正在完成登录…",
    "prov.manualErrorEmpty": "请输入重定向 URL、授权码或 API 密钥。",
  "prov.manualErrorTooLarge": "粘贴内容过大。",
  "prov.manualErrorNoLogin": "没有进行中的登录，请重新开始添加账号。",
  "prov.manualErrorStale": "此粘贴属于上一次登录，请重新开始添加账号并粘贴新的 URL 或授权码。",
  "prov.manualErrorNoCode": "在粘贴内容中未找到授权码。",
  "prov.manualErrorMissingState": "重定向 URL 缺少 state 参数，请粘贴本次登录的完整 URL。",
  "prov.manualErrorStateMismatch": "state 不匹配 — 请粘贴本次登录的重定向 URL。",
  "prov.manualErrorInvalid": "无法提交授权码，请检查粘贴内容后重试。",
