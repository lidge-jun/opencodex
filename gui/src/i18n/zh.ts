...
"common.discard": "丢弃",
  ...
  "models.orderHint": "模型选择器顺序：适用于 Codex 和 Claude 中的已路由模型。可见性开关仅用于筛选，不会改变此顺序。",
  "models.custom": "自定义…",
...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "sub.settings": "设置",
  "models.pickerOrder.title": "模型选择器排序",
  "models.pickerOrder.hint": "控制 Codex 和 Claude 选择器中的已路由模型顺序。",
  "models.pickerOrder.label": "排序已路由模型",
  "models.pickerOrder.default": "默认",
  "models.pickerOrder.alphabetical": "按模型 A–Z",
  "models.pickerOrder.provider": "按提供商",
  "models.pickerOrder.mostUsed": "最常使用",
  "models.pickerOrder.custom": "自定义顺序（配置）",
  "models.pickerOrder.apply": "应用",
  "models.pickerOrder.applying": "正在应用…",
  "models.pickerOrder.saved": "模型选择器排序已保存。将在 Codex 或 Claude 刷新模型列表时应用。",
  "models.pickerOrder.usageFailed": "无法加载模型使用情况",
  "sub.sections": "子代理分区",
