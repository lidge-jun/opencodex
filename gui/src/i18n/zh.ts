...
export const zh: Record<TKey, string> = {
  ...
  "brain.title": "只读观测台：代理、任务、技能、节点、记忆。",
  "brain.subtitle": "只读观测台：代理、任务、技能、节点、记忆。",
  "brain.askPlaceholder": "问问 Pao Brain...",
  "brain.search": "搜索",
  "brain.loading": "加载中...",
  "brain.loadFailed": "无法加载观测台数据。",
  "brain.tab.agents": "代理",
  "brain.tab.tasks": "任务",
  "brain.tab.skills": "技能",
  "brain.tab.nodes": "节点",
  "brain.tab.memory": "记忆",
  "brain.tab.search": "搜索",
  "brain.empty.agents": "尚未注册代理。",
  "brain.empty.tasks": "队列中没有任务。",
  "brain.empty.skills": "尚未注册技能。",
  "brain.empty.nodes": "尚未注册远程节点。",
  "brain.empty.memory": "没有记忆记录。",
  "brain.empty.search": "输入问题以搜索本地宇宙。",
  "brain.empty.searchResults": "没有本地匹配。",
  "brain.col.name": "名称",
  "brain.col.provider": "提供商",
  "brain.col.type": "类型",
  "brain.col.health": "健康",
  "brain.col.enabled": "已启用",
  "brain.col.title": "标题",
  "brain.col.kind": "种类",
  "brain.col.status": "状态",
  "brain.col.attempts": "尝试次数",
  "brain.col.version": "版本",
  "brain.col.capabilities": "能力",
  "brain.permits.pending": "待审批的写入许可",
  "brain.permits.grant": "批准",
  "brain.permits.deny": "拒绝",
  "brain.tab.policies": "策略",
  "brain.policies.capability": "能力",
  "brain.policies.subject": "主体",
  "brain.policies.effect": "效果",
  "brain.policies.addAllow": "允许",
  "brain.policies.addDeny": "拒绝",
  "brain.policies.empty": "尚未配置策略。",
  "brain.policies.remove": "移除",
  "brain.tab.projects": "项目",
  "brain.projects.name": "项目名称",
  "brain.projects.path": "根路径",
  "brain.projects.add": "添加",
  "brain.projects.scan": "扫描",
  "brain.projects.empty": "尚未注册项目。",
  "brain.projects.files": "个文件",
  "brain.projects.lastScan": "上次扫描",
  "brain.tab.atlas": "图谱",
  ...
  "demo.loadScenario": "加载智能工厂场景",
  "demo.reset": "重置演示",
  "demo.noProject": "尚无项目。请先加载场景。",
  "demo.scenarioLoaded": "场景已加载。",
  "demo.resetDone": "演示已重置。",
  "demo.approvalsTitle": "待审批",
  "demo.approvalsNone": "暂无待审批。",
  "demo.activityTitle": "代理活动",
  "demo.activityNone": "暂无代理活动。",
  "brain.tab.tools": "工具",
  "brain.tab.activity": "活动",
  "brain.tool.risk": "风险",
  "brain.tool.readOnly": "只读",
  "brain.tool.execute": "执行",
  "brain.tool.empty": "尚未注册工具。",
  "brain.activity.empty": "暂无代理活动。",
  "brain.activity.tool": "工具",
  "brain.activity.actor": "执行者",
  "brain.activity.result": "结果",
  "brain.graph.selectProject": "项目",
  "brain.graph.empty": "暂无图数据。请先扫描项目。",
  "brain.graph.nodes": "节点",
  "brain.graph.edges": "连接",
  "brain.graph.capped": "显示前180个节点。",
  "brain.graph.aria": "Brain Universe 图",
