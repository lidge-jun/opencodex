...
export const zh: Record<TKey, string> = {
  ...
  // api access page
  "api.title": "API 访问",
  "api.subtitle": "使用生成的 API 密钥从外部应用访问 opencodex 代理。通过 {authHeader} 对请求进行认证。",
  "api.endpoint": "端点",
  "api.endpointNote": "兼容 OpenAI Responses API 格式。",
  "api.tunnelTitle": "Cloudflare 公网访问",
  "api.tunnelStatusStopped": "已关闭",
  "api.tunnelStatusStarting": "正在开启",
  "api.tunnelStatusRunning": "已开启",
  "api.tunnelStatusStopping": "正在关闭",
  ...
  "api.tunnelStarting": "正在开启…",
  "api.tunnelStopping": "正在关闭…",
  ...
  "api.tunnelSetupIntro": "可以自动连接 Cloudflare 账户，也可以使用已有 Tunnel 的凭据。",
  "api.tunnelSseNote": "Named Tunnel 是默认模式，支持端到端 SSE 流式传输。",
  "api.tunnelSetupMethod": "Tunnel 配置方式",
  "api.tunnelSetupAutomatic": "自动配置",
  "api.tunnelSetupAutomaticDesc": "使用最小权限 API Token，一步创建 Tunnel、DNS 路由和本地连接器。",
  "api.tunnelSetupExisting": "使用已有 Tunnel",
  "api.tunnelSetupExistingDesc": "粘贴公网地址和 Tunnel Token，也可以直接粘贴 cloudflared 安装命令。",
  "api.tunnelAccountId": "Cloudflare 账户 ID",
  "api.tunnelAccountIdPlaceholder": "输入账户 ID",
  "api.tunnelZoneId": "Cloudflare 区域 ID",
  "api.tunnelZoneIdPlaceholder": "输入区域 ID",
  "api.tunnelHostname": "公网域名",
  "api.tunnelHostnamePlaceholder": "api.example.com",
  "api.tunnelName": "Tunnel 名称（可选）",
  "api.tunnelNamePlaceholder": "opencodex",
  "api.tunnelApiToken": "Cloudflare API Token",
  "api.tunnelApiTokenPlaceholder": "粘贴最小权限 API Token",
  "api.tunnelApiPermissions": "Token 只需要 Account: Cloudflare Tunnel Edit 和 Zone: DNS Edit 权限。",
  "api.tunnelReplaceExistingConfirm": "我明白这会新建 Tunnel 和 DNS 记录；旧的 Cloudflare 资源不会自动删除，验证新地址后需要手动清理。",
  "api.tunnelExistingPublicUrl": "已有公网地址",
  "api.tunnelExistingPublicUrlPlaceholder": "https://api.example.com",
  "api.tunnelTokenOrCommand": "Tunnel Token 或安装命令",
  "api.tunnelTokenOrCommandPlaceholder": "粘贴 Tunnel Token 或 cloudflared 安装命令",
  "api.tunnelTokenSecurity": "Cloudflare API Token 只用于本次配置请求，绝不会写入磁盘；本地仅保存 Tunnel runner token。",
  "api.tunnelRunnerTokenSecurity": "Tunnel runner token 会保存在受保护的本地凭据文件中，管理 API 绝不会返回它。",
  "api.tunnelOpenDashboard": "打开 Cloudflare 控制台",
  "api.tunnelTokenGuide": "API Token 配置指南",
  "api.tunnelExistingGuide": "Named Tunnel 配置指南",
  "api.tunnelConfiguring": "正在配置…",
  "api.tunnelConfigureStart": "配置并开启",
  "api.tunnelSetupFailed": "无法配置 Named Tunnel。请检查填写内容和 Cloudflare 权限后重试。",
