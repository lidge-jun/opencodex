...
export const zh: Record<TKey, string> = {
  ...
  "models.customFieldCodexAccount": "此模型使用的 Codex 账户",
  "models.customAccountTargetAutomatic": "自动（提供商 Pool/Direct）",
  "models.customAccountTargetHint": "可选的精确绑定。目标不可用时会直接失败，不会切换到其他账户。",
  "models.customAccountTargetPaused": "已暂停",
  "models.customAccountTargetUnavailable": "先前选择的账户（不可用）",
  "models.customAccountTargetLoadFailed": "无法加载 Codex 账户选项",
