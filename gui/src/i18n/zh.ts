...
export const zh: Record<TKey, string> = {
  ...
  "prov.apiProviders": "API 提供方",
  "prov.apiProvidersHint": "仅显示已配置 API 密钥的提供方。使用 + 添加更多。",
  "prov.noApiProviders": "尚未配置 API 提供方。",
  "prov.addApiProvider": "添加 API 提供方",
  "prov.addApiProviderDesc": "选择支持 API 密钥的提供方并完成设置。",
  "prov.apiReady": "就绪",
  "prov.restartCodex": "重启 Codex",
  "prov.restartCodexConfirm": "Codex 将关闭并重新打开，当前任务会被中断。现在重启吗？",
  "prov.restartCodexFailed": "无法重启 Codex：{error}",
  "prov.addedRestartRequired": "已添加 \"{name}\" 并同步模型。请重启 Codex 以刷新应用。",
  "modal.addApiProvider": "添加 API 提供方",
  "modal.apiProvidersHint": "选择 API 密钥提供方，然后输入密钥和端点设置。",
  "prov.noAccountProvidersMatch": "没有匹配的账号 Provider。",
  "prov.noConnectedAccounts": "还没有连接任何账号型 provider。",
  "prov.searchAccountProviders": "搜索账号 Provider",
  "prov.connectAccountDesc": "搜索支持账号登录的 provider。连接后才会显示在列表中。",
  "prov.connectAccountTitle": "连接账号 Provider",
  "prov.connectAccount": "连接",
  "prov.accountLoginHint": "仅显示已连接的账号型 provider。点 + 搜索并连接更多。",
  ...
  "prov.loginOk": "已登录到 {provider}。模型已同步到 Codex。",
  "prov.modelSyncFailed": "Provider 已连接，但模型同步失败。请运行 {cmd} 重试。",
  ...
  "prov.added": "已添加 \"{name}\"。现已生效 — 模型已同步到 Codex。",
