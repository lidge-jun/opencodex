...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "pws.openrouter.hint": "为每个模型选择准确的 OpenRouter endpoint。发现和路由都使用已配置的 OpenRouter API 密钥。",
  ...
  "pws.openrouter.authorizationFailed": "OpenRouter 拒绝了用于发现 endpoint 的已配置 API 密钥。现有手动路由保持不变。",
