...
export const zh: Record<TKey, string> = {
  ...
  "common.retry": "重试",
  "remote.title": "远程",
  "remote.subtitle": "将此 OpenCodex 连接到你的账户，并通过加密的出站 relay 使用终端。",
  "remote.refresh": "刷新远程状态",
  "remote.progressLabel": "远程设置进度",
  "remote.stepAccount": "GitHub 账户",
  "remote.stepPassword": "访问密码",
  "remote.stepTunnel": "电脑连接",
  "remote.loading": "正在加载远程状态…",
  "remote.loadFailed": "无法加载远程状态。",
  "remote.signedOutTitle": "连接此电脑",
  "remote.signedOutBody": "通过 OpenCodex 服务登录。GitHub 仅验证身份，本地 OCX 只会收到 OpenCodex 设备凭据。",
  "remote.signIn": "使用 GitHub 继续",
  "remote.starting": "正在启动…",
  "remote.identityTitle": "身份由中央服务处理",
  "remote.identityBody": "服务处理 GitHub OAuth，不会把 GitHub 令牌发送到此电脑。",
  "remote.deviceTitle": "每台设备独立凭据",
  "remote.deviceBody": "此 OCX 创建独立设备密钥，可单独撤销而不影响其他电脑。",
  "remote.tunnelTitle": "无需开放入站端口",
  "remote.tunnelBody": "Agent 只建立一条加密出站连接，不暴露家庭或办公网络。",
  "remote.startFailed": "无法启动 GitHub 登录。",
  "remote.cancelFailed": "无法取消设备登录。",
  "remote.pendingTitle": "请在浏览器中批准此电脑",
  "remote.pendingBody": "在 opencodexpages.me 完成 GitHub 登录，并确认网站代码与下方代码一致。",
  "remote.codeLabel": "设备代码",
  "remote.openBrowser": "打开登录页面",
  "remote.waiting": "正在等待浏览器批准…",
  "remote.connectedAs": "已连接账户",
  "remote.passwordTitle": "创建远程访问密码",
  "remote.passwordBody": "此密码用于保护远程浏览器访问，与 GitHub 密码分开。",
  "remote.passwordLabel": "远程密码",
  "remote.passwordConfirm": "确认密码",
  "remote.passwordLength": "请至少使用 10 个字符。",
  "remote.passwordMismatch": "两次输入的密码不一致。",
  "remote.passwordFailed": "无法保存远程密码。",
  "remote.savePassword": "保存远程密码",
  "remote.accountReadyTitle": "账户和设备已准备就绪",
  "remote.accountReadyBody": "GitHub 身份、此电脑和远程访问密码已连接。",
  "remote.connectorNext": "下一步：安装并启动签名 OCX 连接器，然后为此电脑分配 opencodexpages.me 地址。",
  "remote.privateBetaTitle": "需要私测资格",
  "remote.privateBetaBody": "账号已连接，但当前服务器仅允许受邀账号启用远程功能。",
  "remote.domainTitle": "选择这台电脑的地址",
  "remote.domainBody": "OpenCodex 会为账户和此电脑保留唯一的 opencodexpages.me 地址。",
  "remote.deviceNameLabel": "电脑名称",
  "remote.deviceNamePlaceholder": "家用电脑",
  "remote.domainLabel": "远程地址",
  "remote.domainSuffix": ".opencodexpages.me",
  "remote.domainInvalid": "地址只能使用小写字母、数字和连字符。",
  "remote.activateFailed": "无法为这台电脑启用远程功能。",
  "remote.activating": "正在保留地址…",
  "remote.activate": "启用远程",
  "remote.provisioningTitle": "正在准备安全地址",
  "remote.provisioningBody": "中央服务正在保留地址并准备加密 relay 访问。",
  "remote.connectorTitle": "连接本地助手",
  "remote.connectorBody": "地址已就绪。启动保持加密出站 relay 连接的已签名非特权 Agent。",
  "remote.pairingCode": "一次性配对码",
  "remote.pairingFailed": "无法准备连接器配对。",
  "remote.preparingConnector": "准备中…",
  "remote.prepareConnector": "准备连接器",
  "remote.connectorRequirement": "连接器以当前用户权限运行，无需 root 或端口转发。OCX 必须包含此平台的已签名二进制文件。",
  "remote.connectingTitle": "正在连接这台电脑",
  "remote.connectingBody": "Agent 已启动，正在等待 OCX、Agent、Relay 和 Gateway 检查通过。",
  "remote.readyTitle": "远程已上线",
  "remote.readyBody": "现在可通过认证地址访问这台电脑的本地 OpenCodex GUI。",
  "remote.openRemote": "打开远程 GUI",
  "remote.unavailableTitle": "远程功能需要处理",
  "remote.unavailableBody": "实例已暂停或配置失败，请刷新状态或联系运营者。",
  "remote.disconnect": "断开连接",
  "remote.disconnectConfirm": "要断开此电脑与 OpenCodex Remote 的连接吗？",
  "remote.disconnectFailed": "无法撤销此设备。",
  "remote.devicesTitle": "已配对的计算机",
  "remote.devicesBody": "每台计算机只维护一条出站加密中继连接，无需入站端口或路由器设置。",
  "remote.changePasswordTitle": "更改加密密码",
  "remote.changePasswordBody": "必须提供旧密码。保险库会先在本地重新加密，再把新信封发送到服务器。",
  "remote.currentPassword": "当前密码",
  "remote.newPassword": "新密码",
  "remote.confirmNewPassword": "确认新密码",
  "remote.changePassword": "更改密码",
  "theme.label": "主题",
  "theme.light": "浅色",
  "theme.dark": "深色",
  "theme.system": "跟随系统",
