...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
  ...
  "codexAuth.autoSwitchResetWindowDesc": "重置窗口：{threshold}% 是耗尽点；有余量的账号按最新重置时间排序。",
  "codexAuth.autoSwitchResetWindowOffDesc": "重置窗口没有用量耗尽点；仍按最新重置顺序分配新建/未绑定任务。",
  ...
  "accountPool.strategyHintResetWindow": "重置窗口按最新的重置时间排列未绑定任务；健康的已绑定任务保持亲和性。",
  "accountPool.resetOrder": "重置顺序",
  "accountPool.resetOrderHelp": "选择从最近到最远或从最远到最近消耗未来的配额重置窗口。",
