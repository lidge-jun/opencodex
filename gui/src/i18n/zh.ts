...
export const zh: Record<TKey, string> = {
  ...
  "modal.endpoint.chinaMainland": "中国大陆",
  "modal.endpoint.international": "国际",
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "time.hoursAgo": "{n} 小时前",
  "time.daysAgo": "{n} 天前",
  "modal.catalogModes": "提供商访问方式",
  "modal.accessGroups": "免费访问分组",
  "modal.providerDirectory": "提供商目录",
  "modal.searchCount": "搜索 {count} 个提供商",
  "modal.group.all": "所有提供商",
  "modal.group.recurring-or-keyless": "定期免费 / 无需密钥",
  "modal.group.recurring-uncapped": "无公开 Token 上限",
  "modal.group.recurring-credit": "定期赠送额度",
  "modal.group.signup-credit": "注册赠送额度",
  "modal.group.existing": "现有免费与本地",
  "modal.paidHint": "浏览付费提供商及提供一次性注册赠送额度的提供商。",
  "modal.selectProvider": "选择提供商",
  "modal.selectProviderHint": "选择提供商以查看设置并发现模型。",
  "modal.badge.recurring": "定期免费",
  "modal.badge.reference": "参考资料",
  "modal.badge.experimental": "实验性",
  "modal.badge.supported": "已支持",
  "modal.verification.official": "官方文档",
  "modal.verification.primary": "第一方来源",
  "modal.verification.unverified": "未验证",
  "modal.providerDocs": "提供商文档",
  "modal.referenceExplanation": "此条目仅供参考。在已记录的传输方式通过验证前，自动调用和模型发现功能将保持禁用。",
  ...
  "modal.discoveredModels": "已发现的模型",
  "modal.discoveryFailed": "无法为此设置发现模型。",
  "modal.backToDirectory": "返回提供商目录",
  "modal.setupReviewProvider": "查看 {label} 的设置文档。",
  "modal.setupReferenceStep": "在经过验证的调用支持可用前，请将此条目用作设置指南。",
  "modal.setupKeylessStep": "确认下方端点；API 密钥为可选项。",
  "modal.setupDiscoverStep": "发现模型并选择默认模型。",
  "modal.noMatch": "无匹配。",
