...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.group.weighted": "加权",
  "cws.group.leastUsed": "最少使用",
  "cws.group.resetWindow": "重设窗口",
  ...
  "cws.count.weighted": "加权",
  "cws.count.leastUsed": "最少使用",
  "cws.count.resetWindow": "重设窗口",
  ...
  "cws.strategy.resetWindow": "重设窗口",
  "cws.strategy.roundRobin": "轮询",
  "cws.strategy.failoverHint": "按顺序尝试目标。若出现可重试错误（限流、故障、订阅门控），则跳到下一个。",
  "cws.strategy.randomHint": "加权随机选择。权重较高的目标更可能被选中。",
  "cws.strategy.resetWindowHint": "优先选择已知配额窗口最早重设的目标。没有已知重设时间的目标仍会作为后备目标。",
  "cws.strategy.leastUsedHint": "选择记录使用次数最少的目标。",
  ...
  "cws.targets.randomHint": "权重控制每个目标在请求中被选中的概率。",
  "cws.targets.leastUsedHint": "成功使用次数相同时，顺序用于打破平局。",
  "cws.targets.resetWindowHint": "顺序用于打破平局，并在没有缓存的配额重设时间时作为后备顺序。",
