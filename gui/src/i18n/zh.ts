...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
  ...
  "codexAuth.accountPickerCustomizeTitle": "按账号自定义模型",
  "codexAuth.accountPickerCustomizeOffDesc": "目前每个账号选择器都会显示所有可用模型，与该设置出现之前一致。",
  "codexAuth.accountPickerCustomizeOnDesc": "在下方选择每个账号选择器下要显示的模型。公共池模型仍会在所有地方显示。",
  "codexAuth.accountPickerCustomizeUpdated": "按账号的模型自定义设置已更新。",
  "codexAuth.accountPickerCustomizeUpdateFailed": "无法更新按账号的模型自定义设置。当前显示的是最后一次确认的设置。",
  "codexAuth.accountPickerModelsCommonNote": "无论下方如何选择，公共池模型都会继续显示在选择器中。",
  "codexAuth.accountPickerModelsSearchPlaceholder": "搜索模型…",
  "codexAuth.accountPickerModelsNoMatch": "没有与搜索匹配的模型。",
  "codexAuth.accountPickerModelsSelectedCount": "已选择 {n} 个",
  "codexAuth.accountPickerModelsSaved": "模型选择已保存。",
  "codexAuth.accountPickerModelsSaveFailed": "无法保存模型选择，请重试。",
  "codexAuth.accountPickerModelsNoAccounts": "暂无可用的账号选择器。",
  "codexAuth.accountPickerOnDescCustomized": "每个选择器都是一个已存储账号的公开标签。选择后，该对话会锁定到对应账号，不会参与 Pool 轮换或故障转移，也不会更改当前的 Pool 账号。公共池模型仍会与下方选择的账号专属模型一起显示。",
