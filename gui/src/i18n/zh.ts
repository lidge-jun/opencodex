...
export const zh: Record<TKey, string> = {
  ...
  "codexAuth.removeCleanupPending": "账户已移除，但本地凭据清理仍待完成。",
  "codexAuth.removeCleanupRetry": "重试清理",
  "codexAuth.removeCleanupComplete": "账户清理已完成。",
  "codexAuth.removeCleanupRetryRefused": "无法确认账户已不存在，因此已停止重试清理。",
