...
export const zh: Record<TKey, string> = {
  ...
  "modal.browseFree": "浏览更多免费提供方",
  "modal.browsePaid": "浏览更多付费提供方",
  "modal.browseBack": "返回热门",
  "modal.connect": "连接",
  "modal.notListedTitle": "列表里没有？",
  "modal.notListedSub": "可添加任意 OpenAI 兼容端点",
  "modal.connectApiKey": "添加自定义端点",
  "modal.badge.api": "API",
  "modal.accountsEmpty": "没有可用的账户登录提供方。",
  "modal.search": "搜索提供方…",
  "modal.logInWith": "使用 {label} 登录",
  "modal.connectWith": "连接 {label}",
  "modal.signInWithProvider": "使用 {label} 登录",
  ...
  "codexAuth.appLoginHint": "通过 Codex / ChatGPT 应用会话登录（非池账户）。",
  ...
  "codexAuth.autoSwitchDesc": "当所选额度达到 80% 时，新会话会切换。Go 和 Free 账户使用 30 天用量窗口。",
  "codexAuth.switched": "下次会话将使用 {email}",
  "codexAuth.removeConfirm": "删除 {id}？",
  "codexAuth.addTitle": "添加 Codex 账号",
  "codexAuth.addIdLabel": "账号名称",
  "codexAuth.addIdPlaceholder": "codex-work, codex-alt, team…",
  "codexAuth.addIdHint": "可选。以 ID/slug 形式保存在 Codex 账号池中（例如 ~/.codex/accounts/codex-work）。留空则登录后自动生成。",
  "codexAuth.slugDuplicate": "账号名称 \"{id}\" 已在池中。",
  "codexAuth.signInWithChatGpt": "使用 ChatGPT 登录",
  "codexAuth.resetCreditsTitleTooltip": "{count} 个速率限制重置额度。点击查看或兑换。",
  ...
  "modal.noMatch": "无匹配。",
  "modal.oauthDefaultNote": "使用账户登录以使用可用模型和使用限额 — 无需 API 密钥。",
  "modal.oauthConnectTitle": "连接 {label}",
  "modal.oauthConnectBody": "使用你的 {label} 账户登录以使用可用模型和使用限额。",
  "pws.providerGone": "此提供方已不在配置中。",
  "pws.providerGoneAction": "返回总览",
  "pws.catalogLoading": "正在加载目录…",
  "pws.modelsLoadFailed": "无法加载此提供方的模型。",
  "pws.modelsLoading": "正在加载模型…",
  "pws.quotaRefreshFailed": "无法刷新额度。",
  "modal.invalidApiKey": "API 密钥无效 — 请检查密钥后重试。",
  "modal.oauthCancelled": "登录已取消或已过期。",
  "pws.quotaUnavailable": "速率限制数据不可用。",
  "pws.noSearchResults": "没有匹配搜索的提供方。",
  "pws.loadingProviders": "正在加载提供方…",
  "pws.jsonSaveFailed": "无法保存配置。",
  "pws.jsonSaved": "配置已保存。",
  "pws.jsonRestoreTitle": "将草稿恢复为打开编辑器时的内容（丢弃未保存的编辑）。",
  "codexAuth.addAccount": "添加账号",
  "codexAuth.noPoolInline": "尚未添加池账号。",
  "modal.forwardNote": "使用你的 Codex 登录 — 无需 API 密钥。",
  "modal.anthropicOauthNote": "使用你的 Claude 账号登录，以使用可用模型和用量限制。",
  ...
  "modal.duplicateWarn": "{name} 已配置，将被覆盖。",
  ...
  "pws.sort.az": "A → Z",
  "pws.sort.za": "Z → A",
  "pws.sort.freePaid": "免费 → 付费",
  "pws.sort.paidFree": "付费 → 免费",
  "pws.status.ready": "就绪",
  "pws.status.needsSetup": "需要配置",
  "pws.status.connected": "已连接",
  "pws.auth.passthrough": "透传",
  "pws.auth.chatgptPassthrough": "ChatGPT 透传",
  "pws.auth.noKey": "无需密钥",
  "pws.rail.selectAria": "选择提供方 {name}，{status}{suffix}",
  "pws.rail.suffixDefault": "，默认",
  "pws.rail.suffixLocal": "，本地",
  "pws.rail.suffixFree": "，免费",
  "pws.defaultTitle": "默认路由提供方",
  "pws.localTitle": "本地运行时",
  "pws.freeTitle": "无需 API 密钥",
  "pws.modelCount": "{count} 个模型",
  "pws.modelCountOne": "1 个模型",
  "pws.connection": "连接",
  "pws.cell.lastChecked": "上次检查",
  "pws.cell.auth": "身份验证",
  "pws.cell.defaultModel": "默认模型",
  "pws.ops.ok": "一切正常",
  "pws.ops.creds": "需要凭据",
  "pws.ops.disabled": "提供方已禁用",
  "pws.editSettings": "编辑设置",
  "pws.editAria": "编辑 {name}",
  "pws.statsAria": "提供方统计",
  "pws.statsTitle": "提供方统计",
  ...
  "pws.notesAria": "提供方备注",
  "pws.notes": "备注",
  "pws.notesPlaceholder": "添加关于此提供方的备注…",
  "pws.apiKeys": "API 密钥",
  "pws.loggedInTitle": "已登录",
  "pws.notLoggedInTitle": "未登录",
  "pws.reauth": "需重新认证",
  "pws.activeAccount": "当前账户",
  "pws.switchAccount": "切换到此账户",
  "pws.removeAccountAria": "移除账户 {id}",
  "pws.noApiKey": "未配置 API 密钥",
  "pws.activeKey": "当前密钥",
  "pws.switchKey": "切换到此密钥",
  "pws.modelsAvailable": "{count} 个可用",
  "pws.selected": "已选",
  "pws.noDefaultModel": "未配置默认模型。",
  "pws.modelsResolvedRuntime": "模型在运行时从此提供方端点解析。",
  "pws.noStaticModels": "无静态模型列表",
  "pws.noStaticModelsDesc": "可用模型会在每次请求时从端点动态发现，因此这里无法显示固定列表。",
  "pws.defaultModelUnset": "默认模型：未设置",
  "pws.defaultModelLabel": "默认模型",
  "pws.defaultModelNone": "未设置",
  "pws.usageTotals": "用量合计（30 天）",
  "pws.noUsageFor": "未记录 {name} 的用量。",
  "pws.usageSummary": "{requests} 次请求，{tokens} 个 token。",
  "pws.quotaContext": "配额上下文",
  "pws.quotaUpdatedFrom": "更新于 {when}，来源 {source}。",
  "pws.quotaUpdated": "检查于 {when}。",
  "pws.rateLimits": "速率限制",
  "pws.noRateLimits": "尚无速率限制窗口。登录 ChatGPT 或 Claude 并刷新配额后，可查看 5 小时 / 每周用量与重置时间。",
  "pws.jsonUnsavedTitle": "未保存的 JSON 更改",
  "pws.jsonUnsavedDesc": "代理配置有未保存的编辑。可保存、丢弃或继续编辑。",
  "pws.jsonUnsavedBadge": "未保存",
  "pws.jsonDiscard": "丢弃",
  "pws.jsonKeepEditing": "继续编辑",
  "pws.updatesUnavailable": "无法更新。",
  "pws.adapterBaseRequired": "适配器和 Base URL 为必填。",
  "pws.settingsSaved": "设置已保存。",
  "pws.connectionSettings": "连接设置",
  "pws.renameUnsupported": "尚不支持重命名 — 如需更改 id，请删除后重新添加。",
  "pws.immutableId": "用于路由和配置键的不可变 id。",
  "pws.note": "备注",
  "pws.notePlaceholder": "可选备注",
  "pws.optionalPlaceholder": "可选",
  "pws.authMode": "认证模式",
  "pws.authForward": "透传",
  "pws.authForwardDesc": "请求通过你的 ChatGPT 登录转发。此提供方不需要单独的 API 密钥。",
  "pws.authForwardManageHint": "请在概览 → 账号登录中管理 ChatGPT 账号。",
  "pws.authForwardCredentials": "在概览中管理",
  "pws.authForwardPoolHint": "这些 ChatGPT 账号由所有 ChatGPT 透传提供商共享。切换将在下一次 Codex 会话生效。",
  "pws.authForwardNextSession": "下次会话：{email}",
  "pws.authCurrent": "当前：{mode}",
  "pws.authCurrentForward": "{label}（{technical}）",
  "pws.apiKeyKeepPlaceholder": "••••••••  （留空以保留）",
  "pws.configured": "已配置",
  "pws.missing": "缺失",
  "pws.keyReplaceHint": "仅在需要替换时输入新值。",
  "pws.keyRequiredHint": "密钥认证提供方必填。",
  "pws.signInStatus": "登录状态",
  "pws.signedInAs": "已以 {email} 登录。",
  "pws.signedIn": "已登录。",
  "pws.notSignedInHint": "未登录 — 请使用 CLI 登录或在提供方中添加账户。",
  "pws.freeTierDesc": "此提供方不需要 API 密钥。",
  "pws.saving": "保存中…",
  "pws.saveSettings": "保存设置",
  "pws.providerState": "提供方状态",
  "pws.providerDisabledLabel": "提供方已禁用",
  "pws.providerEnabledLabel": "提供方已启用",
  "pws.disabledRoutingHint": "已禁用的提供方不参与模型路由。",
  "pws.detailAria": "{name} 提供方详情",
  "pws.backToAll": "提供方概览",
  "pws.allProviders": "提供方概览",
  "pws.checking": "检查中…",
  "pws.testConnection": "测试连接",
  "pws.testing": "测试中…",
  "pws.enableFirst": "请先启用提供方",
  "pws.probeModels": "探测此提供方的模型",
  "pws.removeProvider": "移除提供方",
  "pws.removeProviderAria": "移除提供方 {name}",
  "pws.enabledLabel": "已启用",
  "pws.tabsAria": "{name} 标签页",
  "pws.connectionFailed": "连接失败",
  "pws.removeConfirmTitle": "移除提供方 \"{name}\"？",
  "pws.removeConfirmDesc": "将从 OpenCodex 移除此提供方，包括其已存储的凭据和设置。无法从界面撤销。",
  "pws.removeConfirmUi": "移除提供方 \"{name}\"？无法从界面撤销。",
  "pws.emptyTitle": "还没有提供方",
  "pws.emptySub": "连接你的第一个提供方开始使用。",
  "pws.addProvider": "添加提供方",
  "pws.connectFirst": "连接你的第一个提供方",
  "pws.connectFirstSub": "选择目录中的提供方，或接入任意 OpenAI 兼容端点。",
  "pws.empty.browseFree": "浏览免费提供方",
  "pws.empty.browseFreeDesc": "无需密钥",
  "pws.empty.connectAccount": "连接账户",
  "pws.empty.connectAccountDesc": "使用 ChatGPT、Claude、Cursor 等",
  "pws.empty.addEndpoint": "添加 API 端点",
  "pws.empty.addEndpointDesc": "使用 API 密钥或 OpenAI 兼容端点",
  "pws.browseProviders": "浏览提供方",
  "pws.browseProvidersDesc": "连接常用云提供方",
  "pws.customProviderDesc": "任意 OpenAI 兼容 Base URL + 密钥",
  "pws.notSure": "不确定从哪里开始？",
  "pws.viewDocs": "查看文档",
  "pws.overviewTitle": "提供方概览",
  "pws.overviewSub": "在一处管理所有模型提供方。",
  "pws.needSetup": "需要配置",
  "pws.addProviderDesc": "浏览目录提供方",
  "pws.customEndpointDesc": "任意 OpenAI 兼容端点",
  "pws.editJsonDesc": "以 JSON 编辑原始代理配置",
  "pws.attentionRequired": "需要关注",
  "pws.attentionAria": "{name}：{reason}",
  "pws.recentlyUsed": "最近使用",
  "pws.noUsageRecorded": "暂无用量记录。",
  "pws.openProvider": "打开 {name}",
  "pws.requestsCount": "{count} 次请求",
  ...
  "pws.filterAria": "筛选提供方",
  "pws.filters": "筛选",
  "pws.filterStatus": "状态",
  "pws.pricing": "定价",
  "pws.paid": "付费",
  "pws.sort": "排序",
  "pws.sortProvidersAria": "排序提供方",
  "pws.resetAll": "重置筛选",
  "pws.noResults": "没有与 “{search}” 匹配的结果",
  "pws.noMatchFilters": "没有符合当前筛选条件的提供方。",
  "pws.noProvidersConfigured": "尚未配置提供方。",
  "pws.groupReady": "就绪（{count}）",
  "pws.groupNeedsSetup": "需要配置（{count}）",
  "pws.groupDisabled": "已禁用（{count}）",
  "pws.workspaceMainAria": "提供方工作区",
  "pws.providersAria": "提供方",
  "pws.providerFiltersAria": "提供方筛选",
  "pws.savedName": "已保存 {name}",
  "pws.updateFailed": "更新 {name} 失败",
  "pws.jsonEditorDesc": "以 JSON 编辑实时代理配置。此视图中密钥已遮罩 — 凭据请优先使用各提供方设置或添加 API 密钥。",
  "pws.workspace": "工作区",
  "pws.freeTier": "免费层",
  "modal.overwriteProvider": "覆盖提供方",
  "modal.overwriteWarnDetail": "该提供方的现有凭据、模型和自定义设置将被替换。",
  "modal.overwriteConfirm": "确定覆盖已有提供方“{name}”吗？",
  "time.justNow": "刚刚更新",
  "time.notChecked": "未检查",
  ...
  "quota.usedPercent": "已使用 {pct}%",
  "quota.usedPercentExhausted": "已使用 {pct}% · 已达上限",
  "quota.limitReached": "已达上限",
  "quota.resetsIn": "{when}后重置",
  "quota.resetsAt": "于 {date} {time} 重置",
  ...
  "pws.currentLogin": "当前登录",
  "pws.availableAccounts": "可用账户",
  "pws.searchModels": "搜索模型…",
  "pws.copyModelId": "复制模型 ID",
  "pws.modelCopied": "已复制",
  "pws.noModelsMatch": "没有匹配的模型。",
  "pws.usageLast30d": "最近 30 天",
  "pws.metricRequests": "请求",
  "pws.metricTokens": "令牌",
  "pws.usageUnavailable": "此提供方没有可用的用量数据。",
  "pws.quotaSource": "来源",
  "pws.quotaSource.anthropicOauthUsage": "Anthropic OAuth",
  "pws.quotaSource.cursorUsage": "Cursor 用量",
  "pws.quotaSource.codex": "ChatGPT",
  "pws.quotaSource.unknown": "{source}",
  "pws.lastUpdated": "最后更新",
  "pws.dailyLimit": "每日限额",
  "pws.unavailable": "不可用",
  "pws.jsonFormat": "格式化",
  "pws.jsonRestore": "恢复",
  "pws.jsonInvalid": "无效 JSON{where}",
  "pws.jsonInvalidAt": "（第 {line} 行，第 {column} 列）",
  "pws.jsonLiveConfig": "实时配置",
  "pws.settingsDirty": "未保存的更改",
  "pws.settingsUnsavedBar": "未保存的更改",
  "pws.settingsUnsavedLeave": "设置有未保存更改。要丢弃吗？",
  "pws.discardSettings": "丢弃",
  "pws.advancedSettings": "高级设置",
  "pws.providerId": "提供方 ID",
  "pws.filterType": "类型",
  "pws.type.cloud": "云",
  "pws.type.local": "本地",
