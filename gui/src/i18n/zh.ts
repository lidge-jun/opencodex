...
export const zh: Record<TKey, string> = {
  ...
  "codexAuth.namespacesTitle": "账户专属模型",
  "codexAuth.namespacesOnDesc": "个人和账户别名模型选项已启用，并严格绑定到所选账户。",
  "codexAuth.namespacesOffDesc": "在 Codex 模型选择器中添加明确的个人和工作账户选项。",
  "codexAuth.namespacesSaved": "账户专属模型已更新。如果列表仍旧，请重新打开 Codex。",
  "codexAuth.namespacesSaveFailed": "无法更新账户专属模型。之前的设置保持不变。",
  "codexAuth.pickerModeTitle": "选择器布局",
  "codexAuth.pickerModeAdditive": "基础 + 账户",
  "codexAuth.pickerModeReplace": "仅账户",
  "codexAuth.pickerModeAdditiveDesc": "同时显示基础 OpenAI 模型和个人 / 工作账户选项。",
  "codexAuth.pickerModeReplaceDesc": "仅显示绑定账户的 OpenAI 选项。其他提供商保持不变。",
  "codexAuth.pickerModeSaved": "选择器已更新。如果模型列表仍旧，请重新打开 Codex。",
  "codexAuth.pickerModeSaveFailed": "无法保存选择器设置。之前的选择保持不变。",
  "codexAuth.add": "添加",
