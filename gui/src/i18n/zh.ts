...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
  ...
  "codexAuth.keyringDetailsPending": "OpenCodex 无法读取 Codex 的系统钥匙串登录。账户类型和配额将在首次通过此代理成功请求后显示。",
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "pws.capacity.missingQuota": "无当前配额数据：{count} 个账户。",
  "pws.capacity.unknownPlan": "套餐未知：{count} 个账户。",
  "pws.capacity.pausedAccounts": "已暂停：{count} 个账户。",
  "pws.capacity.reauthAccounts": "需要重新认证：{count} 个账户。",
  "pws.capacity.staleQuota": "配额数据已过期：{count} 个账户。",
