...
export const zh: Record<TKey, string> = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.field.id": "组合 ID",
  "cws.field.idHint": "客户端请求：{model}",
  "cws.field.idInternalHint": "组合的内部 ID。未设置公开模型名时，客户端使用 combo/<id>。",
  "cws.field.idHintEdit": "修改 ID 即重命名组合。未设置公开模型名时，客户端使用 combo/<id>。",
  "cws.field.alias": "公开模型名称",
  "cws.field.aliasPlaceholder": "deepseek-v4-flash 或 vendor/model",
  "cws.field.aliasHint": "可选。覆盖客户端请求的模型名；可填裸名称、自定义前缀（如 vendor/model），或留空使用 combo/<id>。",
  "cws.field.publicModelPreview": "客户端请求：{model}",
