...
export const zh: Record<TKey, string> = {
  ...
  "routing.promptRouting": "自动提示词路由",
  "routing.promptRoutingHelp": "在本地分析每次最新的用户提示词，并为每个请求选择合适的任务等级。",
  "routing.taskTiers": "任务等级",
  "routing.taskTier.fast": "快速",
  "routing.taskTier.balanced": "均衡",
  "routing.taskTier.powerful": "强力",
  ...
  "routing.exclusion.task-tier-mismatch": "未分配到此任务等级",
