...
- **Web Search 与 Vision sidecar。** Web Search 仍使用 OpenAI/Anthropic；Vision 也支持通过已配置 provider 的显式 Chat backend（`provider/model`）。详见 [sidecar 文档](https://opencodex.me/guides/sidecars/)。
