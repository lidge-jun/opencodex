 ...
 * preservation of an existing shared selection or thread binding qualifies here, and a
 * disabled threshold keeps its usual meaning of "never drained on quota alone".
 */
