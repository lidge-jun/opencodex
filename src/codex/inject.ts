...
async function injectCodexConfigImpl(
   ...
   * post-transition input by reconcileAndDerivePlan — the admitted candidate
   * still fingerprints this operation because that re-derivation is a
   * deterministic function of the admitted input.
   */
