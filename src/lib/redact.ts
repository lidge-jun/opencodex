...
/**
 * Replace only explicitly supplied private values, without interpreting the surrounding wire format.
 * Unlike `redactSecretString`, this preserves JSON structure and unrelated account identifiers.
 */
