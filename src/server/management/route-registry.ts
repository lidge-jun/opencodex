...
export const MANAGEMENT_ROUTES: readonly ManagementRoute[] = [
  ...
  { method: "GET", path: "/api/protocols", module: "server/management/protocol-routes", mutates: false, exempt: { reason: "deferred-verb", why: "Reading the protocol vocabulary and active policy revision has no CLI verb yet; PF-12 owns `ocx api protocols`, and until then the dashboard preview is the only reader.", owner: "260924_protocol_first_class PF-12", ownerDoc: "devlog/_plan/260924_protocol_first_class/030_gui_and_management_api.md" } },
  ...
  { method: "PATCH", path: "/api/protocols/settings", module: "server/management/protocol-routes", mutates: true, exempt: { reason: "deferred-verb", why: "Changing the Messages surface and protocol rollout switches has no CLI verb yet; PF-12 owns `ocx api policy`. Until then the API page Messages toggle is the only caller, and hand-editing apiSurfaces/protocols in config.json stays available.", owner: "260924_protocol_first_class PF-12", ownerDoc: "devlog/_plan/260924_protocol_first_class/030_gui_and_management_api.md" } },
