...
export const MANAGEMENT_ROUTES: readonly ManagementRoute[] = [
  ...
  { method: "GET", path: "/api/lab/automation", module: "server/management/lab-automation-routes", mutates: false, go: { volatileFields: [] } },
  { method: "GET", path: "/api/lab/automation/runs", module: "server/management/lab-automation-routes", mutates: false, go: { volatileFields: [] } },
  ...
  { method: "GET", path: "/api/lab/artifacts", module: "server/management/lab-routes", mutates: false, go: { volatileFields: [] } },
  { method: "GET", path: "/api/lab/catalog", module: "server/management/lab-routes", mutates: false, go: { volatileFields: [] } },
  { method: "GET", path: "/api/lab/events", module: "server/management/lab-routes", mutates: false, go: { volatileFields: [] } },
  { method: "GET", path: "/api/lab/observations", module: "server/management/lab-routes", mutates: false, go: { volatileFields: [] } },
  { method: "GET", path: "/api/lab/production-signals", module: "server/management/lab-routes", mutates: false, go: { volatileFields: [] } },
  { method: "GET", path: "/api/lab/public/community", module: "server/management/lab-routes", mutates: false, go: { volatileFields: [] } },
  { method: "GET", path: "/api/lab/status", module: "server/management/lab-routes", mutates: false, go: { volatileFields: [] } },
  { method: "GET", path: "/api/lab/subjects", module: "server/management/lab-routes", mutates: false, go: { volatileFields: [] } },
  { method: "GET", path: "/api/lab/verdicts", module: "server/management/lab-routes", mutates: false, go: { volatileFields: [] } },
  ...
  // Ticket #20: Go owns the public aggregate transport. The serving process
  // remains the pre-flip ledger/cache oracle behind a child capability bridge.
  { method: "GET", path: "/api/usage", module: "server/management/logs-usage-routes", mutates: false, go: { volatileFields: ["generatedAt", "since"] } },
