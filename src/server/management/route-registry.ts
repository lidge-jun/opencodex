...
export const MANAGEMENT_ROUTES: readonly ManagementRoute[] = [
  ...
  { method: "GET", path: "/api/global-model-visibility", module: "server/management/model-routes", mutates: false },
  ...
  { method: "PUT", path: "/api/global-model-visibility", module: "server/management/model-routes", mutates: true },
