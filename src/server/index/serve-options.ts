  ...
  const serveOptions = {
      ...
      if (url.pathname === "/v1/models" && req.method === "GET") {
        ...
        const nativeSlugs = includeNativeOpenAi
          ...
          : [];
        const disabledModels = effectiveDisabledModels(config);
        const disabledNatives = disabledNativeSlugs({ disabledModels: [...disabledModels] });
