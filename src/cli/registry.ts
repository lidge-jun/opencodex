...
export const CLI_COMMANDS: CliCommandEntry[] = [
  ...
  {
    name: "account",
    usage: "ocx account <list|current|use|refresh|auto-switch|alias|clear-cooldown|priority|login|reauth|code|cancel|remove|add-key|import|reset-credits|main> ...",
    ...
    details: [
      ...
      "auto-switch <provider> <on|off|status|threshold N>  Control a supported account pool.",
      "alias <provider> <id> <display-name|->  Set or clear a stored account display name.",
      "clear-cooldown <provider> <id|main>  Clear one supported pool account's runtime cooldown; main is Codex-only.",
      "priority <provider> <id|main> [first|earlier|normal|later|last|-100..100|reset]  Selection order; omit the value to read it.",
      "remove <provider> <id> --yes  Remove a stored account or key after an existence check.",
      "add-key <provider> [--label <label>]  Add a key read only from piped stdin.",
      "import <provider> --format <format> (--file <path>|--stdin)  Import supported account records.",
