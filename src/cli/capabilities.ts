...
export const CAPABILITIES: readonly Capability[] = [
  ...
  },
  {
    ...
    flags: [{ name: "--json", value: "boolean", summary: "Emit the applied strategy, sticky limit, and reset order as JSON." }],
    mutates: true,
    json: "envelope",
    details: [
  ...
  {
    command: ["account", "reset-order"],
    summary: "Show or set reset-window ordering for an account pool.",
    routes: [
      { method: "GET", path: "/api/codex-auth/active" },
      { method: "PUT", path: "/api/codex-auth/pool-strategy" },
      { method: "GET", path: "/api/oauth/accounts/pool" },
