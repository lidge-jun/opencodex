...
export const CAPABILITIES: readonly Capability[] = [
  ...
  },
  {
    ...
    flags: [
        { name: "--range", value: "string", summary: "today | yesterday | 1d | 7d | 30d | all" },
        { name: "--since", value: "string", summary: "Inclusive custom start date/time bound." },
        { name: "--until", value: "string", summary: "Inclusive custom end date/time bound." },
        { name: "--provider", value: "string", summary: "Restrict to one provider." },
        { name: "--model", value: "string", summary: "Restrict to one model id." },
        { name: "--offline", value: "boolean", summary: "Read the bounded local usage ledger without a running proxy." },
        { name: "--format", value: "string", summary: "table | markdown | json" },
