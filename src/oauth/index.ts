...
export const OAUTH_PROVIDERS: Record<string, OAuthProviderDef> = {
  ...
  "zcode-start-plan": {
    ...
    // The plan JWT carries no exp and the gateway has no silent refresh: a rejected
    // token is terminal (needsReauth). Never generate background refresh traffic for it.
    defaultRefreshPolicy: "disabled",
  },
  "meta-muse": {
