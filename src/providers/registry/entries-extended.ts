...
export const PROVIDER_REGISTRY_EXTENDED: readonly ProviderRegistryEntry[] = [
  ...
  { id: "vercel-ai-gateway", label: "Vercel AI Gateway", baseUrl: "https://ai-gateway.vercel.sh/v1", adapter: "openai-chat", authKind: "key", dashboardUrl: "https://vercel.com/dashboard" },
  {
    ...
    // Live-verified 2026-09-08: GET /v3/compat/models answers 401 without a key, so the default
    // discovery URL doubles as key validation. Windows, output caps and modalities live in
    // model-seeds.ts (smallest value / shared modality across each pool's members); live discovery
    // owns which models exist.
    id: "opper",
    label: "Opper",
    adapter: "openai-chat",
