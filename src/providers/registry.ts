...
export const PROVIDER_REGISTRY: readonly ProviderRegistryEntry[] = [
  ...
  {
    id: "chatgpt-browser",
    label: "ChatGPT Browser (experimental)",
    ...
    liveModels: false,
    modelInputModalities: { "gpt-5.6-pro": ["text"] },
    modelReasoningEfforts: { "gpt-5.6-pro": [] },
    parallelToolCalls: false,
    note: "Experimental, opt-in standard-ChatGPT browser route. Requires @steipete/oracle and an eligible signed-in ChatGPT account. Routes only gpt-5.6-pro, verifies Pro selection, and never falls back to Codex, Work, API billing, another model, or another account.",
  },
  {
    id: "cursor",
