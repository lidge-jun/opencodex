...
export const PROVIDER_REGISTRY: readonly ProviderRegistryEntry[] = [
  {
    id: "open2-beta",
    label: "Upstage Open2 Beta",
    baseUrl: "https://open2-beta.upstage.ai",
    adapter: "open2-beta",
    authKind: "key",
    keyOptional: true,
    freeTier: true,
    dashboardUrl: "https://open2-beta.upstage.ai",
    defaultModel: "solar-open2",
    models: ["solar-open2"],
    liveModels: false,
    contextWindow: 524_288,
    modelContextWindows: { "solar-open2": 524_288 },
    modelInputModalities: { "solar-open2": ["text"] },
    noVisionModels: ["solar-open2"],
    reasoningEfforts: ["medium", "high", "max"],
    modelReasoningEfforts: { "solar-open2": ["medium", "high", "max"] },
    reasoningEffortMap: {
      none: "none",
      minimal: "medium",
      low: "medium",
    ...
    note: "Unofficial beta web-session bridge. Currently free and keyless while the public beta remains open; the private web protocol may change or disappear without notice and break this adapter. Sessions refresh automatically. Text/reasoning works; Codex client tools are not exposed by the upstream wire.",
  },
  {
    id: "openai",
